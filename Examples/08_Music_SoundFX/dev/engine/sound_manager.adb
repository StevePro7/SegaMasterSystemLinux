...
S:Lsound_manager.engine_sound_manager_play$sound$1_0$45({1}SC:U),R,0,0,[e]
S:Lsound_manager.engine_sound_manager_play$sfx$1_0$45({2}DG,SV:S),R,0,0,[c,b]
T:Fsound_manager$tag_struct_hack_object[({0}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)]
