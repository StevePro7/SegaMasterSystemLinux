M:joint_screen
F:G$screen_joint_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_joint_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ljoint_screen.screen_joint_screen_update$screen_type$1_0$19({2}DG,SC:U),B,1,4
S:Ljoint_screen.screen_joint_screen_update$sound$1_0$20({1}SC:U),R,0,0,[a]
S:Ljoint_screen.screen_joint_screen_update$input$1_0$20({1}SC:U),R,0,0,[a]
S:Fjoint_screen$prev_play_type$0_0$0({1}SC:U),E,0,0
S:Fjoint_screen$curr_play_type$0_0$0({1}SC:U),E,0,0
