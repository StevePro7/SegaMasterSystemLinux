M:sound_screen
F:G$screen_sound_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_sound_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsound_screen.screen_sound_screen_update$screen_type$1_0$19({2}DG,SC:U),B,1,4
S:Lsound_screen.screen_sound_screen_update$input$1_0$20({1}SC:U),R,0,0,[l]
