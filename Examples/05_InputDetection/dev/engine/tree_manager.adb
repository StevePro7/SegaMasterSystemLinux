...
S:Ltree_manager.engine_tree_manager_draw$tx$1_0$19({1}SC:U),R,0,0,[b]
S:Ltree_manager.engine_tree_manager_draw$ty$1_0$19({1}SC:U),R,0,0,[b]
F:Ftree_manager$draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltree_manager.draw$x$1_0$24({1}SC:U),B,1,4
S:Ltree_manager.draw$y$1_0$24({1}SC:U),B,1,5
S:Ltree_manager.draw$pnt$1_0$25({2}DG,SC:U),R,0,0,[]
