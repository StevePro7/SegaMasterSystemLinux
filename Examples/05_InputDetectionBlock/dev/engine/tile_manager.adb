...
S:Ltile_manager.engine_tile_manager_draw_trees$type$1$19({1}SC:U),B,1,4
S:Ltile_manager.engine_tile_manager_draw_trees$x$1$19({1}SC:U),B,1,5
S:Ltile_manager.engine_tile_manager_draw_trees$y$1$19({1}SC:U),B,1,6
S:Ltile_manager.engine_tile_manager_draw_trees$offset$1$20({1}SC:U),R,0,0,[b]
F:G$engine_tile_manager_draw_sides$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltile_manager.engine_tile_manager_draw_sides$x$1$21({1}SC:U),B,1,4
S:Ltile_manager.engine_tile_manager_draw_sides$y$1$21({1}SC:U),B,1,5
S:Ltile_manager.engine_tile_manager_draw_sides$offset$1$22({1}SC:U),R,0,0,[]
F:Ftile_manager$draw_tile$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltile_manager.draw_tile$offset$1$23({1}SC:U),B,1,4
S:Ltile_manager.draw_tile$x$1$23({1}SC:U),B,1,5
S:Ltile_manager.draw_tile$y$1$23({1}SC:U),B,1,6
S:Ltile_manager.draw_tile$priority$1$24({1}SC:U),R,0,0,[]
F:Ftile_manager$draw_tile_priority$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltile_manager.draw_tile_priority$offset$1$25({1}SC:U),B,1,4
S:Ltile_manager.draw_tile_priority$x$1$25({1}SC:U),B,1,5
S:Ltile_manager.draw_tile_priority$y$1$25({1}SC:U),B,1,6
S:Ltile_manager.draw_tile_priority$priority$1$26({2}SI:U),R,0,0,[c,b]
F:Ftile_manager$comm_tile$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltile_manager.comm_tile$pnt$1$27({2}DG,SC:U),B,1,4
S:Ltile_manager.comm_tile$offset$1$27({1}SC:U),B,1,6
S:Ltile_manager.comm_tile$priority$1$27({2}SI:U),B,1,7
S:Ltile_manager.comm_tile$x$1$27({1}SC:U),B,1,9
S:Ltile_manager.comm_tile$y$1$27({1}SC:U),B,1,10
