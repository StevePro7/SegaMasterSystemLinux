...
S:Ltest_screen.screen_test_screen_update$screen_type$1$3({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$input$1$4({1}SC:U),R,0,0,[l]
...
S:G$engine_scroll_manager_update_left$0$0({2}DF,SV:S),C,0,0
S:G$engine_scroll_manager_update_right$0$0({2}DF,SV:S),C,0,0
