...
;--------------------------------------------------------
	...
	.globl	C$none_screen.c$4$0$0
;none_screen.c:4: void screen_none_screen_load()
;	---------------------------------
; Function screen_none_screen_load
; ---------------------------------
_screen_none_screen_load::
	C$none_screen.c$6$0$0	= .
	.globl	C$none_screen.c$6$0$0
;none_screen.c:6: }
	C$none_screen.c$6$0$0	= .
	.globl	C$none_screen.c$6$0$0
	...
	.globl	C$none_screen.c$8$0$0
;none_screen.c:8: void screen_none_screen_update( unsigned char *screen_type )
;	---------------------------------
; Function screen_none_screen_update
; ---------------------------------
_screen_none_screen_update::
	C$none_screen.c$10$1$4	= .
	.globl	C$none_screen.c$10$1$4
;none_screen.c:10: *screen_type = screen_type_none;
	pop	de
	pop	bc
	push	bc
	push	de
