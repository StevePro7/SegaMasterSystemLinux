...
S:Lenemy_manager.engine_enemy_manager_draw$eo$1$18({2}DG,STtag_struct_enemy_object:S),R,0,0,[e,d]
S:Lenemy_manager.engine_enemy_manager_draw$idx$1$18({1}SC:U),R,0,0,[c]
