...
S:G$devkit_PORT_A_KEY_UP$1_0$20({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_DOWN$1_0$21({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_LEFT$1_0$22({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_RIGHT$1_0$23({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_1$1_0$24({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_2$1_0$25({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_UP$1_0$26({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_DOWN$1_0$27({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_LEFT$1_0$28({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_RIGHT$1_0$29({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_1$1_0$30({2}DF,SI:S),C,0,0
S:G$devkit_PORT_A_KEY_2$1_0$31({2}DF,SI:S),C,0,0
