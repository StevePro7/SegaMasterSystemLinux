M:log_manager
F:G$engine_log_manager_open$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_log_manager_close$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_log_manager_debug$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llog_manager.engine_log_manager_debug$message$1$64({2}DG,SC:U),B,1,4
S:Llog_manager.engine_log_manager_debug$args$1$65({2}DG,SC:U),R,0,0,[e,h]
F:G$engine_log_manager_infos$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llog_manager.engine_log_manager_infos$message$1$68({2}DG,SC:U),B,1,4
S:Llog_manager.engine_log_manager_infos$args$1$69({2}DG,SC:U),R,0,0,[e,h]
F:G$engine_log_manager_error$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llog_manager.engine_log_manager_error$message$1$72({2}DG,SC:U),B,1,4
S:Llog_manager.engine_log_manager_error$args$1$73({2}DG,SC:U),R,0,0,[e,h]
