...
S:Lsprite_manager.engine_tile_manager_draw$x$1$67({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw$y$1$67({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw$pnt$1$68({2}DG,SC:U),R,0,0,[]
F:G$engine_tile_manager_tile$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_tile_manager_tile$x$1$69({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_tile$y$1$69({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_tile$i$1$69({1}SC:U),B,1,6
S:Lsprite_manager.engine_tile_manager_tile$pnt$1$70({2}DG,SC:U),R,0,0,[]
...
S:Lsprite_manager.engine_sprite_manager_draw$tile$1$71({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1$72({1}SC:U),R,0,0,[]
