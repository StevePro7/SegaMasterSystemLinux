...
S:Lsprite_manager.engine_content_manager_draw_tileX$x$1$67({1}SC:U),B,1,4
S:Lsprite_manager.engine_content_manager_draw_tileX$y$1$67({1}SC:U),B,1,5
S:Lsprite_manager.engine_content_manager_draw_tileX$pnt$1$68({2}DG,SC:U),R,0,0,[]
