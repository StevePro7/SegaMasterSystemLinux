...
S:Lsprite_manager.engine_content_manager_draw_tile$i$1$90({2}SI:U),B,1,6
F:G$engine_tilemap_manager_draw_tile$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_tilemap_manager_draw_tile$x$1$92({1}SC:U),B,1,4
...
S:Lsprite_manager.engine_tilemap_manager_draw_tile$base$1$93({1}SC:U),R,0,0,[]
