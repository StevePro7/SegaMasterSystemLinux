...
S:Lscreen_manager.engine_screen_manager_init$xx$1$91({1}SC:U),R,0,0,[b]
S:Lscreen_manager.engine_screen_manager_init$yy$1$91({1}SC:U),R,0,0,[]
...
S:Lscreen_manager.engine_screen_manager_update$input$1$94({1}SC:U),R,0,0,[c]
S:Lscreen_manager.engine_screen_manager_update$sloc0$1$0({2}SI:S),B,1,-2
