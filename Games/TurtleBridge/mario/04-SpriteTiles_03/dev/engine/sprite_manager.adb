M:sprite_manager
F:G$engine_sprite_manager_draw$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
...
S:Lsprite_manager.engine_sprite_manager_draw$sloc0$0_1$0({1}SC:S),B,1,-5
S:Lsprite_manager.engine_sprite_manager_draw$sloc1$0_1$0({1}SC:S),B,1,-4
S:Lsprite_manager.engine_sprite_manager_draw$sloc2$0_1$0({1}SC:S),B,1,-3
S:Lsprite_manager.engine_sprite_manager_draw$sloc3$0_1$0({1}SC:S),B,1,-2
S:Lsprite_manager.engine_sprite_manager_draw$sloc4$0_1$0({1}SC:S),B,1,-1
S:Lsprite_manager.engine_sprite_manager_draw$sloc5$0_1$0({1}SC:S),B,1,-1
