...
S:Lcontent_manager.fadeInBGPalette$i$1$68({1}SC:U),B,1,-36
S:Lcontent_manager.fadeInBGPalette$j$1$68({1}SC:U),B,1,-19
S:Lcontent_manager.fadeInBGPalette$redComponent$1$68({1}SC:U),B,1,-37
S:Lcontent_manager.fadeInBGPalette$greenComponent$1$68({1}SC:U),B,1,-18
S:Lcontent_manager.fadeInBGPalette$blueComponent$1$68({1}SC:U),R,0,0,[b]
S:Lcontent_manager.fadeInBGPalette$temporal_palette$1$68({16}DA16d,SC:U),B,1,-35
S:Lcontent_manager.fadeInBGPalette$sloc0$1$0({2}DD,SC:U),B,1,-5
S:Lcontent_manager.fadeInBGPalette$sloc1$1$0({2}DD,SC:U),B,1,-2
S:Lcontent_manager.fadeInBGPalette$sloc2$1$0({2}DD,SC:U),B,1,-7
S:Lcontent_manager.fadeInBGPalette$sloc3$1$0({1}SC:U),B,1,-3
S:Lcontent_manager.fadeInBGPalette$sloc4$1$0({1}SC:U),B,1,-8
S:Lcontent_manager.fadeInBGPalette$sloc5$1$0({1}SC:U),B,1,-9
S:Lcontent_manager.fadeInBGPalette$sloc6$1$0({4}SL:S),B,1,-17
S:Lcontent_manager.fadeInBGPalette$sloc7$1$0({4}SL:S),B,1,-13
