...
S:Lsprite_manager.draw_sea$x$1$91({1}SC:U),B,1,4
S:Lsprite_manager.draw_sea$y$1$91({1}SC:U),B,1,5
S:Lsprite_manager.draw_sea$offset$1$91({1}SC:U),B,1,6
S:Lsprite_manager.draw_sea$pnt$1$92({2}DG,SC:U),R,0,0,[]
