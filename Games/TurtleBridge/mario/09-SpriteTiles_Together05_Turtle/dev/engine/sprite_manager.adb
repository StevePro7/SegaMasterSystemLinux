...
S:Lsprite_manager.draw_sea$x$1$84({1}SC:U),B,1,4
S:Lsprite_manager.draw_sea$y$1$84({1}SC:U),B,1,5
S:Lsprite_manager.draw_sea$pnt$1$85({2}DG,SC:U),R,0,0,[]
F:G$engine_sprite_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_draw$x$1$86({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw$y$1$86({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$tile$1$86({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1$87({1}SC:U),R,0,0,[]
