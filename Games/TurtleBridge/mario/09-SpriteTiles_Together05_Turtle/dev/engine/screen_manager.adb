...
S:Lscreen_manager.engine_screen_manager_update$test$1$30({1}SC:U),R,0,0,[b]
F:Fscreen_manager$draw_turtles$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_turtles$i$1$32({1}SC:U),R,0,0,[b]
F:Fscreen_manager$draw_turtle$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_turtle$i$1$35({1}SC:U),B,1,4
