M:sprite_manager
F:G$engine_turtle_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lsprite_manager.engine_sprite_manager_draw$tile$1$69({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1$70({1}SC:U),R,0,0,[]
