...
F:G$engine_tile_manager_draw$0$0({2}DF,SV:S),Z,0,82,0,0,0
...
S:Lsprite_manager.engine_tile_manager_draw$w$1$73({1}SC:U),B,1,-84
...
S:Lsprite_manager.engine_tile_manager_draw$tileMap$1$73({80}DA80d,SC:U),B,1,-83
