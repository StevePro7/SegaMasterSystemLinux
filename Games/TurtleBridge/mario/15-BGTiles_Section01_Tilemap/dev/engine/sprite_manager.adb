...
S:Lsprite_manager.engine_tile_manager_init$pnt$1$67({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_init$tile$1$67({1}SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_init$w$1$67({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_tile_manager_init$h$1$67({1}SC:U),R,0,0,[c]
F:G$engine_tile_manager_draw$0$0({2}DF,SV:S),Z,0,98,0,0,0
S:Lsprite_manager.engine_tile_manager_draw$x$1$72({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw$y$1$72({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw$pnt$1$73({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_draw$w$1$73({1}SC:U),B,1,-3
S:Lsprite_manager.engine_tile_manager_draw$h$1$73({1}SC:U),B,1,-100
S:Lsprite_manager.engine_tile_manager_draw$idx$1$73({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_draw$key$1$73({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_draw$tileMap$1$73({96}DA96d,SC:U),B,1,-99
S:Lsprite_manager.engine_tile_manager_draw$sloc0$1$0({1}SC:U),B,1,-2
S:Lsprite_manager.engine_tile_manager_draw$sloc1$1$0({1}SC:U),B,1,-1
F:G$engine_tilemap_manager_draw_tile$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_tilemap_manager_draw_tile$x$1$78({1}SC:U),B,1,4
S:Lsprite_manager.engine_tilemap_manager_draw_tile$y$1$78({1}SC:U),B,1,5
S:Lsprite_manager.engine_tilemap_manager_draw_tile$pnt$1$79({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tilemap_manager_draw_tile$index$1$79({2}SI:U),R,0,0,[l,h]
S:Lsprite_manager.engine_tilemap_manager_draw_tile$base$1$79({1}SC:U),R,0,0,[]
