...
S:Lplayer.add_player$player_number$1_0$98({1}SC:U),B,1,4
S:Lplayer.add_player$playerpointer$1_0$99({2}DG,ST__00000005:S),R,0,0,[c,b]
F:G$manage_input$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer.manage_input$keys$1_0$103({2}SI:U),B,1,4
F:G$manage_player_iddle_status$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer.manage_player_iddle_status$player_number$1_0$108({1}SC:U),B,1,4
S:Lplayer.manage_player_iddle_status$keys$1_0$108({2}SI:U),B,1,5
F:G$manage_player_walking_status$0_0$0({2}DF,SV:S),Z,0,-3,0,0,0
S:Lplayer.manage_player_walking_status$player_number$1_0$136({1}SC:U),B,1,4
S:Lplayer.manage_player_walking_status$keys$1_0$136({2}SI:U),B,1,5
S:Lplayer.manage_player_walking_status$sloc0$0_1$0({1}SC:U),B,1,-1
S:Lplayer.manage_player_walking_status$sloc1$0_1$0({1}SC:U),B,1,-1
S:Lplayer.manage_player_walking_status$sloc2$0_1$0({1}SC:U),B,1,-1
S:Lplayer.manage_player_walking_status$sloc3$0_1$0({1}SC:U),B,1,-1
F:G$manage_player_jumping_status$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer.manage_player_jumping_status$player_number$1_0$186({1}SC:U),B,1,4
S:Lplayer.manage_player_jumping_status$keys$1_0$186({2}SI:U),B,1,5
F:G$manage_player_crouched_status$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer.manage_player_crouched_status$player_number$1_0$214({1}SC:U),B,1,4
S:Lplayer.manage_player_crouched_status$keys$1_0$214({2}SI:U),B,1,5
F:G$update_player_positions$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer.update_player_positions$delta_x$1_0$232({1}SC:S),B,1,4
S:Lplayer.update_player_positions$delta_y$1_0$232({1}SC:S),B,1,5
