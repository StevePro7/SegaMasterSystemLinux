...
S:Lfont_manager.print_data$tile$1_0$97({1}SC:S),B,1,-2
S:Lfont_manager.print_data$quotient$1_0$97({2}SI:U),R,0,0,[e,d]
S:Lfont_manager.print_data$remainder$1_0$97({1}SC:U),R,0,0,[b]
S:Lfont_manager.print_data$hold$1_0$97({5}DA5d,SC:U),B,1,-9
S:Lfont_manager.print_data$sloc0$0_1$0({2}DD,SC:U),B,1,-4
S:Lfont_manager.print_data$sloc1$0_1$0({1}SC:U),B,1,-1
S:Lfont_manager.print_data$sloc2$0_1$0({1}SC:S),B,1,-2
