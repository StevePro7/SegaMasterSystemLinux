M:test_screen
F:G$init_scroll$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Ltest_screen.init_scroll$scrolltable$1_0$108({2}DG,SV:S),B,1,4
S:Ltest_screen.init_scroll$metatiles$1_0$108({2}DG,SV:S),B,1,6
S:Ltest_screen.init_scroll$scroll_x$1_0$108({2}SI:U),B,1,8
S:Ltest_screen.init_scroll$scroll_y$1_0$108({2}SI:U),B,1,10
F:G$screen_test_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_test_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.screen_test_screen_update$screen_type$1_0$111({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$input$1_0$112({1}SC:U),R,0,0,[a]
