...
T:Fcont_screen$tag_struct_enemy_master[({0}S:S$max_enemies$0_0$0({1}SC:U),Z,0,0)]
...
S:Fcont_screen$stage$0_0$0({1}SC:U),E,0,0
S:Fcont_screen$cursor$0_0$0({1}SC:U),E,0,0
