...
S:Ldead_screen.screen_dead_screen_load$ho$1_0$9({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_load$po$1_0$9({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_dead_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldead_screen.screen_dead_screen_update$screen_type$1_0$12({2}DG,SC:U),B,1,4
S:Ldead_screen.screen_dead_screen_update$po$1_0$13({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_update$so$1_0$13({2}DG,STtag_struct_score_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_update$delay$1_0$13({1}SC:U),R,0,0,[l]
...
T:Fdead_screen$tag_struct_hack_object[({0}S:S$hack_delayspeed$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_invincible$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_difficulty$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_game_speed$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_world$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_round$0_0$0({1}SC:U),Z,0,0)({6}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({7}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({8}S:S$hack_enemy$0_0$0({1}SC:U),Z,0,0)]
T:Fdead_screen$tag_struct_delay_object[({0}S:S$delay_delay$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
T:Fdead_screen$tag_struct_score_object[({0}S:S$tot_lives$0_0$0({1}SC:U),Z,0,0)({1}S:S$num_lives$0_0$0({1}SC:U),Z,0,0)({2}S:S$gem_count$0_0$0({1}SC:U),Z,0,0)({3}S:S$gem_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$gem_total$0_0$0({2}SI:U),Z,0,0)]
...
T:Fdead_screen$tag_struct_enemy_master[({0}S:S$max_enemies$0_0$0({1}SC:U),Z,0,0)]
