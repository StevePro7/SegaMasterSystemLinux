M:gems_screen
F:G$screen_gems_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_gems_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgems_screen.screen_gems_screen_update$screen_type$1_0$18({2}DG,SC:U),B,1,4
S:Lgems_screen.screen_gems_screen_update$ro$1_0$19({2}DG,STtag_struct_reset_object:S),R,0,0,[]
S:Lgems_screen.screen_gems_screen_update$delay$1_0$19({1}SC:U),R,0,0,[e]
S:Lgems_screen.screen_gems_screen_update$input$1_0$19({1}SC:U),R,0,0,[d]
S:Lgems_screen.screen_gems_screen_update$check$1_0$19({1}SC:U),R,0,0,[a]
S:Lgems_screen.screen_gems_screen_update$sloc0$0_1$0({2}DG,SC:U),B,1,-2
T:Fgems_screen$tag_struct_player_object[({0}S:S$player_move_type$0_0$0({1}SC:U),Z,0,0)({1}S:S$spotX$0_0$0({2}SI:S),Z,0,0)({3}S:S$spotY$0_0$0({2}SI:S),Z,0,0)({5}S:S$posnX$0_0$0({2}SI:S),Z,0,0)({7}S:S$posnY$0_0$0({2}SI:S),Z,0,0)({9}S:S$drawX$0_0$0({2}SI:S),Z,0,0)({11}S:S$drawY$0_0$0({2}SI:S),Z,0,0)({13}S:S$collX$0_0$0({2}SI:S),Z,0,0)({15}S:S$collY$0_0$0({2}SI:S),Z,0,0)({17}S:S$prevX$0_0$0({2}SI:S),Z,0,0)({19}S:S$prevY$0_0$0({2}SI:S),Z,0,0)({21}S:S$commX$0_0$0({2}SI:S),Z,0,0)({23}S:S$commY$0_0$0({2}SI:S),Z,0,0)({25}S:S$velX$0_0$0({2}SI:S),Z,0,0)({27}S:S$velY$0_0$0({2}SI:S),Z,0,0)({29}S:S$deltaX$0_0$0({1}SC:S),Z,0,0)({30}S:S$deltaY$0_0$0({1}SC:S),Z,0,0)({31}S:S$player_idxX$0_0$0({1}SC:S),Z,0,0)({32}S:S$player_idxY$0_0$0({1}SC:S),Z,0,0)({33}S:S$player_grav$0_0$0({1}SC:S),Z,0,0)({34}S:S$depthX$0_0$0({2}SI:S),Z,0,0)({36}S:S$depthY$0_0$0({2}SI:S),Z,0,0)({38}S:S$isOnGround$0_0$0({1}:S),Z,0,0)({39}S:S$isJumping$0_0$0({1}:S),Z,0,0)({40}S:S$wasJumping$0_0$0({1}:S),Z,0,0)({41}S:S$jumpFrame$0_0$0({1}SC:U),Z,0,0)({42}S:S$coll_horz$0_0$0({1}SC:S),Z,0,0)({43}S:S$coll_vert$0_0$0({1}SC:S),Z,0,0)({44}S:S$coll_left$0_0$0({1}SC:S),Z,0,0)({45}S:S$coll_rght$0_0$0({1}SC:S),Z,0,0)({46}S:S$coll_topX$0_0$0({1}SC:S),Z,0,0)({47}S:S$coll_botX$0_0$0({1}SC:S),Z,0,0)({48}S:S$previousBottom$0_0$0({2}SI:S),Z,0,0)({50}S:S$anim_index$0_0$0({1}SC:U),Z,0,0)({51}S:S$anim_start$0_0$0({1}SC:U),Z,0,0)({52}S:S$anim_maxim$0_0$0({1}SC:U),Z,0,0)({53}S:S$anim_frame$0_0$0({1}SC:S),Z,0,0)({54}S:S$anim_count$0_0$0({1}SC:S),Z,0,0)({55}S:S$kill_idx$0_0$0({1}SC:S),Z,0,0)]
T:Fgems_screen$tag_struct_game_object[({0}S:S$invincible$0_0$0({1}SC:U),Z,0,0)({1}S:S$localcheat$0_0$0({1}SC:U),Z,0,0)({2}S:S$difficulty$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_speed$0_0$0({1}SC:U),Z,0,0)({4}S:S$tutorial$0_0$0({1}SC:U),Z,0,0)({5}S:S$world_no$0_0$0({1}SC:U),Z,0,0)({6}S:S$round_no$0_0$0({1}SC:U),Z,0,0)]
T:Fgems_screen$tag_struct_delay_object[({0}S:S$delay_delay$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
T:Fgems_screen$tag_struct_score_object[({0}S:S$tot_lives$0_0$0({1}SC:U),Z,0,0)({1}S:S$num_lives$0_0$0({1}SC:U),Z,0,0)({2}S:S$gem_count$0_0$0({1}SC:U),Z,0,0)({3}S:S$gem_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$gem_total$0_0$0({2}SI:U),Z,0,0)]
...
T:Fgems_screen$tag_struct_reset_object[({0}S:S$reset_frame$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)({2}S:S$reset_screen$0_0$0({1}SC:U),Z,0,0)]
T:Fgems_screen$tag_struct_enemy_master[({0}S:S$max_enemies$0_0$0({1}SC:U),Z,0,0)]
...
S:Fgems_screen$stage$0_0$0({1}SC:U),E,0,0
