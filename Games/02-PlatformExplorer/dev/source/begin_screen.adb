...
S:Lbegin_screen.screen_begin_screen_load$x$1$47({1}SC:U),R,0,0,[b]
S:Lbegin_screen.screen_begin_screen_load$tile$1$47({1}SC:U),R,0,0,[d]
F:G$screen_begin_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbegin_screen.screen_begin_screen_update$screen_type$1$50({2}DG,SC:U),B,1,4
