M:audio_manager
F:G$engine_audio_manager_music_game$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_audio_manager_music_game$index$1$34({1}SC:U),B,1,4
F:G$engine_audio_manager_music_title$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_music_over$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_music_beat$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
F:G$engine_audio_manager_sound_accept$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_death$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_gem$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_level$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_power$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_audio_manager_sound_reset$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Faudio_manager$play_music$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.play_music$mus$1$47({2}DG,SC:U),B,1,4
S:Laudio_manager.play_music$bank$1$47({1}SC:U),B,1,6
S:Laudio_manager.play_music$ho$1$48({2}DG,STtag_struct_hack_object:S),R,0,0,[]
F:Faudio_manager$play_music_norepeat$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.play_music_norepeat$mus$1$50({2}DG,SC:U),B,1,4
S:Laudio_manager.play_music_norepeat$bank$1$50({1}SC:U),B,1,6
S:Laudio_manager.play_music_norepeat$ho$1$51({2}DG,STtag_struct_hack_object:S),R,0,0,[]
F:Faudio_manager$play_sound$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.play_sound$sfx$1$53({2}DG,SC:U),B,1,4
S:Laudio_manager.play_sound$ho$1$54({2}DG,STtag_struct_hack_object:S),R,0,0,[]
T:Faudio_manager$tag_struct_hack_object[({0}S:S$hack_delayspeed$0$0({1}SC:U),Z,0,0)({1}S:S$hack_invincible$0$0({1}SC:U),Z,0,0)({2}S:S$hack_difficulty$0$0({1}SC:U),Z,0,0)({3}S:S$hack_game_speed$0$0({1}SC:U),Z,0,0)({4}S:S$hack_world$0$0({1}SC:U),Z,0,0)({5}S:S$hack_round$0$0({1}SC:U),Z,0,0)({6}S:S$hack_music$0$0({1}SC:U),Z,0,0)({7}S:S$hack_sound$0$0({1}SC:U),Z,0,0)({8}S:S$hack_enemy$0$0({1}SC:U),Z,0,0)]
S:G$game_audio_data$0$0({0}DA0d,DG,SC:U),E,0,0
S:G$title_audio_data$0$0({0}DA0d,DG,SC:U),E,0,0
S:G$beat_audio_data$0$0({0}DA0d,DG,SC:U),E,0,0
S:G$over_audio_data$0$0({0}DA0d,DG,SC:U),E,0,0
