...
S:Lsplash_screen.screen_splash_screen_update$screen_type$1$17({2}DG,SC:U),B,1,4
S:Lsplash_screen.screen_splash_screen_update$delay$1$18({1}SC:U),R,0,0,[c]
S:Lsplash_screen.screen_splash_screen_update$input$1$18({1}SC:U),R,0,0,[b]
T:Fsplash_screen$tag_struct_delay_object[({0}S:S$delay_delay$0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0$0({2}SI:U),Z,0,0)]
