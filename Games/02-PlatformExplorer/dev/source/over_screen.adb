...
S:Lover_screen.screen_over_screen_load$go$1_0$24({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_over_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1_0$25({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$delay$1_0$26({1}SC:U),R,0,0,[c]
...
T:Fover_screen$tag_struct_game_object[({0}S:S$invincible$0_0$0({1}SC:U),Z,0,0)({1}S:S$localcheat$0_0$0({1}SC:U),Z,0,0)({2}S:S$difficulty$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_speed$0_0$0({1}SC:U),Z,0,0)({4}S:S$tutorial$0_0$0({1}SC:U),Z,0,0)({5}S:S$world_no$0_0$0({1}SC:U),Z,0,0)({6}S:S$round_no$0_0$0({1}SC:U),Z,0,0)]
T:Fover_screen$tag_struct_delay_object[({0}S:S$delay_delay$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
T:Fover_screen$tag_struct_level_object[({0}S:S$collision_array$0_0$0({192}DA192d,SC:U),Z,0,0)({192}S:S$drawtiles_array$0_0$0({192}DA192d,SC:U),Z,0,0)({384}S:S$load_cols$0_0$0({2}SI:U),Z,0,0)({386}S:S$draw_cols$0_0$0({2}SI:U),Z,0,0)({388}S:S$exit_spotX$0_0$0({1}SC:S),Z,0,0)({389}S:S$exit_spotY$0_0$0({1}SC:S),Z,0,0)({390}S:S$gem_level$0_0$0({1}SC:U),Z,0,0)({391}S:S$player_spot$0_0$0({2}SI:U),Z,0,0)({393}S:S$enemys_spotX$0_0$0({8}DA4d,SI:U),Z,0,0)({401}S:S$enemys_spotY$0_0$0({8}DA4d,SI:U),Z,0,0)({409}S:S$enemys_type$0_0$0({4}DA4d,SC:U),Z,0,0)({413}S:S$enemys_minX$0_0$0({4}DA4d,SC:U),Z,0,0)({417}S:S$enemys_maxX$0_0$0({4}DA4d,SC:U),Z,0,0)({421}S:S$enemys_action$0_0$0({4}DA4d,SC:U),Z,0,0)({425}S:S$enemyCount$0_0$0({1}SC:U),Z,0,0)]
...
T:Fover_screen$tag_struct_enemy_master[({0}S:S$max_enemies$0_0$0({1}SC:U),Z,0,0)]
