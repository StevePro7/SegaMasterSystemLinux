...
S:Lplay_screen.screen_play_screen_load$go$1_0$23({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_load$so$1_0$23({2}DG,STtag_struct_stats_object:S),R,0,0,[c,b]
S:Lplay_screen.screen_play_screen_load$difficulty$1_0$23({1}SC:U),R,0,0,[e]
F:G$screen_play_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplay_screen.screen_play_screen_update$screen_type$1_0$24({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$ro$1_0$25({2}DG,STtag_struct_reset_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$lo$1_0$25({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$so$1_0$25({2}DG,STtag_struct_score_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$po$1_0$25({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$em$1_0$25({2}DG,STtag_struct_enemy_master:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$eo$1_0$25({2}DG,STtag_struct_enemy_object:S),R,0,0,[e,d]
S:Lplay_screen.screen_play_screen_update$input$1_0$25({1}SC:U),R,0,0,[c]
S:Lplay_screen.screen_play_screen_update$check$1_0$25({1}SC:U),R,0,0,[a]
S:Lplay_screen.screen_play_screen_update$idx$1_0$25({1}SC:U),B,1,-4
S:Lplay_screen.screen_play_screen_update$evt$1_0$25({1}SC:U),R,0,0,[c]
S:Lplay_screen.screen_play_screen_update$coll_diff$1_0$25({2}SI:S),R,0,0,[e,d]
S:Lplay_screen.screen_play_screen_update$sloc0$0_1$0({1}SC:U),B,1,-4
S:Lplay_screen.screen_play_screen_update$sloc1$0_1$0({1}SC:S),B,1,-3
S:Lplay_screen.screen_play_screen_update$sloc2$0_1$0({1}SC:S),B,1,-2
S:Lplay_screen.screen_play_screen_update$sloc3$0_1$0({1}SC:U),B,1,-1
F:Fplay_screen$increase_lives$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplay_screen.increase_lives$so$1_0$50({2}DG,STtag_struct_score_object:S),R,0,0,[]
F:Fplay_screen$ground_collision$0_0$0({2}DF,SC:U),Z,0,-6,0,0,0
S:Lplay_screen.ground_collision$lo$1_0$53({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lplay_screen.ground_collision$po$1_0$53({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplay_screen.ground_collision$evt$1_0$53({1}SC:U),R,0,0,[]
S:Lplay_screen.ground_collision$tile$1_0$53({1}SC:U),R,0,0,[e]
S:Lplay_screen.ground_collision$cell_top$1_0$53({2}SI:U),B,1,-2
S:Lplay_screen.ground_collision$cell_bot$1_0$53({2}SI:U),B,1,-6
S:Lplay_screen.ground_collision$sloc0$0_1$0({2}SI:S),B,1,-6
S:Lplay_screen.ground_collision$sloc1$0_1$0({1}SC:S),B,1,-7
S:Lplay_screen.ground_collision$sloc2$0_1$0({2}SI:U),B,1,-2
S:Lplay_screen.ground_collision$sloc3$0_1$0({2}SI:S),B,1,-4
S:Lplay_screen.ground_collision$sloc4$0_1$0({2}SI:U),B,1,-6
S:Lplay_screen.ground_collision$sloc5$0_1$0({2}DG,SC:U),B,1,-4
S:Lplay_screen.ground_collision$sloc6$0_1$0({1}SC:U),B,1,-2
S:Lplay_screen.ground_collision$sloc7$0_1$0({1}SC:U),B,1,-1
...
T:Fplay_screen$tag_struct_hack_object[({0}S:S$hack_delayspeed$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_invincible$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_difficulty$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_game_speed$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_world$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_round$0_0$0({1}SC:U),Z,0,0)({6}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({7}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({8}S:S$hack_enemy$0_0$0({1}SC:U),Z,0,0)]
T:Fplay_screen$tag_struct_game_object[({0}S:S$invincible$0_0$0({1}SC:U),Z,0,0)({1}S:S$localcheat$0_0$0({1}SC:U),Z,0,0)({2}S:S$difficulty$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_speed$0_0$0({1}SC:U),Z,0,0)({4}S:S$tutorial$0_0$0({1}SC:U),Z,0,0)({5}S:S$world_no$0_0$0({1}SC:U),Z,0,0)({6}S:S$round_no$0_0$0({1}SC:U),Z,0,0)]
T:Fplay_screen$tag_struct_level_object[({0}S:S$collision_array$0_0$0({192}DA192d,SC:U),Z,0,0)({192}S:S$drawtiles_array$0_0$0({192}DA192d,SC:U),Z,0,0)({384}S:S$load_cols$0_0$0({2}SI:U),Z,0,0)({386}S:S$draw_cols$0_0$0({2}SI:U),Z,0,0)({388}S:S$exit_spotX$0_0$0({1}SC:S),Z,0,0)({389}S:S$exit_spotY$0_0$0({1}SC:S),Z,0,0)({390}S:S$gem_level$0_0$0({1}SC:U),Z,0,0)({391}S:S$player_spot$0_0$0({2}SI:U),Z,0,0)({393}S:S$enemys_spotX$0_0$0({8}DA4d,SI:U),Z,0,0)({401}S:S$enemys_spotY$0_0$0({8}DA4d,SI:U),Z,0,0)({409}S:S$enemys_type$0_0$0({4}DA4d,SC:U),Z,0,0)({413}S:S$enemys_minX$0_0$0({4}DA4d,SC:U),Z,0,0)({417}S:S$enemys_maxX$0_0$0({4}DA4d,SC:U),Z,0,0)({421}S:S$enemys_action$0_0$0({4}DA4d,SC:U),Z,0,0)({425}S:S$enemyCount$0_0$0({1}SC:U),Z,0,0)]
T:Fplay_screen$tag_struct_score_object[({0}S:S$tot_lives$0_0$0({1}SC:U),Z,0,0)({1}S:S$num_lives$0_0$0({1}SC:U),Z,0,0)({2}S:S$gem_count$0_0$0({1}SC:U),Z,0,0)({3}S:S$gem_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$gem_total$0_0$0({2}SI:U),Z,0,0)]
...
T:Fplay_screen$tag_struct_reset_object[({0}S:S$reset_frame$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)({2}S:S$reset_screen$0_0$0({1}SC:U),Z,0,0)]
T:Fplay_screen$tag_struct_stats_object[({0}S:S$collision_offsets$0_0$0({2}DA2d,SC:U),Z,0,0)({2}S:S$enemys_velX$0_0$0({32}DA4d,DA8d,SC:U),Z,0,0)({34}S:S$enemys_wait$0_0$0({32}DA4d,DA8d,SC:U),Z,0,0)({66}S:S$enemys_walk$0_0$0({32}DA4d,DA8d,SC:U),Z,0,0)]
T:Fplay_screen$tag_struct_enemy_master[({0}S:S$max_enemies$0_0$0({1}SC:U),Z,0,0)]
...
S:Fplay_screen$invincible$0_0$0({1}SC:U),E,0,0
S:Fplay_screen$game_speed$0_0$0({1}SC:U),E,0,0
S:Fplay_screen$loop_speed$0_0$0({1}SC:U),E,0,0
S:Fplay_screen$collision$0_0$0({1}SC:U),E,0,0
...
S:G$engine_state_manager_init$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_state_manager_load$0_0$0({2}DF,SV:S),C,0,0
