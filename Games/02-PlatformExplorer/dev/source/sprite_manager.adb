M:sprite_manager
F:G$engine_sprite_manager_draw_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_draw_player$x$1$16({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw_player$y$1$16({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw_player$tile$1$16({2}SI:U),B,1,6
F:G$engine_sprite_manager_draw_enemyX$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_draw_enemyX$x$1$18({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw_enemyX$y$1$18({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw_enemyX$tile$1$18({2}SI:U),B,1,6
