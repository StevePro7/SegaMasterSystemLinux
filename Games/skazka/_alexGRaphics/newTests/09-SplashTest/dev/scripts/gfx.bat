...
bmp2tile.exe raw/logo_big.png -savetiles "logo_big (tiles).psgcompr" -removedupes -nomirror -planar -tileoffset 1  -savetilemap "logo_big (tilemap).bin" -savepalette "font_tiles (palette).bin" -fullpalette -exit
