...
bmp2tile.exe raw/logo_big.png -savetiles "logo_big (tiles).psgcompr" -removedupes -nomirror -planar -tileoffset 64  -savetilemap "logo_big (tilemap).bin" -savepalette "logo_big (palette).bin" -fullpalette -exit
