...
bmp2tile.exe raw/logo_big.png -savetiles "logo_big (tiles).psgcompr" -noremovedupes -planar -tileoffset 64  -savetilemap "logo_big (tilemap).bin" -savepalette "font_tiles (palette).bin" -fullpalette -exit
