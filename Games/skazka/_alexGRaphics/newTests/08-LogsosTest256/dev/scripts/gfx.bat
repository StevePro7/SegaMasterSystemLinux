...
bmp2tile.exe raw/logo_big.png -savetiles "logo_big (tiles).psgcompr" -removedupes -nomirror -planar -tileoffset 256  -savetilemap "logo_big (tilemap).bin" -savepalette "background (palette).bin" -fullpalette -exit
