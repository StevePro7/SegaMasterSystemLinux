...
bmp2tile.exe raw/battle_player.png  -savetiles "battle_player (tiles).psgcompr"    -removedupes -nomirror -planar -tileoffset 224 -savetilemap "battle_player (tilemap).bin"  -exit
