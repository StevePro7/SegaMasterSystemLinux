...
bmp2tile.exe raw/battle_player.png  -savetiles "battle_player (tiles).psgcompr"    -removedupes -nomirror -planar -tileoffset  0 -savetilemap "battle_player (tilemap).bin"  -exit
