...
S:Lscreen_manager.draw_intro$row$1_0$98({1}SC:U),B,1,-1
S:Lscreen_manager.draw_intro$idx$1_0$98({1}SC:U),R,0,0,[c]
...
S:Lscreen_manager.draw_punc$idx$1_0$104({1}SC:U),R,0,0,[]
F:Fscreen_manager$draw_flip$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_flip$idx$1_0$105({1}SC:U),R,0,0,[]
