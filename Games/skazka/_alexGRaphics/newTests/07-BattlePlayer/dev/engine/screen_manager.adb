...
F:Fscreen_manager$draw_battle_player$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fscreen_manager$draw_leshy$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fscreen_manager$draw_intro$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_intro$row$1_0$99({1}SC:U),B,1,-1
S:Lscreen_manager.draw_intro$idx$1_0$99({1}SC:U),R,0,0,[c]
S:Lscreen_manager.draw_intro$sloc0$0_1$0({1}SC:U),B,1,-1
F:Fscreen_manager$draw_boss$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fscreen_manager$draw_title2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lscreen_manager.draw_punc$idx$1_0$106({1}SC:U),R,0,0,[]
F:Fscreen_manager$draw_flip$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_flip$idx$1_0$107({1}SC:U),R,0,0,[]
...
S:G$engine_content_manager_load_battle_player$0_0$0({2}DF,SV:S),C,0,0
...
S:G$engine_graphics_manager_draw_battle_player$0_0$0({2}DF,SV:S),C,0,0
