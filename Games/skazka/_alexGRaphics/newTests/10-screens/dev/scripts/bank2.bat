...
C:\SEGA\bmp2tile043\bmp2tile.exe raw/battle_enemies.png -savetiles "battle_enemies (tiles).psgcompr" -noremovedupes -nomirror -planar -tileoffset 64   -savetilemap "battle_enemies (tilemap).bin" -exit
C:\SEGA\bmp2tile043\bmp2tile.exe raw/battle_player.png  -savetiles "battle_player (tiles).psgcompr"  -noremovedupes -nomirror -planar -tileoffset 256  -savetilemap "battle_player (tilemap).bin"  -exit
