...
bmp2tile.exe raw/battle_enemies_leshy.png -savetiles "battle_enemies_leshy (tiles).psgcompr" -noremovedupes -planar -tileoffset 256  -savetilemap "battle_enemies_leshy (tilemap).bin" -savepalette "sprite (palette).bin" -fullpalette -exit
