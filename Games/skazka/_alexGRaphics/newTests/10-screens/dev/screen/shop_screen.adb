...
S:Lshop_screen.screen_shop_screen_load$po$1_0$118({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lshop_screen.screen_shop_screen_load$row$1_0$118({1}SC:U),B,1,-1
S:Lshop_screen.screen_shop_screen_load$idx$1_0$118({1}SC:U),R,0,0,[c]
