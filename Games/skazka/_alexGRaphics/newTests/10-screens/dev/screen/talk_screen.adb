...
S:Ltalk_screen.screen_talk_screen_update$screen_type$1_0$161({2}DG,SC:U),B,1,4
S:Ltalk_screen.screen_talk_screen_update$ho$1_0$162({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_update$input1$1_0$162({1}SC:U),R,0,0,[a]
S:Ltalk_screen.screen_talk_screen_update$input2$1_0$162({1}SC:U),R,0,0,[a]
F:Ftalk_screen$display_msg$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltalk_screen.display_msg$row$1_0$168({1}SC:U),R,0,0,[b]
S:Ltalk_screen.display_msg$msg$1_0$168({1}SC:U),R,0,0,[c]
S:Ltalk_screen.display_msg$idx$1_0$168({1}SC:U),R,0,0,[e]
S:Ltalk_screen.display_msg$beg$1_0$168({1}SC:U),B,1,-2
S:Ltalk_screen.display_msg$txt$1_0$168({1}SC:U),R,0,0,[a]
