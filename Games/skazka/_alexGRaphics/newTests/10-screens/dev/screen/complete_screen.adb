...
S:Lcomplete_screen.screen_complete_screen_load$row$1_0$101({1}SC:U),B,1,-1
S:Lcomplete_screen.screen_complete_screen_load$idx$1_0$101({1}SC:U),R,0,0,[c]
...
S:Lcomplete_screen.screen_complete_screen_update$screen_type$1_0$104({2}DG,SC:U),B,1,4
