...
S:Lforest_screen.screen_forest_screen_load$po$1_0$156({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_load$go$1_0$156({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_forest_screen_update$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1_0$158({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$po$1_0$159({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$ho$1_0$159({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$go$1_0$159({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$random$1_0$159({1}SC:U),R,0,0,[b]
S:Lforest_screen.screen_forest_screen_update$input$1_0$159({1}SC:U),R,0,0,[a]
S:Lforest_screen.screen_forest_screen_update$value$1_0$159({1}SC:U),R,0,0,[a]
S:Lforest_screen.screen_forest_screen_update$xp$1_0$159({1}SC:U),B,1,-3
S:Lforest_screen.screen_forest_screen_update$add_armor$1_0$159({1}:S),R,0,0,[l]
...
S:Lforest_screen.setup$row$1_0$180({1}SC:U),B,1,-1
S:Lforest_screen.setup$idx$1_0$180({1}SC:U),R,0,0,[c]
...
S:Lforest_screen.calc_add_armor$go$1_0$185({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$eo$1_0$185({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$po$1_0$185({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$add_armor$1_0$185({1}:S),R,0,0,[c]
