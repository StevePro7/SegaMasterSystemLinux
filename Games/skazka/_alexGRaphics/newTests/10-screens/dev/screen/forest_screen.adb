M:forest_screen
F:G$screen_forest_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.screen_forest_screen_load$po$1_0$155({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_load$go$1_0$155({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_forest_screen_update$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1_0$157({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$po$1_0$158({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$ho$1_0$158({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$go$1_0$158({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$random$1_0$158({1}SC:U),R,0,0,[b]
S:Lforest_screen.screen_forest_screen_update$input$1_0$158({1}SC:U),R,0,0,[a]
S:Lforest_screen.screen_forest_screen_update$value$1_0$158({1}SC:U),R,0,0,[a]
S:Lforest_screen.screen_forest_screen_update$xp$1_0$158({1}SC:U),B,1,-3
S:Lforest_screen.screen_forest_screen_update$add_armor$1_0$158({1}:S),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$sloc0$0_1$0({2}DG,SC:U),B,1,-2
F:Fforest_screen$setup$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
S:Lforest_screen.setup$row$1_0$179({1}SC:U),B,1,-1
S:Lforest_screen.setup$idx$1_0$179({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$sloc0$0_1$0({1}SC:U),B,1,-1
S:Lforest_screen.setup$sloc1$0_1$0({1}SC:U),B,1,-1
F:Fforest_screen$calc_add_armor$0_0$0({2}DF,:S),Z,0,0,0,0,0
S:Lforest_screen.calc_add_armor$go$1_0$184({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$eo$1_0$184({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$po$1_0$184({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$add_armor$1_0$184({1}:S),R,0,0,[c]
T:Fforest_screen$tag_struct_player_object[({0}S:S$xp$0_0$0({1}SC:U),Z,0,0)({1}S:S$hp$0_0$0({1}SC:U),Z,0,0)({2}S:S$gold$0_0$0({2}SI:U),Z,0,0)({4}S:S$weapon$0_0$0({1}SC:U),Z,0,0)({5}S:S$armor$0_0$0({1}SC:U),Z,0,0)({6}S:S$life$0_0$0({1}SC:U),Z,0,0)({7}S:S$level$0_0$0({1}SC:U),Z,0,0)({8}S:S$max_hp$0_0$0({1}SC:U),Z,0,0)({9}S:S$max_xp$0_0$0({1}SC:U),Z,0,0)({10}S:S$won$0_0$0({1}SC:U),Z,0,0)({11}S:S$def_xp$0_0$0({1}SC:U),Z,0,0)({12}S:S$def_hp$0_0$0({1}SC:U),Z,0,0)({13}S:S$def_gold$0_0$0({2}SI:U),Z,0,0)({15}S:S$def_weapon$0_0$0({1}SC:U),Z,0,0)({16}S:S$def_armor$0_0$0({1}SC:U),Z,0,0)({17}S:S$def_life$0_0$0({1}SC:U),Z,0,0)]
T:Fforest_screen$tag_struct_hack_object[({0}S:S$hack_delays$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_nodead$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_currxp$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_currhp$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_goldno$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_weapon$0_0$0({1}SC:U),Z,0,0)({6}S:S$hack_armors$0_0$0({1}SC:U),Z,0,0)({7}S:S$hack_oneups$0_0$0({1}SC:U),Z,0,0)({8}S:S$hack_talker$0_0$0({1}SC:U),Z,0,0)({9}S:S$hack_musics$0_0$0({1}SC:U),Z,0,0)({10}S:S$hack_sounds$0_0$0({1}SC:U),Z,0,0)]
T:Fforest_screen$tag_struct_game_object[({0}S:S$intro_once$0_0$0({1}:S),Z,0,0)({1}S:S$play_music$0_0$0({1}:S),Z,0,0)({2}S:S$flash_arrow$0_0$0({1}:S),Z,0,0)({3}S:S$difficulty$0_0$0({1}SC:U),Z,0,0)]
T:Fforest_screen$tag_struct_enemy_object[({0}S:S$index$0_0$0({1}SC:U),Z,0,0)({1}S:S$hplo$0_0$0({1}SC:U),Z,0,0)({2}S:S$ax$0_0$0({1}SC:U),Z,0,0)({3}S:S$gldo$0_0$0({1}SC:U),Z,0,0)({4}S:S$xpo$0_0$0({1}SC:U),Z,0,0)]
T:Fforest_screen$tag_struct_aelect_object[({0}S:S$select_index$0_0$0({8}DA8d,SC:U),Z,0,0)({8}S:S$select_X$0_0$0({1}SC:U),Z,0,0)({9}S:S$select_Y$0_0$0({1}SC:U),Z,0,0)({10}S:S$select_min$0_0$0({1}SC:U),Z,0,0)({11}S:S$select_max$0_0$0({1}SC:U),Z,0,0)]
S:G$run_away_hit$0_0$0({2}DA2d,SC:U),E,0,0
...
S:Fforest_screen$curr_selection$0_0$0({1}SC:U),E,0,0
S:Fforest_screen$prev_selection$0_0$0({1}SC:U),E,0,0
S:Fforest_screen$event_stage$0_0$0({1}SC:U),E,0,0
S:Fforest_screen$enemys_damage$0_0$0({1}SC:U),E,0,0
S:Fforest_screen$player_damage$0_0$0({1}SC:U),E,0,0
S:Fforest_screen$player_gold$0_0$0({1}SC:U),E,0,0
S:Fforest_screen$select_type$0_0$0({1}SC:U),E,0,0
S:Fforest_screen$run_away_val$0_0$0({1}SC:U),E,0,0
...
S:G$engine_fight_manager_player_to_enemy$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_fight_manager_enemy_to_player$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_fight_manager_player_to_boss$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_fight_manager_boss_to_player$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_fight_manager_gold$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_boss_manager_draw$0_0$0({2}DF,SV:S),C,0,0
...
S:G$engine_random_manager_diff$0_0$0({2}DF,:S),C,0,0
