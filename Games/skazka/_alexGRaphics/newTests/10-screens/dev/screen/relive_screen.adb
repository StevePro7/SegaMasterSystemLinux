...
F:G$screen_relive_screen_update$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lrelive_screen.screen_relive_screen_update$screen_type$1_0$115({2}DG,SC:U),B,1,4
S:Lrelive_screen.screen_relive_screen_update$timer$1_0$116({1}SC:U),R,0,0,[a]
S:Lrelive_screen.screen_relive_screen_update$input$1_0$116({1}SC:U),B,1,-1
