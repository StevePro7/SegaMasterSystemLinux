...
S:Lintro_screen.screen_intro_screen_load$row$1_0$126({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_load$idx$1_0$126({1}SC:U),R,0,0,[c]
...
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$129({2}DG,SC:U),B,1,4
