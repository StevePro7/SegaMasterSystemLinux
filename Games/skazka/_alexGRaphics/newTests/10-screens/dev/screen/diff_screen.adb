...
S:Ldiff_screen.screen_diff_screen_update$screen_type$1_0$127({2}DG,SC:U),B,1,4
S:Ldiff_screen.screen_diff_screen_update$ho$1_0$128({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_update$go$1_0$128({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_update$selection$1_0$128({1}SC:U),R,0,0,[a]
S:Ldiff_screen.screen_diff_screen_update$timer$1_0$128({1}SC:U),R,0,0,[a]
