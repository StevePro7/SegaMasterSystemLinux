...
S:Lboss_screen.screen_boss_screen_load$go$1_0$159({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_load$row$1_0$159({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_load$idx$1_0$159({1}SC:U),R,0,0,[c]
S:Lboss_screen.screen_boss_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_boss_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1_0$163({2}DG,SC:U),B,1,4
S:Lboss_screen.screen_boss_screen_update$po$1_0$164({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$ho$1_0$164({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$selection$1_0$164({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_update$random$1_0$164({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_update$input$1_0$164({1}SC:U),R,0,0,[a]
S:Lboss_screen.screen_boss_screen_update$idx$1_0$164({1}SC:U),R,0,0,[b]
S:Lboss_screen.screen_boss_screen_update$row$1_0$164({1}SC:U),R,0,0,[b]
S:Lboss_screen.screen_boss_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
F:Fboss_screen$boss_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_init$p_weapon$1_0$182({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_init$p_armor$1_0$182({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_init$po$1_0$183({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fboss_screen$boss_stats$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_stats$p_weapon$1_0$184({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_stats$p_armor$1_0$184({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_stats$po$1_0$185({2}DG,STtag_struct_player_object:S),R,0,0,[l,h]
F:Fboss_screen$boss_laugh$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_laugh$selection$1_0$187({1}SC:U),B,1,4
