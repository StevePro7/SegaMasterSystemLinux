...
S:Lboss_screen.screen_boss_screen_load$go$1_0$158({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_load$row$1_0$158({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_load$idx$1_0$158({1}SC:U),R,0,0,[c]
S:Lboss_screen.screen_boss_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_boss_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1_0$162({2}DG,SC:U),B,1,4
S:Lboss_screen.screen_boss_screen_update$po$1_0$163({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$ho$1_0$163({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$selection$1_0$163({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_update$random$1_0$163({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_update$input$1_0$163({1}SC:U),R,0,0,[a]
S:Lboss_screen.screen_boss_screen_update$idx$1_0$163({1}SC:U),R,0,0,[c]
S:Lboss_screen.screen_boss_screen_update$row$1_0$163({1}SC:U),R,0,0,[b]
S:Lboss_screen.screen_boss_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
F:Fboss_screen$boss_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_init$p_weapon$1_0$181({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_init$p_armor$1_0$181({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_init$po$1_0$182({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fboss_screen$boss_stats$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_stats$p_weapon$1_0$183({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_stats$p_armor$1_0$183({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_stats$po$1_0$184({2}DG,STtag_struct_player_object:S),R,0,0,[l,h]
F:Fboss_screen$boss_laugh$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_laugh$selection$1_0$186({1}SC:U),B,1,4
T:Fboss_screen$tag_struct_player_object[({0}S:S$xp$0_0$0({1}SC:U),Z,0,0)({1}S:S$hp$0_0$0({1}SC:U),Z,0,0)({2}S:S$gold$0_0$0({2}SI:U),Z,0,0)({4}S:S$weapon$0_0$0({1}SC:U),Z,0,0)({5}S:S$armor$0_0$0({1}SC:U),Z,0,0)({6}S:S$life$0_0$0({1}SC:U),Z,0,0)({7}S:S$level$0_0$0({1}SC:U),Z,0,0)({8}S:S$max_hp$0_0$0({1}SC:U),Z,0,0)({9}S:S$max_xp$0_0$0({1}SC:U),Z,0,0)({10}S:S$won$0_0$0({1}SC:U),Z,0,0)({11}S:S$def_xp$0_0$0({1}SC:U),Z,0,0)({12}S:S$def_hp$0_0$0({1}SC:U),Z,0,0)({13}S:S$def_gold$0_0$0({2}SI:U),Z,0,0)({15}S:S$def_weapon$0_0$0({1}SC:U),Z,0,0)({16}S:S$def_armor$0_0$0({1}SC:U),Z,0,0)({17}S:S$def_life$0_0$0({1}SC:U),Z,0,0)]
T:Fboss_screen$tag_struct_hack_object[({0}S:S$hack_delays$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_nodead$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_currxp$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_currhp$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_goldno$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_weapon$0_0$0({1}SC:U),Z,0,0)({6}S:S$hack_armors$0_0$0({1}SC:U),Z,0,0)({7}S:S$hack_oneups$0_0$0({1}SC:U),Z,0,0)({8}S:S$hack_talker$0_0$0({1}SC:U),Z,0,0)({9}S:S$hack_musics$0_0$0({1}SC:U),Z,0,0)({10}S:S$hack_sounds$0_0$0({1}SC:U),Z,0,0)]
T:Fboss_screen$tag_struct_game_object[({0}S:S$intro_once$0_0$0({1}:S),Z,0,0)({1}S:S$play_music$0_0$0({1}:S),Z,0,0)({2}S:S$flash_arrow$0_0$0({1}:S),Z,0,0)({3}S:S$difficulty$0_0$0({1}SC:U),Z,0,0)]
T:Fboss_screen$tag_struct_enemy_object[({0}S:S$index$0_0$0({1}SC:U),Z,0,0)({1}S:S$hplo$0_0$0({1}SC:U),Z,0,0)({2}S:S$ax$0_0$0({1}SC:U),Z,0,0)({3}S:S$gldo$0_0$0({1}SC:U),Z,0,0)({4}S:S$xpo$0_0$0({1}SC:U),Z,0,0)]
T:Fboss_screen$tag_struct_aelect_object[({0}S:S$select_index$0_0$0({8}DA8d,SC:U),Z,0,0)({8}S:S$select_X$0_0$0({1}SC:U),Z,0,0)({9}S:S$select_Y$0_0$0({1}SC:U),Z,0,0)({10}S:S$select_min$0_0$0({1}SC:U),Z,0,0)({11}S:S$select_max$0_0$0({1}SC:U),Z,0,0)]
S:G$beg_boss_hit$0_0$0({2}DA2d,SC:U),E,0,0
...
S:Fboss_screen$player_damage$0_0$0({1}SC:U),E,0,0
S:Fboss_screen$player_weapon$0_0$0({1}SC:U),E,0,0
S:Fboss_screen$player_armor$0_0$0({1}SC:U),E,0,0
S:Fboss_screen$beg_boss_val$0_0$0({1}SC:U),E,0,0
S:Fboss_screen$first_time$0_0$0({1}:S),E,0,0
