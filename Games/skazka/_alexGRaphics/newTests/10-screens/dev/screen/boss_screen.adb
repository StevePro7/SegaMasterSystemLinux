...
S:Lboss_screen.screen_boss_screen_load$row$1_0$129({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_load$idx$1_0$129({1}SC:U),R,0,0,[c]
S:Lboss_screen.screen_boss_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_boss_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1_0$132({2}DG,SC:U),B,1,4
...
T:Fboss_screen$tag_struct_timer_object[({0}S:S$timer_count$0_0$0({2}SI:U),Z,0,0)({2}S:S$timer_value$0_0$0({2}SI:U),Z,0,0)]
