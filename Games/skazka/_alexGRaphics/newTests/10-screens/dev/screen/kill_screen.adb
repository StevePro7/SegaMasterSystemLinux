M:kill_screen
F:G$screen_kill_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_kill_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lkill_screen.screen_kill_screen_update$screen_type$1_0$10({2}DG,SC:U),B,1,4
