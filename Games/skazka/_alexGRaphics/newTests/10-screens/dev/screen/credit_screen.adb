...
S:Lcredit_screen.screen_credit_screen_update$screen_type$1_0$104({2}DG,SC:U),B,1,4
S:Lcredit_screen.screen_credit_screen_update$input1$1_0$105({1}SC:U),B,1,-2
S:Lcredit_screen.screen_credit_screen_update$input2$1_0$105({1}SC:U),B,1,-1
S:Lcredit_screen.screen_credit_screen_update$timer$1_0$105({1}SC:U),R,0,0,[c]
S:Lcredit_screen.screen_credit_screen_update$sloc0$0_1$0({1}SC:U),B,1,-2
S:Lcredit_screen.screen_credit_screen_update$sloc1$0_1$0({1}SC:U),B,1,-1
F:Fcredit_screen$display$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lcredit_screen.display$row$1_0$107({1}SC:U),B,1,-1
S:Lcredit_screen.display$idx$1_0$107({1}SC:U),R,0,0,[c]
S:Lcredit_screen.display$x1$1_0$107({1}SC:U),R,0,0,[]
S:Lcredit_screen.display$x2$1_0$107({1}SC:U),R,0,0,[]
S:Lcredit_screen.display$sloc0$0_1$0({1}SC:U),B,1,-1
T:Fcredit_screen$tag_struct_game_object[({0}S:S$intro_once$0_0$0({1}:S),Z,0,0)({1}S:S$play_music$0_0$0({1}:S),Z,0,0)({2}S:S$flash_arrow$0_0$0({1}:S),Z,0,0)({3}S:S$difficulty$0_0$0({1}SC:U),Z,0,0)]
T:Fcredit_screen$tag_struct_timer_object[({0}S:S$timer_count$0_0$0({2}SI:U),Z,0,0)({2}S:S$timer_value$0_0$0({2}SI:U),Z,0,0)]
