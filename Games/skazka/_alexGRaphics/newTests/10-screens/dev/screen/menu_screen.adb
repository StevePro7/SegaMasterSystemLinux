...
S:Lmenu_screen.screen_menu_screen_load$row$1_0$103({1}SC:U),B,1,-1
S:Lmenu_screen.screen_menu_screen_load$idx$1_0$103({1}SC:U),R,0,0,[c]
S:Lmenu_screen.screen_menu_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_menu_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmenu_screen.screen_menu_screen_update$screen_type$1_0$106({2}DG,SC:U),B,1,4
S:Lmenu_screen.screen_menu_screen_update$selection$1_0$107({1}SC:U),R,0,0,[l]
