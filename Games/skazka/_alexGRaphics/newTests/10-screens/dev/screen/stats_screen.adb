...
S:Lstats_screen.screen_stats_screen_load$go$1_0$133({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lstats_screen.screen_stats_screen_load$flash_arrow$1_0$133({1}:S),R,0,0,[c]
F:G$screen_stats_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstats_screen.screen_stats_screen_update$screen_type$1_0$135({2}DG,SC:U),B,1,4
S:Lstats_screen.screen_stats_screen_update$selection$1_0$136({1}SC:U),B,1,-1
