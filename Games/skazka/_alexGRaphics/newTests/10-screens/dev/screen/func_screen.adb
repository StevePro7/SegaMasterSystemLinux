...
S:Lfunc_screen.screen_func_screen_load$row$1_0$97({1}SC:U),B,1,-1
S:Lfunc_screen.screen_func_screen_load$idx$1_0$97({1}SC:U),R,0,0,[c]
S:Lfunc_screen.screen_func_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_func_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.screen_func_screen_update$screen_type$1_0$100({2}DG,SC:U),B,1,4
F:Ffunc_screen$draw_leshy$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Ffunc_screen$draw_intro$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.draw_intro$row$1_0$103({1}SC:U),B,1,-1
S:Lfunc_screen.draw_intro$idx$1_0$103({1}SC:U),R,0,0,[c]
...
S:Lfunc_screen.draw_punc$idx$1_0$109({1}SC:U),R,0,0,[]
F:Ffunc_screen$draw_flip$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.draw_flip$idx$1_0$110({1}SC:U),R,0,0,[]
