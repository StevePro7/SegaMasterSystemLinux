...
S:Lfunc_screen.draw_intro$row$1_0$100({1}SC:U),B,1,-1
S:Lfunc_screen.draw_intro$idx$1_0$100({1}SC:U),R,0,0,[c]
...
S:Lfunc_screen.draw_punc$idx$1_0$106({1}SC:U),R,0,0,[]
F:Ffunc_screen$draw_flip$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.draw_flip$idx$1_0$107({1}SC:U),R,0,0,[]
