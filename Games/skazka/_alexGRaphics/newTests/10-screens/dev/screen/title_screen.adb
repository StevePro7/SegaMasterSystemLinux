...
S:Ltitle_screen.screen_title_screen_update$ho$1_0$130({2}DG,STtag_struct_hack_object:S),R,0,0,[]
...
S:Ltitle_screen.screen_title_screen_update$index$1_0$130({1}SC:U),R,0,0,[c]
