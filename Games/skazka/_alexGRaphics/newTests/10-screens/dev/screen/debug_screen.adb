M:debug_screen
F:G$screen_debug_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_debug_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldebug_screen.screen_debug_screen_update$screen_type$1_0$10({2}DG,SC:U),B,1,4
