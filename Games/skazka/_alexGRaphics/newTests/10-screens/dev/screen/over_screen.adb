...
S:Lover_screen.screen_over_screen_load$row$1_0$105({1}SC:U),B,1,-1
S:Lover_screen.screen_over_screen_load$idx$1_0$105({1}SC:U),R,0,0,[c]
S:Lover_screen.screen_over_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_over_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1_0$108({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$input1$1_0$109({1}SC:U),B,1,-2
S:Lover_screen.screen_over_screen_update$input2$1_0$109({1}SC:U),B,1,-1
S:Lover_screen.screen_over_screen_update$timer$1_0$109({1}SC:U),R,0,0,[l]
S:Lover_screen.screen_over_screen_update$index$1_0$109({1}SC:U),R,0,0,[b]
