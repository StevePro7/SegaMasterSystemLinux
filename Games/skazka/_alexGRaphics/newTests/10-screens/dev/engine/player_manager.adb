...
F:G$engine_player_manager_draw_inventory$0_0$0({2}DF,SV:S),Z,0,-3,0,0,0
...
S:Lplayer_manager.engine_player_manager_draw_inventory$tile$1_0$116({2}SI:U),R,0,0,[c,b]
...
S:Lplayer_manager.engine_player_manager_draw_inventory$sloc2$0_1$0({1}SC:U),B,1,-1
