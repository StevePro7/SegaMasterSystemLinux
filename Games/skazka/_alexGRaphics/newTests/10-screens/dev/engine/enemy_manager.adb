...
S:Lenemy_manager.engine_enemy_manager_init$eo$1_0$120({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_load$level$1_0$121({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_load$value$1_0$122({1}SC:U),R,0,0,[l]
S:Lenemy_manager.engine_enemy_manager_load$index$1_0$122({1}SC:U),R,0,0,[]
F:G$engine_target_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_target_manager_load$index$1_0$133({1}SC:U),B,1,4
S:Lenemy_manager.engine_target_manager_load$eo$1_0$134({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_draw$x$1_0$135({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_draw$y$1_0$135({1}SC:U),B,1,5
S:Lenemy_manager.engine_enemy_manager_draw$eo$1_0$136({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lenemy_manager.engine_enemy_manager_draw$pnt$1_0$136({2}DG,SC:U),R,0,0,[]
S:Lenemy_manager.engine_enemy_manager_draw$wide$1_0$136({1}SC:U),R,0,0,[]
S:Lenemy_manager.engine_enemy_manager_draw$high$1_0$136({1}SC:U),R,0,0,[]
S:Lenemy_manager.engine_enemy_manager_draw$i$1_0$136({1}SC:U),R,0,0,[b]
S:Lenemy_manager.engine_enemy_manager_draw$j$1_0$136({1}SC:U),R,0,0,[c]
S:Lenemy_manager.engine_enemy_manager_draw$idx$1_0$136({1}SC:U),R,0,0,[]
S:Lenemy_manager.engine_enemy_manager_draw$tile$1_0$136({2}SI:U),R,0,0,[e,d]
S:Lenemy_manager.engine_enemy_manager_draw$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$engine_enemy_manager_text$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_text$eo$1_0$141({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_hplo$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_hplo$eo$1_0$142({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_hit$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_hit$hp$1_0$143({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_hit$eo$1_0$144({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_dead$0_0$0({2}DF,:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_dead$eo$1_0$147({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
