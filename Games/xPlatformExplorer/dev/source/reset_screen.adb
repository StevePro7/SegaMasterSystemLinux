M:reset_screen
F:G$screen_reset_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_reset_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lreset_screen.screen_reset_screen_update$screen_type$1_0$8({2}DG,SC:U),B,1,4
S:Lreset_screen.screen_reset_screen_update$ro$1_0$9({2}DG,STtag_struct_reset_object:S),R,0,0,[]
S:Lreset_screen.screen_reset_screen_update$go$1_0$9({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lreset_screen.screen_reset_screen_update$delay$1_0$9({1}SC:U),R,0,0,[l]
...
T:Freset_screen$tag_struct_game_object[({0}S:S$invincible$0_0$0({1}SC:U),Z,0,0)({1}S:S$localcheat$0_0$0({1}SC:U),Z,0,0)({2}S:S$difficulty$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_speed$0_0$0({1}SC:U),Z,0,0)({4}S:S$tutorial$0_0$0({1}SC:U),Z,0,0)({5}S:S$world_no$0_0$0({1}SC:U),Z,0,0)({6}S:S$round_no$0_0$0({1}SC:U),Z,0,0)]
T:Freset_screen$tag_struct_delay_object[({0}S:S$delay_delay$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
...
T:Freset_screen$tag_struct_reset_object[({0}S:S$reset_frame$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)({2}S:S$reset_screen$0_0$0({1}SC:U),Z,0,0)]
T:Freset_screen$tag_struct_enemy_master[({0}S:S$max_enemies$0_0$0({1}SC:U),Z,0,0)]
...
S:Freset_screen$stage$0_0$0({1}SC:U),E,0,0
