...
S:Lmain.main$open_screen_type$1$123({1}SC:U),R,0,0,[]
T:Fmain$tag_struct_hack_object[({0}S:S$hack_steps$0$0({1}SC:U),Z,0,0)({1}S:S$hack_delay$0$0({1}SC:U),Z,0,0)({2}S:S$hack_hands$0$0({1}SC:U),Z,0,0)({3}S:S$hack_music$0$0({1}SC:U),Z,0,0)({4}S:S$hack_sound$0$0({1}SC:U),Z,0,0)({5}S:S$hack_paths$0$0({1}SC:U),Z,0,0)]
S:G$global_hack_object$0$0({6}STtag_struct_hack_object:S),E,0,0
S:Lmain.main$global_pause$1$123({1}:S),E,0,0
