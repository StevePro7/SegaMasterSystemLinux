...
S:Lplay_screen.screen_play_screen_load$go$1$99({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_load$po$1$99({2}DG,STtag_struct_path_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_load$direction$1$99({1}SC:U),R,0,0,[b]
F:G$screen_play_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplay_screen.screen_play_screen_update$screen_type$1$100({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$go$1$101({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$po$1$101({2}DG,STtag_struct_path_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$direction$1$101({1}SC:U),R,0,0,[b]
S:Lplay_screen.screen_play_screen_update$input$1$101({1}SC:U),R,0,0,[l]
