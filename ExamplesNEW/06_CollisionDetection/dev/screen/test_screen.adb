...
S:Ltest_screen.screen_test_screen_update$screen_type$1$87({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$collide$1$88({1}:S),R,0,0,[c]
S:Ltest_screen.screen_test_screen_update$input$1$88({1}SC:U),R,0,0,[c]
