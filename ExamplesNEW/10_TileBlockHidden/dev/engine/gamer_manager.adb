...
S:Lgamer_manager.engine_gamer_manager_init$px$1$68({1}SC:U),B,1,4
S:Lgamer_manager.engine_gamer_manager_init$py$1$68({1}SC:U),B,1,5
S:Lgamer_manager.engine_gamer_manager_init$vel$1$68({1}SC:U),B,1,6
S:Lgamer_manager.engine_gamer_manager_init$tile$1$68({2}SI:U),B,1,7
S:Lgamer_manager.engine_gamer_manager_init$go$1$69({2}DG,STtag_struct_gamer_object:S),R,0,0,[c,b]
F:G$engine_gamer_manager_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgamer_manager.engine_gamer_manager_update$dx$1$70({1}SC:U),B,1,4
