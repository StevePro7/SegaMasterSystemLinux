...
S:Laudio_manager.engine_music_manager_play$ho$1$37({2}DG,STtag_struct_hack_object:S),R,0,0,[]
F:G$engine_sound_manager_play$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_sound_manager_play$ho$1$39({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Laudio_manager.engine_sound_manager_play$sound$1$39({1}SC:U),R,0,0,[e]
S:Laudio_manager.engine_sound_manager_play$sfx$1$39({2}DG,SV:S),R,0,0,[c,b]
T:Faudio_manager$tag_struct_hack_object[({0}S:S$hack_steps$0$0({1}SC:U),Z,0,0)({1}S:S$hack_delay$0$0({1}SC:U),Z,0,0)({2}S:S$hack_hands$0$0({1}SC:U),Z,0,0)({3}S:S$hack_music$0$0({1}SC:U),Z,0,0)({4}S:S$hack_sound$0$0({1}SC:U),Z,0,0)({5}S:S$hack_paths$0$0({1}SC:U),Z,0,0)]
