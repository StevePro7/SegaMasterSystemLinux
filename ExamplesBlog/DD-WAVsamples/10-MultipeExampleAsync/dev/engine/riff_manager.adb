...
S:Lriff_manager.engine_riff_manager_play$index$1_0$90({1}SC:U),B,1,4
S:Lriff_manager.engine_riff_manager_play$data$1_0$91({2}DG,SC:U),R,0,0,[e,d]
S:Lriff_manager.engine_riff_manager_play$bank$1_0$91({1}SC:U),R,0,0,[a]
