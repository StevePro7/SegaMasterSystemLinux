...
S:Lmap_manager.engine_map_manager_init$level_data$1_0$67({2}DG,SC:U),B,1,4
S:Lmap_manager.engine_map_manager_init$map_data$1_0$68({2}DG,STtag_struct_map_object:S),R,0,0,[]
...
S:Lmap_manager.engine_map_manager_draw_map_screen$map_data$1_0$71({2}DG,STtag_struct_map_object:S),R,0,0,[]
F:G$engine_map_manager_draw_map$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap_manager.engine_map_manager_draw_map$map_data$1_0$73({2}DG,STtag_struct_map_object:S),R,0,0,[]
F:Fmap_manager$draw_map_row$0_0$0({2}DF,SV:S),Z,0,16,0,0,0
S:Lmap_manager.draw_map_row$map_data$1_0$78({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.draw_map_row$i$1_0$78({1}SC:U),B,1,-4
S:Lmap_manager.draw_map_row$j$1_0$78({1}SC:U),B,1,-1
S:Lmap_manager.draw_map_row$y$1_0$78({1}SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$map_char$1_0$78({2}DG,SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$base_tile$1_0$78({2}SI:U),R,0,0,[e,d]
S:Lmap_manager.draw_map_row$tile$1_0$78({2}SI:U),R,0,0,[l,h]
S:Lmap_manager.draw_map_row$buffer$1_0$78({16}DA16d,SC:U),B,1,-23
...
S:Lmap_manager.decompress_map_row$buffer$1_0$86({2}DG,SC:U),B,1,4
S:Lmap_manager.decompress_map_row$map_data$1_0$87({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.decompress_map_row$o$1_0$87({2}DG,SC:U),R,0,0,[c,b]
S:Lmap_manager.decompress_map_row$d$1_0$87({2}DG,SC:U),R,0,0,[l,h]
S:Lmap_manager.decompress_map_row$remaining$1_0$87({1}SC:U),R,0,0,[e]
S:Lmap_manager.decompress_map_row$ch$1_0$87({1}SC:U),R,0,0,[d]
S:Lmap_manager.decompress_map_row$repeat$1_0$87({1}SC:U),R,0,0,[]
