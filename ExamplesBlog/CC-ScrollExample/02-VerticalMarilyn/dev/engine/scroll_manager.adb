...
S:Lscroll_manager.engine_scroll_manager_init$so$1_0$65({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_up$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_up$so$1_0$66({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_up$index$1_0$66({2}SI:U),R,0,0,[e,d]
S:Lscroll_manager.engine_scroll_manager_up$y$1_0$66({2}SI:U),B,1,-2
...
S:Lscroll_manager.engine_scroll_manager_down$so$1_0$69({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
