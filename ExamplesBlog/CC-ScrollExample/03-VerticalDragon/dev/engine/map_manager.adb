...
S:Lmap_manager.engine_map_manager_draw_map$map_data$1_0$70({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.engine_map_manager_draw_map$lines_before_next$1_0$70({1}SC:U),R,0,0,[]
S:Lmap_manager.engine_map_manager_draw_map$scroll_y$1_0$70({1}SC:U),R,0,0,[]
F:Fmap_manager$draw_map_row$0_0$0({2}DF,SV:S),Z,0,16,0,0,0
S:Lmap_manager.draw_map_row$map_data$1_0$75({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.draw_map_row$i$1_0$75({1}SC:U),B,1,-4
S:Lmap_manager.draw_map_row$j$1_0$75({1}SC:U),B,1,-1
S:Lmap_manager.draw_map_row$y$1_0$75({1}SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$map_char$1_0$75({2}DG,SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$base_tile$1_0$75({2}SI:U),R,0,0,[e,d]
S:Lmap_manager.draw_map_row$tile$1_0$75({2}SI:U),R,0,0,[l,h]
S:Lmap_manager.draw_map_row$buffer$1_0$75({16}DA16d,SC:U),B,1,-23
...
S:Lmap_manager.decompress_map_row$buffer$1_0$83({2}DG,SC:U),B,1,4
S:Lmap_manager.decompress_map_row$map_data$1_0$84({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.decompress_map_row$o$1_0$84({2}DG,SC:U),R,0,0,[c,b]
S:Lmap_manager.decompress_map_row$d$1_0$84({2}DG,SC:U),R,0,0,[l,h]
