...
S:Laudio_manager.engine_audio_manager_init$ao$1_0$109({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_music_manager_play$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_music_manager_play$index$1_0$110({1}SC:U),B,1,4
S:Laudio_manager.engine_music_manager_play$ao$1_0$111({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_music_manager_stop$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_music_manager_stop$ao$1_0$112({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_sound_manager_play$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_sound_manager_play$index$1_0$113({1}SC:U),B,1,4
S:Laudio_manager.engine_sound_manager_play$ao$1_0$114({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_sound_manager_stop$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_sound_manager_stop$ao$1_0$115({2}DG,STtag_struct_audio_object:S),R,0,0,[]
