...
S:Llevel_manager.engine_level_manager_init$lo$1$16({2}DG,STtag_struct_level_object:S),R,0,0,[c,b]
...
S:Llevel_manager.engine_level_manager_update$lo$1$18({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_update$four$1$18({1}SC:U),R,0,0,[]
S:Llevel_manager.engine_level_manager_update$column_Y$1$18({1}SC:U),R,0,0,[]
S:Llevel_manager.engine_level_manager_update$planeA_column$1$18({2}SI:U),R,0,0,[e,d]
S:Llevel_manager.engine_level_manager_update$planeB_column$1$18({2}SI:U),B,1,-5
S:Llevel_manager.engine_level_manager_update$sloc0$1$0({1}SC:U),B,1,-3
