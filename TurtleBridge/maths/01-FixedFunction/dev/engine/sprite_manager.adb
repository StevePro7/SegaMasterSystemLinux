M:sprite_manager
F:G$engine_sprite_manager_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_sprite_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_draw$x$1_0$68({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw$y$1_0$68({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$tile$1_0$68({2}SI:U),B,1,6
