...
S:Lplayer_manager.engine_player_manager_update2$po$1$16({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1$17({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
F:Fplayer_manager$coord$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.coord$po$1$19({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$print$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.print$po$1$20({2}DG,STtag_struct_player_object:S),R,0,0,[]
