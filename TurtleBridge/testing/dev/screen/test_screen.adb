...
S:Ltest_screen.screen_test_screen_update$screen_type$1_0$90({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$input$1_0$91({1}SC:U),R,0,0,[a]
S:Ltest_screen.screen_test_screen_update$x$1_0$91({1}SC:U),R,0,0,[c]
S:Ltest_screen.screen_test_screen_update$y$1_0$91({1}SC:U),R,0,0,[b]
S:Ltest_screen.screen_test_screen_update$f$1_0$91({1}SC:U),R,0,0,[a]
S:Ltest_screen.screen_test_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
F:Ftest_screen$draw_sprite$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.draw_sprite$idx$1_0$94({1}SC:U),B,1,4
S:Ltest_screen.draw_sprite$size$1_0$94({1}SC:U),B,1,5
S:Ltest_screen.draw_sprite$x$1_0$94({1}SC:U),B,1,6
S:Ltest_screen.draw_sprite$y$1_0$94({1}SC:U),B,1,7
S:Ltest_screen.draw_sprite$wide$1_0$95({1}SC:U),R,0,0,[]
S:Ltest_screen.draw_sprite$high$1_0$95({1}SC:U),R,0,0,[]
S:Ltest_screen.draw_sprite$num$1_0$95({1}SC:U),R,0,0,[a]
S:Ltest_screen.draw_sprite$i$1_0$95({1}SC:U),R,0,0,[d]
S:Ltest_screen.draw_sprite$j$1_0$95({1}SC:U),R,0,0,[e]
S:Ltest_screen.draw_sprite$sloc0$0_1$0({1}SC:U),B,1,-4
S:Ltest_screen.draw_sprite$sloc1$0_1$0({1}SC:U),B,1,-3
S:Ltest_screen.draw_sprite$sloc2$0_1$0({1}SC:U),B,1,-2
S:Ltest_screen.draw_sprite$sloc3$0_1$0({1}SC:S),B,1,-1
S:Ftest_screen$posX$0_0$0({9}DA9d,SC:U),E,0,0
S:Ftest_screen$posY$0_0$0({9}DA9d,SC:U),E,0,0
