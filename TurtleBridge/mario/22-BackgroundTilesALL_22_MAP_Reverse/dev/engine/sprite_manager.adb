...
S:Lsprite_manager.engine_turtle_manager_draw_sea$pnt$1$66({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_turtle_manager_draw_sea$x$1$66({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_turtle_manager_draw_sea$y$1$66({1}SC:U),R,0,0,[c]
F:G$draw_tops$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lsprite_manager.draw_tops$x$1$71({1}SC:U),B,1,4
S:Lsprite_manager.draw_tops$y$1$71({1}SC:U),B,1,5
S:Lsprite_manager.draw_tops$pnt$1$72({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.draw_tops$z$1$72({1}SC:U),R,0,0,[c]
F:G$draw_ones$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lsprite_manager.draw_ones$x$1$75({1}SC:U),B,1,4
S:Lsprite_manager.draw_ones$y$1$75({1}SC:U),B,1,5
S:Lsprite_manager.draw_ones$pnt$1$76({2}DG,SC:U),R,0,0,[]
F:G$draw_four$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lsprite_manager.draw_four$x$1$77({1}SC:U),B,1,4
S:Lsprite_manager.draw_four$y$1$77({1}SC:U),B,1,5
S:Lsprite_manager.draw_four$pnt$1$78({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.draw_four$z$1$78({1}SC:U),R,0,0,[c]
F:G$draw_five$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lsprite_manager.draw_five$x$1$81({1}SC:U),B,1,4
S:Lsprite_manager.draw_five$y$1$81({1}SC:U),B,1,5
S:Lsprite_manager.draw_five$pnt$1$82({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.draw_five$z$1$82({1}SC:U),R,0,0,[c]
F:G$engine_turtle_manager_draw_title$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_turtle_manager_draw_title$x$1$85({1}SC:U),B,1,4
S:Lsprite_manager.engine_turtle_manager_draw_title$y$1$85({1}SC:U),B,1,5
S:Lsprite_manager.engine_turtle_manager_draw_title$pnt$1$86({2}DG,SC:U),R,0,0,[]
...
S:G$draw_tops$0$0({2}DF,SV:S),C,0,0
S:G$draw_ones$0$0({2}DF,SV:S),C,0,0
S:G$draw_four$0$0({2}DF,SV:S),C,0,0
S:G$draw_five$0$0({2}DF,SV:S),C,0,0
