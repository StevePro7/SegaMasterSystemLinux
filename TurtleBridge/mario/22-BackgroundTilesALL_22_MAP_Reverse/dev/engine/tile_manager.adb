...
S:Ltile_manager.engine_tile_manager_section01_left$flip$1$91({2}SI:U),B,1,-4
...
S:Ltile_manager.engine_tile_manager_section01_left$tmp$1$91({1}SC:U),B,1,-2
...
F:Ftile_manager$draw_tile_next$0$0({2}DF,SV:S),Z,0,3,0,0,0
...
S:Ltile_manager.draw_tile_next$idx$1$111({1}SC:U),R,0,0,[c]
S:Ltile_manager.draw_tile_next$val$1$111({2}SI:U),R,0,0,[c,b]
S:Ltile_manager.draw_tile_next$row$1$111({1}SC:U),R,0,0,[e]
S:Ltile_manager.draw_tile_next$col$1$111({1}SC:U),B,1,-5
S:Ltile_manager.draw_tile_next$tmp$1$111({1}SC:U),R,0,0,[c]
S:Ltile_manager.draw_tile_next$flip$1$111({2}SI:U),B,1,-4
