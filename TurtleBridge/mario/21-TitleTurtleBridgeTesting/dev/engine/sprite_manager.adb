...
S:Lsprite_manager.engine_turtle_manager_draw_sea$pnt$1$67({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_turtle_manager_draw_sea$x$1$67({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_turtle_manager_draw_sea$y$1$67({1}SC:U),R,0,0,[c]
F:G$engine_turtle_manager_draw_01$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lsprite_manager.engine_turtle_manager_draw_01$x$1$72({1}SC:U),B,1,4
S:Lsprite_manager.engine_turtle_manager_draw_01$y$1$72({1}SC:U),B,1,5
S:Lsprite_manager.engine_turtle_manager_draw_01$pnt$1$73({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_turtle_manager_draw_01$ix$1$73({1}SC:U),B,1,-3
S:Lsprite_manager.engine_turtle_manager_draw_01$iy$1$73({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_turtle_manager_draw_01$idx$1$73({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_turtle_manager_draw_01$val$1$73({2}SI:U),R,0,0,[l,h]
S:Lsprite_manager.engine_turtle_manager_draw_01$sloc0$1$0({2}DG,SV:S),B,1,-2
F:G$engine_turtle_manager_draw_02$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_turtle_manager_draw_02$x$1$78({1}SC:U),B,1,4
S:Lsprite_manager.engine_turtle_manager_draw_02$y$1$78({1}SC:U),B,1,5
S:Lsprite_manager.engine_turtle_manager_draw_02$pnt$1$79({2}DG,SC:U),R,0,0,[]
