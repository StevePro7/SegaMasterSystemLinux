...
S:Lscreen_manager.engine_screen_manager_update$input$1_0$7({1}SC:U),R,0,0,[a]
S:Lscreen_manager.engine_screen_manager_update$diff$1_0$7({1}SC:U),R,0,0,[c]
S:Fscreen_manager$index$0_0$0({1}SC:U),E,0,0
S:Fscreen_manager$x$0_0$0({1}SC:U),E,0,0
S:Fscreen_manager$z$0_0$0({1}SC:U),E,0,0
