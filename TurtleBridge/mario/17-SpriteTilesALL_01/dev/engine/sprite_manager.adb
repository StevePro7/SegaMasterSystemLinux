...
S:Lsprite_manager.engine_sprite_manager_draw$x$1$67({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw$y$1$67({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$tile$1$67({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1$68({1}SC:U),R,0,0,[]
F:G$engine_sprite_manager_fish$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_fish$x$1$69({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_fish$y$1$69({1}SC:U),B,1,5
...
S:Lsprite_manager.engine_sprite_manager_fish$sloc0$1$0({1}SC:U),B,1,-3
S:Lsprite_manager.engine_sprite_manager_fish$sloc1$1$0({1}SC:U),B,1,-1
