...
S:Lscroll_manager.engine_scroll_manager_init$so$1$70({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_scroll_manager_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$so$1$72({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_getPosY$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_getPosY$col$1$74({2}SI:U),B,1,4
F:Fscroll_manager$print$0$0({2}DF,SV:S),C,0,0,0,0,0
T:Fscroll_manager$tag_struct_scroll_object[({0}S:S$scroll_left$0$0({1}SC:U),Z,0,0)({1}S:S$scroll_right$0$0({1}SC:U),Z,0,0)({2}S:S$scroll$0$0({1}SC:U),Z,0,0)({3}S:S$scrollRight$0$0({1}SC:U),Z,0,0)({4}S:S$scrollRightDivided8$0$0({1}SC:U),Z,0,0)({5}S:S$offset_left$0$0({2}SI:U),Z,0,0)({7}S:S$offset_right$0$0({2}SI:U),Z,0,0)]
...
S:Fscroll_manager$print$0$0({2}DF,SV:S),C,0,0
