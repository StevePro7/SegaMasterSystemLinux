...
static void bonus_level()
{
	...
	// Clouds
	engine_tile_manager_draw_norm2( tile_type_cloud01, 3, 1 );
	engine_tile_manager_draw_flip2( tile_type_cloud01, 27, 2 );
	engine_tile_manager_draw_norm2( tile_type_cloud02, 19, 4 );
	engine_tile_manager_draw_flip2( tile_type_cloud02, 10, 2 );
	...
	engine_tile_manager_fly_turtle( turtle_type_fly_turtle01, 4, 7 );
	engine_tile_manager_fly_turtle( turtle_type_fly_turtle02, 8, 7 );


	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA1, 4, 14);
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleB1, 8, 14 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA2, 12, 15 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleB2, 16, 15 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA3, 20, 16 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA4, 24, 16 );
}
