...
S:Lscreen_manager.engine_screen_manager_update$input$1_0$100({1}SC:U),R,0,0,[a]
F:Fscreen_manager$draw_turtles$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_turtles$i$1_0$105({1}SC:U),R,0,0,[b]
F:Fscreen_manager$draw_turtle$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_turtle$i$1_0$108({1}SC:U),B,1,4
S:Fscreen_manager$flag$0_0$0({6}DA6d,SC:U),E,0,0
S:Fscreen_manager$wide$0_0$0({6}DA6d,SC:U),E,0,0
...
S:G$engine_content_manager_load_turtle$0_0$0({2}DF,SV:S),C,0,0
...
S:G$engine_turtle_manager_draw_01$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_turtle_manager_draw_02$0_0$0({2}DF,SV:S),C,0,0
