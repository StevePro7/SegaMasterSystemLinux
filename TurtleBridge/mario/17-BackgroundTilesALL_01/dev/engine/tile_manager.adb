M:tile_manager
F:G$engine_tile_manager_turtle01$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Ltile_manager.engine_tile_manager_turtle01$x$1$66({1}SC:U),B,1,4
S:Ltile_manager.engine_tile_manager_turtle01$y$1$66({1}SC:U),B,1,5
S:Ltile_manager.engine_tile_manager_turtle01$pnt$1$67({2}DG,SC:U),R,0,0,[]
S:Ltile_manager.engine_tile_manager_turtle01$start$1$67({1}SC:U),R,0,0,[]
S:Ltile_manager.engine_tile_manager_turtle01$index$1$67({1}SC:U),R,0,0,[e]
S:Ltile_manager.engine_tile_manager_turtle01$count$1$67({1}SC:U),R,0,0,[c]
S:Ltile_manager.engine_tile_manager_turtle01$ax$1$67({1}SC:U),B,1,-2
S:Ltile_manager.engine_tile_manager_turtle01$ay$1$67({1}SC:U),R,0,0,[b]
S:Ltile_manager.engine_tile_manager_turtle01$mx$1$67({1}SC:U),R,0,0,[]
S:Ltile_manager.engine_tile_manager_turtle01$my$1$67({1}SC:U),R,0,0,[]
S:Ltile_manager.engine_tile_manager_turtle01$row$1$67({1}SC:U),R,0,0,[]
