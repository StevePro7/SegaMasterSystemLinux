...
static void bonus_level()
{
	...
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA1, 16, 19 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA2, 16, 15 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA3, 16, 11 );

	engine_tile_manager_sea_turtle( turtle_type_sea_turtleB1, 22, 19 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleB2, 22, 15 );
	engine_tile_manager_sea_turtle( turtle_type_sea_turtleA4, 22, 11 );

	engine_tile_manager_fly_turtle( turtle_type_fly_turtle01, 16, 7 );
	engine_tile_manager_fly_turtle( turtle_type_fly_turtle02, 22, 7 );
}
