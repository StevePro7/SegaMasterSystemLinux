...
S:Lscroll_manager.engine_scroll_manager_init$so$1_0$71({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_scroll_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$so$1_0$74({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_getPosY$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_getPosY$col$1_0$76({2}SI:U),B,1,4
F:Fscroll_manager$print$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.print$so$1_0$78({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
