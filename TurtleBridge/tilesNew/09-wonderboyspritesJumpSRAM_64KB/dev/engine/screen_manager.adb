...
S:Lscreen_manager.engine_screen_manager_update$jo$1_0$107({2}DG,STtag_struct_jump_object:S),R,0,0,[]
S:Lscreen_manager.engine_screen_manager_update$input$1_0$107({1}SC:U),R,0,0,[a]
S:Lscreen_manager.engine_screen_manager_update$delta$1_0$107({1}SC:U),B,1,-1
...
S:Lscreen_manager.draw_sprite$idx$1_0$113({1}SC:U),B,1,4
S:Lscreen_manager.draw_sprite$x$1_0$113({1}SC:U),B,1,5
S:Lscreen_manager.draw_sprite$y$1_0$113({1}SC:U),B,1,6
S:Lscreen_manager.draw_sprite$wide$1_0$114({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$high$1_0$114({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$num$1_0$114({1}SC:U),R,0,0,[a]
S:Lscreen_manager.draw_sprite$i$1_0$114({1}SC:U),R,0,0,[c]
S:Lscreen_manager.draw_sprite$j$1_0$114({1}SC:U),B,1,-1
