...
S:Lstorage_manager.engine_storage_manager_available$so$1_0$88({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
S:Lstorage_manager.engine_storage_manager_available$foundMagic$1_0$88({1}SC:U),R,0,0,[l]
F:G$engine_storage_manager_read$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_read$so$1_0$89({2}DG,STtag_struct_storage_object:S),R,0,0,[e,d]
S:Lstorage_manager.engine_storage_manager_read$num_jumps$1_0$89({2}SI:U),R,0,0,[c,b]
S:Lstorage_manager.engine_storage_manager_read$index$1_0$89({2}SI:U),R,0,0,[e,d]
