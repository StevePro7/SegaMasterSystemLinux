...
S:Lstorage_manager.engine_storage_manager_available$savegame$1_0$82({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
S:Lstorage_manager.engine_storage_manager_available$foundMagic$1_0$82({1}SC:U),R,0,0,[l]
F:G$engine_storage_manager_read$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_read$savegame$1_0$83({2}DG,STtag_struct_storage_object:S),R,0,0,[]
F:G$engine_storage_manager_write$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_write$savegame$1_0$84({2}DG,STtag_struct_storage_object:S),R,0,0,[]
F:G$engine_storage_manager_erase$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_erase$savegame$1_0$85({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
T:Fstorage_manager$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$num_bytes$0_0$0({1}SC:U),Z,0,0)({5}S:S$sgb_byte1$0_0$0({1}SC:U),Z,0,0)({6}S:S$sgb_byte2$0_0$0({1}SC:U),Z,0,0)({7}S:S$sgb_byte3$0_0$0({1}SC:U),Z,0,0)]
S:G$global_storage_object$0_0$0({8}STtag_struct_storage_object:S),E,0,0
