...
S:Lscreen_manager.engine_screen_manager_update$input$1_0$103({1}SC:U),R,0,0,[a]
F:G$engine_screen_manager_update2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Fscreen_manager$stageframe$0_0$0({1}SC:U),E,0,0
