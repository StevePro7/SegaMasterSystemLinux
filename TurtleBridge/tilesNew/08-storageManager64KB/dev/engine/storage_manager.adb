...
S:Lstorage_manager.engine_storage_manager_available$so$1_0$82({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
S:Lstorage_manager.engine_storage_manager_available$foundMagic$1_0$82({1}SC:U),R,0,0,[l]
F:G$engine_storage_manager_read$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_read$so$1_0$83({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
S:Lstorage_manager.engine_storage_manager_read$temp$1_0$83({2}SI:U),R,0,0,[e,d]
...
T:Fstorage_manager$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$num_bytes$0_0$0({2}SI:U),Z,0,0)({6}S:S$sgb_bytes$0_0$0({3}DA3d,SC:U),Z,0,0)({9}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
