...
S:Lstorage_manager.engine_storage_manager_available$so$1_0$86({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
S:Lstorage_manager.engine_storage_manager_available$foundMagic$1_0$86({1}SC:U),R,0,0,[l]
