...
S:Lscroll_manager.engine_scroll_manager_load$count$1_0$92({1}SC:U),B,1,4
F:G$engine_scroll_manager_update$0_0$0({2}DF,:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$94({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_update$so$1_0$95({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_update$newTile$1_0$95({1}:S),R,0,0,[e]
...
S:Lscroll_manager.lineScrollHandler$val$1_0$100({2}SI:U),R,0,0,[]
