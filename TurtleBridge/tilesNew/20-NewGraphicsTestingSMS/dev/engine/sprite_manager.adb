...
S:Lsprite_manager.engine_sprite_manager_fish$x$1_0$156({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_fish$y$1_0$156({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_fish$tile$1_0$157({2}SI:U),R,0,0,[]
