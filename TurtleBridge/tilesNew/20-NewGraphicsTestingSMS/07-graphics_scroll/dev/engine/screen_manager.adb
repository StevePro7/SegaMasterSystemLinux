...
S:Lscreen_manager.engine_screen_manager_init$idx$1_0$92({1}SC:U),R,0,0,[b]
S:Lscreen_manager.engine_screen_manager_init$tile$1_0$92({1}SC:U),R,0,0,[]
F:G$engine_screen_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.engine_screen_manager_update$input$1_0$95({1}SC:U),R,0,0,[a]
...
T:Fscreen_manager$tag_struct_level_object[({0}S:S$num_levels$0_0$0({1}SC:U),Z,0,0)]
