...
S:Lscroll_manager.engine_scroll_manager_update2$delta$1_0$91({1}SC:U),R,0,0,[]
F:G$engine_scroll_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$h1$1_0$93({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_update$h2$1_0$93({1}SC:U),B,1,5
F:Fscroll_manager$lineScrollHandler$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.lineScrollHandler$val$1_0$96({2}SI:U),R,0,0,[c,b]
