...
F:G$engine_scroll_manager_update2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update2$delta$1_0$98({1}SC:U),R,0,0,[]
...
S:G$lineCnt$0_0$0({1}SC:U),E,0,0
