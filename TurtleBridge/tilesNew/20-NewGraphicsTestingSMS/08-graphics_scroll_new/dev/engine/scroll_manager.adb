...
S:Lscroll_manager.engine_scroll_manager_update$newTile$1_0$93({1}:S),R,0,0,[]
F:Fscroll_manager$print$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.print$newTile$1_0$94({1}:S),B,1,4
S:Lscroll_manager.print$so$1_0$95({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:Fscroll_manager$lineScrollHandler$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.lineScrollHandler$so$1_0$98({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$val$1_0$98({2}SI:U),R,0,0,[a,c]
