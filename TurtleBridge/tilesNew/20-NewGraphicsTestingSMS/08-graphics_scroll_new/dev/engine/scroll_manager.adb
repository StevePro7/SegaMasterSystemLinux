...
S:Lscroll_manager.print$newTile$1_0$96({1}:S),B,1,4
S:Lscroll_manager.print$so$1_0$97({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:Fscroll_manager$lineScrollHandler$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.lineScrollHandler$so$1_0$100({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$val$1_0$100({2}SI:U),R,0,0,[a,c]
