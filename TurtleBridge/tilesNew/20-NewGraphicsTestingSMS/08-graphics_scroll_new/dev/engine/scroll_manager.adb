...
S:Lscroll_manager.engine_scroll_manager_init$so$1_0$91({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_update$0_0$0({2}DF,:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$92({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_update$so$1_0$93({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_update$temp$1_0$93({1}SC:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_update$newTile$1_0$93({1}:S),B,1,-1
S:Lscroll_manager.engine_scroll_manager_update$sloc0$0_1$0({1}:S),B,1,-1
F:G$engine_scroll_manager_updateZ$0_0$0({2}DF,:S),C,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_updateZ$so$1_0$96({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_updateZ$newTile$1_0$96({1}:S),R,0,0,[c]
S:Lscroll_manager.engine_scroll_manager_updateZ$delta$1_0$96({1}SC:U),R,0,0,[]
F:Fscroll_manager$print$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.print$newTile$1_0$98({1}:S),B,1,4
S:Lscroll_manager.print$so$1_0$99({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:Fscroll_manager$lineScrollHandler$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.lineScrollHandler$so$1_0$102({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$val$1_0$102({2}SI:U),R,0,0,[a,c]
T:Fscroll_manager$tag_struct_scroll_object[({0}S:S$scroll$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$offset_right$0_0$0({2}SI:U),Z,0,0)({4}S:S$scroll_x$0_0$0({12}DA6d,SI:U),Z,0,0)({16}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
S:G$global_scroll_object$0_0$0({17}STtag_struct_scroll_object:S),E,0,0
...
S:G$engine_scroll_manager_updateZ$0_0$0({2}DF,:S),C,0,0
