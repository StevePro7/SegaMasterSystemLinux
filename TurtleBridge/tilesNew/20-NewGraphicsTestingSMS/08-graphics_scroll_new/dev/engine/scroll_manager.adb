...
S:Lscroll_manager.engine_scroll_manager_init$so$1_0$90({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_update$0_0$0({2}DF,:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$91({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_update$so$1_0$92({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_update$temp$1_0$92({1}SC:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_update$newTile$1_0$92({1}:S),B,1,-1
...
S:Lscroll_manager.engine_scroll_manager_updateZ$so$1_0$95({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_updateZ$newTile$1_0$95({1}:S),R,0,0,[c]
S:Lscroll_manager.engine_scroll_manager_updateZ$delta$1_0$95({1}SC:U),R,0,0,[]
F:Fscroll_manager$print$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.print$newTile$1_0$97({1}:S),B,1,4
S:Lscroll_manager.print$so$1_0$98({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
