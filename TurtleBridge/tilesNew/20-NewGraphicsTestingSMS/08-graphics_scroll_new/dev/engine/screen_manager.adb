...
S:Lscreen_manager.engine_screen_manager_update$delta$1_0$98({1}SC:U),R,0,0,[b]
...
S:Lscreen_manager.print$newTile$1_0$105({1}:S),B,1,4
S:Lscreen_manager.print$so$1_0$106({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
