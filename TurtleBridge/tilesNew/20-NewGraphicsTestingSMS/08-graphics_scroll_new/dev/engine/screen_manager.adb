...
S:Lscreen_manager.engine_screen_manager_init$idx$1_0$96({1}SC:U),R,0,0,[c]
F:G$engine_screen_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.engine_screen_manager_update$so$1_0$99({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
S:Lscreen_manager.engine_screen_manager_update$input$1_0$99({1}SC:U),R,0,0,[a]
S:Lscreen_manager.engine_screen_manager_update$delta$1_0$99({1}SC:U),R,0,0,[e]
S:Lscreen_manager.engine_screen_manager_update$value$1_0$99({1}SC:U),R,0,0,[d]
S:Lscreen_manager.engine_screen_manager_update$newTile$1_0$99({1}:S),R,0,0,[l]
F:Fscreen_manager$print$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.print$newTile$1_0$108({1}:S),B,1,4
S:Lscreen_manager.print$so$1_0$109({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
T:Fscreen_manager$tag_struct_scroll_object[({0}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({1}S:S$offset_right$0_0$0({2}SI:U),Z,0,0)({3}S:S$scroll_x$0_0$0({6}DA6d,SC:U),Z,0,0)({9}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({10}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
