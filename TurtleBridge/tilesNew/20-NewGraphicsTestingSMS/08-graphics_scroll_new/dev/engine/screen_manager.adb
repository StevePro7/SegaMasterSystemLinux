...
S:Lscreen_manager.engine_screen_manager_update$so$1_0$99({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscreen_manager.engine_screen_manager_update$input$1_0$99({1}SC:U),R,0,0,[a]
S:Lscreen_manager.engine_screen_manager_update$delta$1_0$99({1}SC:U),B,1,-1
S:Lscreen_manager.engine_screen_manager_update$value$1_0$99({1}SC:U),R,0,0,[c]
