...
S:Lscreen_manager.engine_screen_manager_update$input$1_0$98({1}SC:U),R,0,0,[c]
S:Lscreen_manager.engine_screen_manager_update$delta$1_0$98({1}SC:U),R,0,0,[b]
S:Lscreen_manager.engine_screen_manager_update$value$1_0$98({1}SC:U),R,0,0,[c]
S:Lscreen_manager.engine_screen_manager_update$newTile$1_0$98({1}:S),R,0,0,[l]
F:Fscreen_manager$print$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.print$newTile$1_0$106({1}:S),B,1,4
S:Lscreen_manager.print$so$1_0$107({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
