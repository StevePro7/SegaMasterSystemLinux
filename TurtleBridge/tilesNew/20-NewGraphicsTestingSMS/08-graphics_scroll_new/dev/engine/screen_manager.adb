...
S:Lscreen_manager.engine_screen_manager_update$so$1_0$98({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscreen_manager.engine_screen_manager_update$input$1_0$98({1}SC:U),R,0,0,[a]
S:Lscreen_manager.engine_screen_manager_update$delta$1_0$98({1}SC:U),R,0,0,[c]
...
S:Lscreen_manager.print$newTile$1_0$104({1}:S),B,1,4
S:Lscreen_manager.print$so$1_0$105({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
T:Fscreen_manager$tag_struct_scroll_object[({0}S:S$scroll$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$offset_right$0_0$0({2}SI:U),Z,0,0)({4}S:S$scroll_x$0_0$0({12}DA6d,SI:U),Z,0,0)({16}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
