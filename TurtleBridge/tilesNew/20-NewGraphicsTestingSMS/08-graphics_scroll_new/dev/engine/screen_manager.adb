...
S:Lscreen_manager.engine_screen_manager_init$idx$1_0$96({1}SC:U),R,0,0,[b]
S:Lscreen_manager.engine_screen_manager_init$tile$1_0$96({1}SC:U),R,0,0,[]
...
S:Lscreen_manager.engine_screen_manager_update$delta$1_0$99({1}SC:U),R,0,0,[d]
S:Lscreen_manager.engine_screen_manager_update$value$1_0$99({1}SC:U),R,0,0,[e]
...
S:Lscreen_manager.print$newTile$1_0$107({1}:S),B,1,4
S:Lscreen_manager.print$so$1_0$108({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
