...
T:Fmain$tag_struct_scroll_object[({0}S:S$scroll$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$offset_right$0_0$0({2}SI:U),Z,0,0)({4}S:S$scroll_x$0_0$0({12}DA6d,SI:U),Z,0,0)({16}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
