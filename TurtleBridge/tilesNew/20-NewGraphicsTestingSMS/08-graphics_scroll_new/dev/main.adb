...
T:Fmain$tag_struct_scroll_object[({0}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({1}S:S$offset_right$0_0$0({2}SI:U),Z,0,0)({3}S:S$scroll_x$0_0$0({6}DA6d,SC:U),Z,0,0)({9}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({10}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
