...
S:Ldebug_manager.engine_debug_manager_initgame$go$1_0$96({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_debug_manager_printout$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldebug_manager.engine_debug_manager_printout$po$1_0$97({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldebug_manager.engine_debug_manager_printout$lo$1_0$97({2}DG,STtag_struct_level_object:S),R,0,0,[]
F:G$engine_debug_manager_scrollout$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldebug_manager.engine_debug_manager_scrollout$so$1_0$98({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
...
T:Fdebug_manager$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)]
