...
S:Ldebug_manager.engine_debug_manager_initgame$go$1_0$106({2}DG,STtag_struct_game_object:S),R,0,0,[c,b]
...
S:Ldebug_manager.engine_debug_manager_scrollout$so$1_0$108({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
