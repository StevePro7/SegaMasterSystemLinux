...
T:Fdebug_manager$tag_struct_player_object[({0}S:S$posnX$0_0$0({2}SI:U),Z,0,0)({2}S:S$posnY$0_0$0({2}SI:U),Z,0,0)({4}S:S$drawX$0_0$0({1}SC:U),Z,0,0)({5}S:S$drawY$0_0$0({1}SC:U),Z,0,0)({6}S:S$tileX$0_0$0({2}SI:U),Z,0,0)({8}S:S$tileY$0_0$0({2}SI:U),Z,0,0)({10}S:S$player_state$0_0$0({1}SC:U),Z,0,0)({11}S:S$player_index$0_0$0({1}SC:U),Z,0,0)({12}S:S$player_frame$0_0$0({1}SC:U),Z,0,0)({13}S:S$player_count$0_0$0({2}SI:U),Z,0,0)]
