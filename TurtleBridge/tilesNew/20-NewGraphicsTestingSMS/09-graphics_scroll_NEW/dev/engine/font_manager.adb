...
S:Lfont_manager.engine_font_manager_splash_data$data$1_0$85({2}SI:U),B,1,4
S:Lfont_manager.engine_font_manager_splash_data$x$1_0$85({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_splash_data$y$1_0$85({1}SC:U),B,1,7
F:G$engine_font_manager_titles_data$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfont_manager.engine_font_manager_titles_data$data$1_0$87({2}SI:U),B,1,4
S:Lfont_manager.engine_font_manager_titles_data$x$1_0$87({1}SC:U),B,1,6
S:Lfont_manager.engine_font_manager_titles_data$y$1_0$87({1}SC:U),B,1,7
F:Ffont_manager$draw_data$0_0$0({2}DF,SV:S),Z,0,5,0,0,0
S:Lfont_manager.draw_data$tilemap$1_0$89({2}DG,SC:U),B,1,4
S:Lfont_manager.draw_data$data$1_0$89({2}SI:U),B,1,6
S:Lfont_manager.draw_data$x$1_0$89({1}SC:U),B,1,8
S:Lfont_manager.draw_data$y$1_0$89({1}SC:U),B,1,9
S:Lfont_manager.draw_data$idx$1_0$90({1}SC:U),B,1,-1
S:Lfont_manager.draw_data$tile$1_0$90({1}SC:S),R,0,0,[c]
S:Lfont_manager.draw_data$quotient$1_0$90({2}SI:U),B,1,-5
S:Lfont_manager.draw_data$remainder$1_0$90({1}SC:U),B,1,-3
S:Lfont_manager.draw_data$hold$1_0$90({5}DA5d,SC:U),B,1,-12
