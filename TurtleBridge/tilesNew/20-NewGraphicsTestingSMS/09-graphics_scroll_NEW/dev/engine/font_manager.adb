...
S:Lfont_manager.engine_font_manager_splash_data$data$1_0$84({2}SI:U),B,1,4
...
S:Lfont_manager.draw_data$idx$1_0$87({1}SC:U),B,1,-1
S:Lfont_manager.draw_data$tile$1_0$87({1}SC:S),R,0,0,[c]
S:Lfont_manager.draw_data$quotient$1_0$87({2}SI:U),B,1,-5
S:Lfont_manager.draw_data$remainder$1_0$87({1}SC:U),B,1,-3
S:Lfont_manager.draw_data$hold$1_0$87({5}DA5d,SC:U),B,1,-12
