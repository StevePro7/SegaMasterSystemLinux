...
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$140({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$140({2}SI:U),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_loadX$screen$1_0$140({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$141({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_set_action$newFrame$1_0$155({1}SC:U),B,1,-2
...
S:Lplayer_manager.engine_player_manager_bounds$posnY$1_0$167({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_bounds$invincible$1_0$167({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_bounds$po$1_0$168({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_collision$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_collision$state$1_0$173({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$173({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$173({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$deltaY$1_0$173({2}SI:S),B,1,7
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$173({1}SC:U),B,1,9
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$173({1}SC:U),B,1,10
S:Lplayer_manager.engine_player_manager_collision$po$1_0$174({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$174({1}SC:U),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$174({1}SC:S),B,1,-1
...
S:Lplayer_manager.engine_player_manager_animate$frame$1_0$185({1}SC:U),B,1,4
...
S:Lplayer_manager.updatePlayerY$po$1_0$194({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerFrameGroundToFlying$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameGroundToFlying$player_frame$1_0$195({1}SC:U),B,1,4
...
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$208({1}SC:U),B,1,4
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$210({1}SC:S),B,1,4
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$212({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_draw$deltaDraw$1_0$212({1}SC:U),R,0,0,[e]
