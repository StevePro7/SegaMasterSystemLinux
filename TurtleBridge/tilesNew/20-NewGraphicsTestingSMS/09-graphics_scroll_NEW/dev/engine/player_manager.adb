...
S:Lplayer_manager.engine_player_manager_set_action$state$1_0$145({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$145({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$146({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_set_action$index$1_0$146({1}SC:U),R,0,0,[]
F:G$engine_player_manager_horz$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$152({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$153({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$162({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$162({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$162({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$162({1}SC:U),B,1,8
S:Lplayer_manager.engine_player_manager_collision$po$1_0$163({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$163({1}SC:U),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$163({1}SC:S),B,1,-1
...
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$172({1}SC:U),B,1,4
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$174({1}SC:U),B,1,4
F:Fplayer_manager$updatePlayer$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fplayer_manager$updatePlayerX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerX$po$1_0$177({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$178({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$po$1_0$179({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_count$po$1_0$180({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$182({2}DG,STtag_struct_player_object:S),R,0,0,[]
