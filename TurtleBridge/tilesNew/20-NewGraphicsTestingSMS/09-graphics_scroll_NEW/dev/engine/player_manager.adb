...
S:Lplayer_manager.engine_player_manager_init$po$1_0$137({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_initX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_initX$difficulty$1_0$138({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_initX$world$1_0$138({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_initX$po$1_0$139({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_loadX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadX$checkPoint$1_0$140({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$141({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$141({2}SI:U),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_loadX$screen$1_0$141({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$142({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$143({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_get_deltaX$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaX$state$1_0$146({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_get_deltaX$command$1_0$146({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_get_deltaX$po$1_0$147({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaX$deltaX$1_0$147({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_get_deltaY$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaY$po$1_0$152({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaY$deltaY$1_0$152({2}SI:S),R,0,0,[e,d]
...
S:Lplayer_manager.engine_player_manager_set_action$frame$1_0$155({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$155({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$156({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_set_action$newFrame$1_0$156({1}SC:U),B,1,-2
S:Lplayer_manager.engine_player_manager_set_action$newIndex$1_0$156({1}SC:U),B,1,-1
...
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$164({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$165({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_vert$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_vert$deltaY$1_0$166({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_vert$po$1_0$167({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_bounds$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_bounds$deltaY$1_0$168({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_bounds$posnY$1_0$168({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_bounds$invincible$1_0$168({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_bounds$po$1_0$169({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_collision$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_collision$state$1_0$174({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$174({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$174({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$deltaY$1_0$174({2}SI:S),B,1,7
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$174({1}SC:U),B,1,9
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$174({1}SC:U),B,1,10
S:Lplayer_manager.engine_player_manager_collision$po$1_0$175({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$175({1}SC:U),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$175({1}SC:S),B,1,-1
...
S:Lplayer_manager.engine_player_manager_animate$frame$1_0$186({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_animate$po$1_0$187({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_finish$0_0$0({2}DF,SC:U),Z,0,2,0,0,0
S:Lplayer_manager.engine_player_manager_finish$po$1_0$190({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_finish$player_begY$1_0$190({1}SC:U),B,1,-4
S:Lplayer_manager.engine_player_manager_finish$player_endY$1_0$190({1}SC:U),B,1,-3
...
S:Lplayer_manager.updatePlayerX$po$1_0$194({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$195({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerFrameGroundToFlying$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameGroundToFlying$player_frame$1_0$196({1}SC:U),B,1,4
F:Fplayer_manager$updatePlayerFrameFlyingToGround$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameFlyingToGround$player_frame$1_0$199({1}SC:U),B,1,4
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$player_passX$1_0$202({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_pass$player_endY$1_0$202({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_pass$po$1_0$203({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_pass$deltaY$1_0$203({2}SI:S),R,0,0,[e,d]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$209({1}SC:U),B,1,4
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$211({1}SC:S),B,1,4
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$213({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_draw$deltaDraw$1_0$213({1}SC:U),R,0,0,[e]
...
S:Lplayer_manager.engine_player_manager_head$po$1_0$214({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_head$index$1_0$214({1}SC:U),R,0,0,[c]
