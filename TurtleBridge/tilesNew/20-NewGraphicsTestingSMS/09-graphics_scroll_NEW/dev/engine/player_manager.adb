...
S:Lplayer_manager.engine_player_manager_init$po$1_0$96({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_initX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_initX$difficulty$1_0$97({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_initX$po$1_0$98({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_loadX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadX$checkPoint$1_0$99({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$100({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$100({2}SI:U),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_loadX$screen$1_0$100({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$101({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$102({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_get_deltaX$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaX$state$1_0$105({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_get_deltaX$command$1_0$105({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_get_deltaX$deltaX$1_0$106({1}SC:U),R,0,0,[l]
F:G$engine_player_manager_set_action$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_set_action$state$1_0$110({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$110({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$111({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_set_action$index$1_0$111({1}SC:U),R,0,0,[]
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$117({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_right$po$1_0$118({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$119({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_down$po$1_0$120({2}DG,STtag_struct_player_object:S),R,0,0,[]
