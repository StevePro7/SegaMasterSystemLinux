...
S:Lplayer_manager.engine_player_manager_animate$frame$1_0$181({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_animate$po$1_0$182({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_draw$deltaDraw$1_0$201({1}SC:U),R,0,0,[e]
