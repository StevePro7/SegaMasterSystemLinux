...
S:Lplayer_manager.updatePlayerY$po$1_0$115({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$po$1_0$116({2}DG,STtag_struct_player_object:S),R,0,0,[]
