...
S:Lplayer_manager.engine_player_manager_init$po$1_0$128({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_initX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_initX$difficulty$1_0$129({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_initX$po$1_0$130({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_loadX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadX$checkPoint$1_0$131({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$132({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$132({2}SI:U),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_loadX$screen$1_0$132({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$133({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$134({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_get_deltaX$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaX$state$1_0$137({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_get_deltaX$command$1_0$137({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_get_deltaX$deltaX$1_0$138({1}SC:U),R,0,0,[l]
F:G$engine_player_manager_get_deltaY$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaY$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaY$deltaY$1_0$142({2}SI:S),R,0,0,[e,d]
S:Lplayer_manager.engine_player_manager_get_deltaY$sloc0$0_1$0({1}SC:U),B,1,-3
S:Lplayer_manager.engine_player_manager_get_deltaY$sloc1$0_1$0({2}SI:S),B,1,-2
F:G$engine_player_manager_set_action$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_set_action$state$1_0$144({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$144({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$145({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_set_action$index$1_0$145({1}SC:U),R,0,0,[]
F:G$engine_player_manager_horz$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$151({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$152({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_vert$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_vert$deltaY$1_0$153({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_vert$po$1_0$154({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_bounds$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_bounds$deltaY$1_0$155({1}SC:S),B,1,4
S:Lplayer_manager.engine_player_manager_bounds$posnY$1_0$155({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_bounds$invincible$1_0$155({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_bounds$po$1_0$156({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_collision$0_0$0({2}DF,SC:U),Z,0,-1,0,0,0
S:Lplayer_manager.engine_player_manager_collision$state$1_0$161({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$161({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$161({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$161({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$161({1}SC:U),B,1,8
S:Lplayer_manager.engine_player_manager_collision$po$1_0$162({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$162({1}SC:U),B,1,-1
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$162({1}SC:S),R,0,0,[d]
S:Lplayer_manager.engine_player_manager_collision$sloc0$0_1$0({1}SC:U),B,1,-1
S:Lplayer_manager.engine_player_manager_collision$sloc1$0_1$0({2}SI:S),B,1,-2
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$170({1}SC:U),B,1,4
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$172({1}SC:U),B,1,4
F:Fplayer_manager$updatePlayer$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fplayer_manager$updatePlayerX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerX$po$1_0$175({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$176({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$po$1_0$177({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_count$po$1_0$178({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$180({2}DG,STtag_struct_player_object:S),R,0,0,[]
