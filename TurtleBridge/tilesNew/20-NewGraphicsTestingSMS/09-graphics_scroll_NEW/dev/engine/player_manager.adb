...
S:Lplayer_manager.engine_player_manager_starts$index$1_0$93({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_starts$po$1_0$94({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_starts$px$1_0$94({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_init$po$1_0$95({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_initX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_initX$difficulty$1_0$96({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_initX$po$1_0$97({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_loadX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadX$checkPoint$1_0$98({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$99({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$99({2}SI:U),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_loadX$screen$1_0$99({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$100({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$101({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_update3$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_update3$po$1_0$102({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_update2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_update2$po$1_0$103({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_update$level_platform$1_0$105({1}SC:U),R,0,0,[]
S:Lplayer_manager.engine_player_manager_update$tempY$1_0$105({1}SC:U),R,0,0,[e]
S:Lplayer_manager.engine_player_manager_update$tileY$1_0$105({1}SC:U),R,0,0,[a]
S:Lplayer_manager.engine_player_manager_update$deltaY$1_0$105({1}SC:S),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_update$po$1_0$105({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_left$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_left$po$1_0$112({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$113({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_right$po$1_0$114({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$115({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_down$po$1_0$116({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_up$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_up$po$1_0$117({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_downX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_downX$po$1_0$118({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayer$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fplayer_manager$updatePlayerX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerX$po$1_0$120({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$121({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$po$1_0$122({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_count$po$1_0$123({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$125({2}DG,STtag_struct_player_object:S),R,0,0,[]
