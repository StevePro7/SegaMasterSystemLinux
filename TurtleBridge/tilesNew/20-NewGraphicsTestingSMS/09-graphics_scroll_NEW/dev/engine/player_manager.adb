...
S:Lplayer_manager.engine_player_manager_init$po$1_0$125({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_initX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_initX$difficulty$1_0$126({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_initX$po$1_0$127({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_loadX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadX$checkPoint$1_0$128({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$129({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$129({2}SI:U),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_loadX$screen$1_0$129({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$130({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$131({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_get_deltaX$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaX$state$1_0$134({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_get_deltaX$command$1_0$134({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_get_deltaX$deltaX$1_0$135({1}SC:U),R,0,0,[l]
F:G$engine_player_manager_get_deltaY$0_0$0({2}DF,SC:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaY$state$1_0$139({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_get_deltaY$po$1_0$140({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaY$deltaY$1_0$140({1}SC:S),R,0,0,[l]
F:G$engine_player_manager_set_action$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_set_action$state$1_0$141({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$141({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_set_action$index$1_0$142({1}SC:U),R,0,0,[]
F:G$engine_player_manager_horz$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$148({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$149({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_vert$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_vert$deltaY$1_0$150({1}SC:U),B,1,4
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$153({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_right$po$1_0$154({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$155({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_down$po$1_0$156({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayer$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fplayer_manager$updatePlayerX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerX$po$1_0$158({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$159({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$po$1_0$160({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_count$po$1_0$161({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$163({2}DG,STtag_struct_player_object:S),R,0,0,[]
