...
S:Lplayer_manager.engine_player_manager_init$po$1_0$132({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_initX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_initX$difficulty$1_0$133({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_initX$po$1_0$134({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_loadX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadX$checkPoint$1_0$135({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$136({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$136({2}SI:U),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_loadX$screen$1_0$136({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$137({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$138({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_get_deltaX$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaX$state$1_0$141({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_get_deltaX$command$1_0$141({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_get_deltaX$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaX$deltaX$1_0$142({1}SC:U),R,0,0,[l]
F:G$engine_player_manager_get_deltaY$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaY$po$1_0$147({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaY$deltaY$1_0$147({2}SI:S),R,0,0,[e,d]
...
S:Lplayer_manager.engine_player_manager_set_action$state$1_0$150({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$150({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$151({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_set_action$index$1_0$151({1}SC:U),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$157({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$158({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_vert$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_vert$deltaY$1_0$159({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_vert$po$1_0$160({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_bounds$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_bounds$deltaY$1_0$161({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_bounds$posnY$1_0$161({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_bounds$invincible$1_0$161({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_bounds$po$1_0$162({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_collision$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_collision$state$1_0$167({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$167({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$167({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$deltaY$1_0$167({2}SI:S),B,1,7
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$167({1}SC:U),B,1,9
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$167({1}SC:U),B,1,10
S:Lplayer_manager.engine_player_manager_collision$po$1_0$168({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$168({1}SC:U),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$168({1}SC:S),B,1,-1
...
S:Lplayer_manager.engine_player_manager_animate$frame$1_0$178({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_animate$po$1_0$179({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayer$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fplayer_manager$updatePlayerX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerX$po$1_0$183({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$184({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerFrameGroundToFlying$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameGroundToFlying$player_frame$1_0$185({1}SC:U),B,1,4
F:Fplayer_manager$updatePlayerFrameFlyingToGround$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameFlyingToGround$player_frame$1_0$188({1}SC:U),B,1,4
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$po$1_0$191({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$192({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$195({1}SC:U),B,1,4
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$197({1}SC:U),B,1,4
