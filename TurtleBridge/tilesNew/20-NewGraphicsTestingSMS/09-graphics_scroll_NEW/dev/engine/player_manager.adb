...
S:Lplayer_manager.engine_player_manager_count$po$1_0$120({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$122({2}DG,STtag_struct_player_object:S),R,0,0,[]
