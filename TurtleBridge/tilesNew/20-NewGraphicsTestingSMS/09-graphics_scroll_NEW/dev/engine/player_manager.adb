...
S:Lplayer_manager.engine_player_manager_set_action$frame$1_0$152({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$152({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$153({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_set_action$newFrame$1_0$153({1}SC:U),B,1,-2
S:Lplayer_manager.engine_player_manager_set_action$newIndex$1_0$153({1}SC:U),B,1,-1
...
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$161({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$162({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_vert$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_vert$deltaY$1_0$163({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_vert$po$1_0$164({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_bounds$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_bounds$deltaY$1_0$165({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_bounds$posnY$1_0$165({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_bounds$invincible$1_0$165({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_bounds$po$1_0$166({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_collision$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_collision$state$1_0$171({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$171({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$171({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$deltaY$1_0$171({2}SI:S),B,1,7
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$171({1}SC:U),B,1,9
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$171({1}SC:U),B,1,10
S:Lplayer_manager.engine_player_manager_collision$po$1_0$172({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$172({1}SC:U),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$172({1}SC:S),B,1,-1
...
S:Lplayer_manager.engine_player_manager_animate$frame$1_0$183({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_animate$po$1_0$184({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayer$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fplayer_manager$updatePlayerX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerX$po$1_0$188({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$189({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerFrameGroundToFlying$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameGroundToFlying$player_frame$1_0$190({1}SC:U),B,1,4
F:Fplayer_manager$updatePlayerFrameFlyingToGround$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameFlyingToGround$player_frame$1_0$193({1}SC:U),B,1,4
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$po$1_0$196({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$199({1}SC:U),B,1,4
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$201({1}SC:U),B,1,4
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$203({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_draw$deltaDraw$1_0$203({1}SC:U),R,0,0,[e]
