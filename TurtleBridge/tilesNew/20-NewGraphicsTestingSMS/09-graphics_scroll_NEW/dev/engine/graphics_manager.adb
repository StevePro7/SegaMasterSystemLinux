...
S:Lgraphics_manager.engine_graphics_manager_sea$tiles$1_0$86({2}DG,SC:U),R,0,0,[]
S:Lgraphics_manager.engine_graphics_manager_sea$row$1_0$86({1}SC:U),R,0,0,[c]
S:Lgraphics_manager.engine_graphics_manager_sea$col$1_0$86({1}SC:U),B,1,-1
S:Lgraphics_manager.engine_graphics_manager_sea$x$1_0$86({1}SC:U),R,0,0,[b]
S:Lgraphics_manager.engine_graphics_manager_sea$y$1_0$86({1}SC:U),B,1,-2
S:Lgraphics_manager.engine_graphics_manager_sea$tileIdx$1_0$86({1}SC:U),R,0,0,[a]
S:Lgraphics_manager.engine_graphics_manager_sea$tileMap$1_0$86({1}SC:U),R,0,0,[a]
S:Lgraphics_manager.engine_graphics_manager_sea$idx$1_0$86({2}SI:U),R,0,0,[a,h]
S:Lgraphics_manager.engine_graphics_manager_sea$val$1_0$86({2}SI:U),R,0,0,[l,h]
S:Lgraphics_manager.engine_graphics_manager_sea$sea_lines$1_0$86({12}DA12d,SC:U),B,1,-14
...
T:Fgraphics_manager$tag_struct_tile_object[({0}S:S$tilemap_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$tile_wide$0_0$0({1}SC:U),Z,0,0)({3}S:S$tile_platform$0_0$0({1}SC:U),Z,0,0)]
