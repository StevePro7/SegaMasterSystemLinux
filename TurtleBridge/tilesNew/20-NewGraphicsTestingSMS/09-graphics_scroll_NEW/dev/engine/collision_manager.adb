...
S:Lcollision_manager.engine_collision_manager_finish$lookX$1_0$21({1}SC:U),B,1,4
S:Lcollision_manager.engine_collision_manager_finish$tileY$1_0$21({1}SC:U),B,1,5
S:Lcollision_manager.engine_collision_manager_finish$posnY$1_0$21({1}SC:U),B,1,6
S:Lcollision_manager.engine_collision_manager_finish$player_begY$1_0$21({2}DG,SC:U),B,1,7
S:Lcollision_manager.engine_collision_manager_finish$player_endY$1_0$21({2}DG,SC:U),B,1,9
S:Lcollision_manager.engine_collision_manager_finish$lookup_platform$1_0$22({1}SC:U),R,0,0,[e]
