...
S:Lcollision_manager.engine_collision_manager_load$difficulty$1_0$95({1}SC:U),B,1,4
F:G$engine_collision_manager_player$0_0$0({2}DF,SC:S),Z,0,0,0,0,0
S:Lcollision_manager.engine_collision_manager_player$lookX$1_0$98({1}SC:U),B,1,4
S:Lcollision_manager.engine_collision_manager_player$tileY$1_0$98({1}SC:U),B,1,5
S:Lcollision_manager.engine_collision_manager_player$po$1_0$99({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lcollision_manager.engine_collision_manager_player$lo$1_0$99({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lcollision_manager.engine_collision_manager_player$lookup_platform$1_0$99({1}SC:U),R,0,0,[c]
S:Lcollision_manager.engine_collision_manager_player$player_platform$1_0$99({1}SC:U),B,1,-2
S:Lcollision_manager.engine_collision_manager_player$collisionTile$1_0$99({1}SC:S),R,0,0,[e]
