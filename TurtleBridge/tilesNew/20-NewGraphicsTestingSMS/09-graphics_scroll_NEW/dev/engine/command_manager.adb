...
T:Fcommand_manager$tag_struct_hack_object[({0}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_inair$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
