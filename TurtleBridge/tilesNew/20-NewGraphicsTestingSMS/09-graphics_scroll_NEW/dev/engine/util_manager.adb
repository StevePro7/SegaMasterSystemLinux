...
S:Lutil_manager.engine_util_manager_convertByteToNibbles$byte$1_0$89({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_convertByteToNibbles$upper_nibble$1_0$89({2}DG,SC:U),B,1,5
S:Lutil_manager.engine_util_manager_convertByteToNibbles$lower_nibble$1_0$89({2}DG,SC:U),B,1,7
F:G$engine_util_manager_convertNibblesToByte$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil_manager.engine_util_manager_convertNibblesToByte$upper_nibble$1_0$91({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_convertNibblesToByte$lower_nibble$1_0$91({1}SC:U),B,1,5
S:Lutil_manager.engine_util_manager_convertNibblesToByte$byte$1_0$91({2}DG,SC:U),B,1,6
