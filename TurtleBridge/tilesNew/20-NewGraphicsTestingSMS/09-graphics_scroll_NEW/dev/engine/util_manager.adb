...
S:Lutil_manager.engine_util_manager_locale_texts$index$1_0$118({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_locale_texts$x$1_0$118({1}SC:U),B,1,5
S:Lutil_manager.engine_util_manager_locale_texts$y$1_0$118({1}SC:U),B,1,6
S:Lutil_manager.engine_util_manager_locale_texts$text$1_0$119({2}DG,SC:U),R,0,0,[c,b]
F:G$engine_util_manager_locale_blank$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil_manager.engine_util_manager_locale_blank$index$1_0$120({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_locale_blank$x$1_0$120({1}SC:U),B,1,5
S:Lutil_manager.engine_util_manager_locale_blank$y$1_0$120({1}SC:U),B,1,6
S:Lutil_manager.engine_util_manager_locale_blank$blank$1_0$121({2}DG,SC:U),R,0,0,[c,b]
F:G$engine_util_manager_calculate_level$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lutil_manager.engine_util_manager_calculate_level$world$1_0$122({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_calculate_level$round$1_0$122({1}SC:U),B,1,5
F:G$engine_util_manager_convertByteToNibbles$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil_manager.engine_util_manager_convertByteToNibbles$byte$1_0$124({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_convertByteToNibbles$upper_nibble$1_0$124({2}DG,SC:U),B,1,5
S:Lutil_manager.engine_util_manager_convertByteToNibbles$lower_nibble$1_0$124({2}DG,SC:U),B,1,7
F:G$engine_util_manager_convertNibblesToByte$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil_manager.engine_util_manager_convertNibblesToByte$upper_nibble$1_0$126({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_convertNibblesToByte$lower_nibble$1_0$126({1}SC:U),B,1,5
S:Lutil_manager.engine_util_manager_convertNibblesToByte$byte$1_0$126({2}DG,SC:U),B,1,6
F:G$engine_random_manager_rand$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_random_manager_next$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lutil_manager.engine_random_manager_next$max$1_0$129({2}SI:U),B,1,4
