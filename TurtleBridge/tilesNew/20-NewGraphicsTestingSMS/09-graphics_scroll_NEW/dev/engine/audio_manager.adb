...
S:Laudio_manager.engine_music_manager_stop$ao$1_0$125({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_audio_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_audio_manager_update$ao$1_0$126({2}DG,STtag_struct_audio_object:S),R,0,0,[]
