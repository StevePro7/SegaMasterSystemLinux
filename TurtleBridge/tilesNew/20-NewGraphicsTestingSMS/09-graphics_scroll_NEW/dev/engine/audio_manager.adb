...
S:Laudio_manager.engine_music_manager_stop$ao$1_0$126({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_sound_manager_play$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_sound_manager_play$index$1_0$127({1}SC:U),B,1,4
S:Laudio_manager.engine_sound_manager_play$ao$1_0$128({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_sound_manager_stop$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_sound_manager_stop$ao$1_0$129({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_audio_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_audio_manager_update$ao$1_0$130({2}DG,STtag_struct_audio_object:S),R,0,0,[]
