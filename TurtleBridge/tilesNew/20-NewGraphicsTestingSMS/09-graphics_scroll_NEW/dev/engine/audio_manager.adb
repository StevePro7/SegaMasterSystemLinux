...
S:Laudio_manager.engine_music_manager_play$index$1_0$96({1}SC:U),B,1,4
S:Laudio_manager.engine_music_manager_play$music_data$1_0$97({2}DG,SC:U),R,0,0,[c,b]
S:Laudio_manager.engine_music_manager_play$music_bank$1_0$97({1}SC:U),R,0,0,[a]
