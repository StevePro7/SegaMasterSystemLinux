...
S:Laudio_manager.engine_audio_manager_init$ao$1_0$123({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_music_manager_play$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_music_manager_play$index$1_0$124({1}SC:U),B,1,4
S:Laudio_manager.engine_music_manager_play$ao$1_0$125({2}DG,STtag_struct_audio_object:S),R,0,0,[]
S:Laudio_manager.engine_music_manager_play$ho$1_0$125({2}DG,STtag_struct_hack_object:S),R,0,0,[]
F:G$engine_music_manager_stop$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_music_manager_stop$ao$1_0$127({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_sound_manager_play$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_sound_manager_play$index$1_0$128({1}SC:U),B,1,4
S:Laudio_manager.engine_sound_manager_play$ao$1_0$129({2}DG,STtag_struct_audio_object:S),R,0,0,[]
S:Laudio_manager.engine_sound_manager_play$ho$1_0$129({2}DG,STtag_struct_hack_object:S),R,0,0,[]
F:G$engine_sound_manager_stop$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_sound_manager_stop$ao$1_0$131({2}DG,STtag_struct_audio_object:S),R,0,0,[]
F:G$engine_audio_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_audio_manager_update$ao$1_0$132({2}DG,STtag_struct_audio_object:S),R,0,0,[]
T:Faudio_manager$tag_struct_hack_object[({0}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
