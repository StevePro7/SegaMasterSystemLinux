...
S:Lscroll_manager.para_scroll_load$so$1_0$99({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
...
S:Lscroll_manager.full_scroll_update$so$1_0$108({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$newTile$1_0$108({1}:S),B,1,-5
...
S:Lscroll_manager.lineScrollHandler$so$1_0$112({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$val$1_0$112({2}SI:U),R,0,0,[]
