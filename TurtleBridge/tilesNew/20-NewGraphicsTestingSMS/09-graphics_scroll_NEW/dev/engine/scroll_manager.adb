...
S:Lscroll_manager.para_scroll_load$count$1_0$104({1}SC:U),B,1,4
...
S:Lscroll_manager.full_scroll_load$count$1_0$108({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_load$so$1_0$109({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:Fscroll_manager$full_scroll_update$0_0$0({2}DF,:S),Z,0,-1,0,0,0
S:Lscroll_manager.full_scroll_update$delta$1_0$110({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_update$so$1_0$111({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$newTile$1_0$111({1}:S),B,1,-5
...
S:Lscroll_manager.lineScrollHandler$so$1_0$115({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$val$1_0$115({2}SI:U),R,0,0,[]
