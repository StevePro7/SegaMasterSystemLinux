...
S:Lscroll_manager.full_scroll_load$scroll_complete$1_0$113({2}SI:S),B,1,4
S:Lscroll_manager.full_scroll_load$so$1_0$114({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:Fscroll_manager$full_scroll_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_update$delta$1_0$115({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_update$so$1_0$116({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$scroll_state$1_0$116({1}SC:U),B,1,-3
...
S:Lscroll_manager.lineScrollHandler$val$1_0$122({1}SC:U),R,0,0,[a]
F:Fscroll_manager$lineScrollHandlerX$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lscroll_manager.lineScrollHandlerX$so$1_0$124({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandlerX$value$1_0$124({1}SC:U),R,0,0,[b]
S:Lscroll_manager.lineScrollHandlerX$index$1_0$124({1}SC:U),R,0,0,[l]
F:Fscroll_manager$lineScrollHandler_old$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lscroll_manager.lineScrollHandler_old$so$1_0$133({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler_old$val$1_0$133({1}SC:U),R,0,0,[a]
F:Fscroll_manager$lineScrollHandler_new$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lscroll_manager.lineScrollHandler_new$so$1_0$135({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler_new$value$1_0$135({1}SC:U),R,0,0,[a]
S:Lscroll_manager.lineScrollHandler_new$index$1_0$135({1}SC:U),R,0,0,[a]
T:Fscroll_manager$tag_struct_scroll_object[({0}S:S$scroll$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$offset_right$0_0$0({2}SI:U),Z,0,0)({4}S:S$scroll_complete$0_0$0({2}SI:U),Z,0,0)({6}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({7}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
...
S:Fscroll_manager$lineScrollHandlerX$0_0$0({2}DF,SV:S),C,0,0
S:Fscroll_manager$lineScrollHandler_old$0_0$0({2}DF,SV:S),C,0,0
