...
S:Lscroll_manager.engine_scroll_manager_para_load$screen$1_0$106({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_para_load$scrollFinish$1_0$106({2}SI:S),B,1,5
S:Lscroll_manager.engine_scroll_manager_para_load$so$1_0$107({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_para_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_para_update$delta$1_0$108({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_para_update$so$1_0$109({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_para_update$scroll_state$1_0$109({1}SC:U),R,0,0,[e]
F:Fscroll_manager$para_scroll_section$0_0$0({2}DF,SC:U),C,0,0,0,0,0
S:Lscroll_manager.para_scroll_section$delta$1_0$114({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_section$so$1_0$115({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.para_scroll_section$scroll_state$1_0$115({1}SC:U),R,0,0,[e]
F:Fscroll_manager$full_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_load$screen$1_0$120({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_load$scrollFinish$1_0$120({2}SI:S),B,1,5
S:Lscroll_manager.full_scroll_load$so$1_0$121({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:Fscroll_manager$full_scroll_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_update$delta$1_0$122({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_update$so$1_0$123({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$scroll_state$1_0$123({1}SC:U),B,1,-3
...
S:Lscroll_manager.lineScrollHandler$so$1_0$129({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$index$1_0$129({1}SC:U),R,0,0,[c]
S:Lscroll_manager.lineScrollHandler$value$1_0$129({1}SC:U),B,1,-1
...
S:Fscroll_manager$para_scroll_section$0_0$0({2}DF,SC:U),C,0,0
