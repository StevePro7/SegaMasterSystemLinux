...
S:Lscroll_manager.engine_scroll_manager_load$screen$1_0$104({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_load$scrollFinish$1_0$104({2}SI:S),B,1,5
F:G$engine_scroll_manager_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$106({1}SC:U),B,1,4
F:G$engine_scroll_manager_section$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_section$delta$1_0$108({1}SC:U),B,1,4
F:Fscroll_manager$para_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.para_scroll_load$screen$1_0$110({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_load$scrollFinish$1_0$110({2}SI:S),B,1,5
S:Lscroll_manager.para_scroll_load$so$1_0$111({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:Fscroll_manager$para_scroll_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.para_scroll_update$delta$1_0$112({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_update$so$1_0$113({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.para_scroll_update$scroll_state$1_0$113({1}SC:U),B,1,-1
S:Lscroll_manager.para_scroll_update$sloc0$0_1$0({1}SC:U),B,1,-1
F:Fscroll_manager$para_scroll_section$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.para_scroll_section$delta$1_0$118({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_section$so$1_0$119({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.para_scroll_section$scroll_state$1_0$119({1}SC:U),R,0,0,[e]
F:Fscroll_manager$full_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_load$screen$1_0$124({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_load$scrollFinish$1_0$124({2}SI:S),B,1,5
S:Lscroll_manager.full_scroll_load$so$1_0$125({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:Fscroll_manager$full_scroll_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_update$delta$1_0$126({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_update$so$1_0$127({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$scroll_state$1_0$127({1}SC:U),B,1,-3
...
S:Lscroll_manager.lineScrollHandler$so$1_0$133({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$index$1_0$133({1}SC:U),R,0,0,[c]
S:Lscroll_manager.lineScrollHandler$value$1_0$133({1}SC:U),B,1,-1
...
S:Fscroll_manager$update_section$0_0$0({2}DC,DF,SC:U),E,0,0
