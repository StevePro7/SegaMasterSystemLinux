...
S:Lscroll_manager.engine_scroll_manager_load$screen$1_0$105({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_load$scrollFinish$1_0$105({2}SI:S),B,1,5
F:G$engine_scroll_manager_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$107({1}SC:U),B,1,4
F:G$engine_scroll_manager_section$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_section$delta$1_0$109({1}SC:U),B,1,4
F:Fscroll_manager$para_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.para_scroll_load$screen$1_0$111({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_load$scrollFinish$1_0$111({2}SI:S),B,1,5
S:Lscroll_manager.para_scroll_load$so$1_0$112({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:Fscroll_manager$para_scroll_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.para_scroll_update$delta$1_0$113({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_update$so$1_0$114({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.para_scroll_update$scroll_state$1_0$114({1}SC:U),B,1,-1
...
S:Lscroll_manager.para_scroll_section$delta$1_0$119({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_section$so$1_0$120({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.para_scroll_section$scroll_state$1_0$120({1}SC:U),R,0,0,[e]
F:Fscroll_manager$full_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_load$screen$1_0$125({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_load$scrollFinish$1_0$125({2}SI:S),B,1,5
S:Lscroll_manager.full_scroll_load$so$1_0$126({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:Fscroll_manager$full_scroll_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_update$delta$1_0$127({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_update$so$1_0$128({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$scroll_state$1_0$128({1}SC:U),B,1,-3
...
S:Lscroll_manager.lineScrollHandler$so$1_0$134({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$index$1_0$134({1}SC:U),R,0,0,[c]
S:Lscroll_manager.lineScrollHandler$value$1_0$134({1}SC:U),B,1,-1
