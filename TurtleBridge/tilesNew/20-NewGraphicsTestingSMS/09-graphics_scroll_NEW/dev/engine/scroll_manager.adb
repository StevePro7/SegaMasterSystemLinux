...
S:Lscroll_manager.engine_scroll_manager_load$screen$1_0$99({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_load$scrollFinish$1_0$99({2}SI:S),B,1,5
F:G$engine_scroll_manager_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$101({1}SC:U),B,1,4
F:Fscroll_manager$para_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.para_scroll_load$screen$1_0$103({1}SC:U),B,1,4
S:Lscroll_manager.para_scroll_load$scrollFinish$1_0$103({2}SI:S),B,1,5
S:Lscroll_manager.para_scroll_load$so$1_0$104({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
...
S:Lscroll_manager.full_scroll_load$so$1_0$112({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:Fscroll_manager$full_scroll_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_update$delta$1_0$113({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_update$so$1_0$114({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$scroll_state$1_0$114({1}SC:U),B,1,-3
...
S:Lscroll_manager.lineScrollHandler$so$1_0$120({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$index$1_0$120({1}SC:U),R,0,0,[c]
S:Lscroll_manager.lineScrollHandler$value$1_0$120({1}SC:U),B,1,-1
