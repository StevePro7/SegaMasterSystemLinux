...
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$97({1}SC:U),B,1,4
F:Fscroll_manager$para_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fscroll_manager$para_scroll_update$0_0$0({2}DF,:S),Z,0,0,0,0,0
S:Lscroll_manager.para_scroll_update$delta$1_0$100({1}SC:U),B,1,4
F:Fscroll_manager$full_scroll_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.full_scroll_load$so$1_0$102({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:Fscroll_manager$full_scroll_update$0_0$0({2}DF,:S),Z,0,-1,0,0,0
S:Lscroll_manager.full_scroll_update$delta$1_0$103({1}SC:U),B,1,4
S:Lscroll_manager.full_scroll_update$so$1_0$104({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.full_scroll_update$newTile$1_0$104({1}:S),B,1,-5
S:Lscroll_manager.full_scroll_update$sloc0$0_1$0({1}:S),B,1,-1
S:Lscroll_manager.full_scroll_update$sloc1$0_1$0({1}:S),B,1,-5
S:Lscroll_manager.full_scroll_update$sloc2$0_1$0({2}SI:U),B,1,-4
S:Lscroll_manager.full_scroll_update$sloc3$0_1$0({2}SI:U),B,1,-2
F:Fscroll_manager$lineScrollHandler$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.lineScrollHandler$so$1_0$108({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.lineScrollHandler$val$1_0$108({2}SI:U),R,0,0,[]
...
S:Fscroll_manager$update_method$0_0$0({2}DC,DF,:S),E,0,0
