...
S:Lscroll_manager.engine_scroll_manager_load$screen$1_0$101({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_load$scrollFinish$1_0$101({2}SI:S),B,1,5
F:G$engine_scroll_manager_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$delta$1_0$103({1}SC:U),B,1,4
F:G$engine_scroll_manager_full_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_full_load$screen$1_0$105({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_full_load$scrollFinish$1_0$105({2}SI:S),B,1,5
S:Lscroll_manager.engine_scroll_manager_full_load$so$1_0$106({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:G$engine_scroll_manager_para_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_para_load$screen$1_0$107({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_para_load$scrollFinish$1_0$107({2}SI:S),B,1,5
S:Lscroll_manager.engine_scroll_manager_para_load$so$1_0$108({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_para_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_para_update$delta$1_0$109({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_para_update$so$1_0$110({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_para_update$scroll_state$1_0$110({1}SC:U),R,0,0,[e]
...
S:Lscroll_manager.lineScrollHandler$index$1_0$122({1}SC:U),R,0,0,[c]
S:Lscroll_manager.lineScrollHandler$value$1_0$122({1}SC:U),B,1,-1
