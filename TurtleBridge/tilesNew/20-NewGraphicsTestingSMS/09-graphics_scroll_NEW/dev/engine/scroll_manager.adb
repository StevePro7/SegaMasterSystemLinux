...
S:Lscroll_manager.engine_scroll_manager_full_load$screen$1_0$103({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_full_load$scrollFinish$1_0$103({2}SI:S),B,1,5
S:Lscroll_manager.engine_scroll_manager_full_load$so$1_0$104({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
F:G$engine_scroll_manager_full_update$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_full_update$delta$1_0$105({1}SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_full_update$so$1_0$106({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_full_update$scroll_state$1_0$106({1}SC:U),B,1,-3
