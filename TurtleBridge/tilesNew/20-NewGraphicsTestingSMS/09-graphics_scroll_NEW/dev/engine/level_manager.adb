...
S:Llevel_manager.engine_level_manager_init$lo$1_0$94({2}DG,STtag_struct_level_object:S),R,0,0,[]
F:G$engine_level_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_load$index$1_0$95({1}SC:U),B,1,4
...
S:Llevel_manager.engine_level_manager_draw$offset$1_0$97({2}SI:U),B,1,4
S:Llevel_manager.engine_level_manager_draw$lo$1_0$98({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw$index$1_0$98({2}SI:U),R,0,0,[e,d]
S:Llevel_manager.engine_level_manager_draw$data$1_0$98({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw$planesA$1_0$98({1}SC:U),B,1,-2
S:Llevel_manager.engine_level_manager_draw$columnA$1_0$98({1}SC:U),B,1,-1
S:Llevel_manager.engine_level_manager_draw$flip$1_0$98({1}:S),R,0,0,[b]
