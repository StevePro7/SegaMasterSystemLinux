...
S:Llevel_manager.engine_level_manager_init$level$1_0$99({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_init$lo$1_0$100({2}DG,STtag_struct_level_object:S),R,0,0,[]
F:G$engine_level_manager_draw_screen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_draw_screen$checkScreen$1_0$101({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_screen$lo$1_0$102({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_screen$scrollColumn$1_0$102({2}SI:U),R,0,0,[c,b]
S:Llevel_manager.engine_level_manager_draw_screen$index$1_0$102({1}SC:U),R,0,0,[e]
F:G$engine_level_manager_draw_point$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_draw_point$checkPoint$1_0$105({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_point$lo$1_0$106({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_point$scrollColumn$1_0$106({2}SI:U),R,0,0,[c,b]
S:Llevel_manager.engine_level_manager_draw_point$index$1_0$106({1}SC:U),R,0,0,[e]
F:G$engine_level_manager_draw_column$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Llevel_manager.engine_level_manager_draw_column$scrollColumn$1_0$109({2}SI:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_column$lo$1_0$110({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_column$level_data$1_0$110({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw_column$level_column$1_0$110({1}SC:U),B,1,-2
