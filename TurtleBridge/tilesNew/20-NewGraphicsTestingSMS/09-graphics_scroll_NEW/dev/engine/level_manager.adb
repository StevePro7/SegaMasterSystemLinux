...
S:Llevel_manager.engine_level_manager_load$index$1_0$96({1}SC:U),B,1,4
...
S:Llevel_manager.engine_level_manager_show$index$1_0$99({1}SC:U),R,0,0,[e]
S:Llevel_manager.engine_level_manager_show$offset$1_0$99({2}SI:U),R,0,0,[c,b]
F:G$engine_level_manager_draw$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Llevel_manager.engine_level_manager_draw$offset$1_0$102({2}SI:U),B,1,4
S:Llevel_manager.engine_level_manager_draw$lo$1_0$103({2}DG,STtag_struct_level_object:S),R,0,0,[]
...
T:Flevel_manager$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({1}SC:U),Z,0,0)({3}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({4}S:S$level_draw_offset$0_0$0({1}SC:U),Z,0,0)]
