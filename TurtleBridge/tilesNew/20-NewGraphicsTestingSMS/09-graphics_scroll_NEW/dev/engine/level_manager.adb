...
S:Llevel_manager.engine_level_manager_init$lo$1_0$95({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_init$idx$1_0$95({1}SC:U),R,0,0,[e]
F:G$engine_level_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_load$index$1_0$98({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_load$lo$1_0$99({2}DG,STtag_struct_level_object:S),R,0,0,[]
F:G$engine_level_manager_show$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_show$screen$1_0$100({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_show$lo$1_0$101({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_show$index$1_0$101({1}SC:U),R,0,0,[e]
S:Llevel_manager.engine_level_manager_show$offset$1_0$101({2}SI:U),R,0,0,[c,b]
...
S:Llevel_manager.engine_level_manager_draw$level_data$1_0$105({1}SC:U),R,0,0,[b]
S:Llevel_manager.engine_level_manager_draw$level_column$1_0$105({1}SC:U),B,1,-3
S:Llevel_manager.engine_level_manager_draw$level_object$1_0$105({1}SC:U),B,1,-2
S:Llevel_manager.engine_level_manager_draw$level_platform$1_0$105({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw$flip$1_0$105({1}:S),B,1,-1
