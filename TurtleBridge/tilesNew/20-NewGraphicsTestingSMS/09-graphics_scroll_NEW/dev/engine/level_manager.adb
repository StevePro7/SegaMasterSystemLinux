...
S:Llevel_manager.engine_level_manager_draw_point$checkPoint$1_0$98({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_point$lo$1_0$99({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_point$index$1_0$99({1}SC:U),R,0,0,[e]
S:Llevel_manager.engine_level_manager_draw_point$scrollColumn$1_0$99({2}SI:U),R,0,0,[c,b]
F:G$engine_level_manager_draw_column$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Llevel_manager.engine_level_manager_draw_column$scrollColumn$1_0$102({2}SI:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_column$lo$1_0$103({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_column$level_data$1_0$103({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw_column$level_column$1_0$103({1}SC:U),B,1,-2
S:Llevel_manager.engine_level_manager_draw_column$level_object$1_0$103({1}SC:U),B,1,-1
S:Llevel_manager.engine_level_manager_draw_column$level_platform$1_0$103({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw_column$flip$1_0$103({1}:S),R,0,0,[b]
T:Flevel_manager$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
