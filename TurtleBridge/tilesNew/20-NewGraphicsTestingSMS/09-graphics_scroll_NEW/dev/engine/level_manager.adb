...
S:Llevel_manager.engine_level_manager_draw_screen$checkScreen$1_0$98({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_screen$lo$1_0$99({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_screen$scrollColumn$1_0$99({2}SI:U),R,0,0,[c,b]
S:Llevel_manager.engine_level_manager_draw_screen$index$1_0$99({1}SC:U),R,0,0,[e]
