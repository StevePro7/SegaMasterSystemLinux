...
S:Llevel_manager.engine_level_manager_draw_column$scrollColumn$1_0$103({2}SI:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_column$lo$1_0$104({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_column$level_data$1_0$104({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw_column$level_column$1_0$104({1}SC:U),B,1,-2
S:Llevel_manager.engine_level_manager_draw_column$level_object$1_0$104({1}SC:U),B,1,-1
S:Llevel_manager.engine_level_manager_draw_column$level_platform$1_0$104({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw_column$flip$1_0$104({1}:S),R,0,0,[b]
