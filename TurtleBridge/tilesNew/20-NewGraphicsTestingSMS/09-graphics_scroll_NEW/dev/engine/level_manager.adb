...
S:Llevel_manager.engine_level_manager_show$scrollColumn$1_0$99({2}SI:U),R,0,0,[c,b]
F:G$engine_level_manager_draw$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Llevel_manager.engine_level_manager_draw$scrollColumn$1_0$102({2}SI:U),B,1,4
