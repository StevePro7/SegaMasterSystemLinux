...
S:Llevel_manager.engine_level_manager_init$lo$1_0$91({2}DG,STtag_struct_level_object:S),R,0,0,[]
F:G$engine_level_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_load$lo$1_0$92({2}DG,STtag_struct_level_object:S),R,0,0,[]
F:G$engine_level_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_draw$offset$1_0$93({2}SI:U),B,1,4
S:Llevel_manager.engine_level_manager_draw$lo$1_0$94({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw$index$1_0$94({2}SI:U),R,0,0,[c,b]
S:Llevel_manager.engine_level_manager_draw$planesA$1_0$94({1}SC:U),R,0,0,[e]
S:Llevel_manager.engine_level_manager_draw$columnA$1_0$94({1}SC:U),R,0,0,[a]
