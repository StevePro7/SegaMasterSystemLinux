...
S:Llevel_manager.engine_level_manager_init$level$1_0$98({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_init$lo$1_0$99({2}DG,STtag_struct_level_object:S),R,0,0,[]
