...
S:Lsprite_manager.engine_sprite_manager_clear$ch$1_0$114({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_clear$row$1_0$115({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_sprite_manager_clear$col$1_0$115({1}SC:U),R,0,0,[b]
F:G$engine_sprite_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_draw$idx$1_0$120({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw$x$1_0$120({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$y$1_0$120({1}SC:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$wide$1_0$121({1}SC:U),R,0,0,[]
S:Lsprite_manager.engine_sprite_manager_draw$high$1_0$121({1}SC:U),R,0,0,[]
S:Lsprite_manager.engine_sprite_manager_draw$num$1_0$121({1}SC:U),R,0,0,[a]
S:Lsprite_manager.engine_sprite_manager_draw$i$1_0$121({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_sprite_manager_draw$j$1_0$121({1}SC:U),B,1,-1
