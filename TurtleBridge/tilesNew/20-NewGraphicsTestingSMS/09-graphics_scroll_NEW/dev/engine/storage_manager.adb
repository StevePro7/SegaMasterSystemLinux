...
S:Lstorage_manager.engine_storage_manager_write$sloc0$0_1$0({2}DG,DA3d,SI:U),B,1,-2
S:Lstorage_manager.engine_storage_manager_write$sloc1$0_1$0({2}DG,SI:U),B,1,-2
S:Lstorage_manager.engine_storage_manager_write$sloc2$0_1$0({2}DG,SI:U),B,1,-2
F:G$engine_storage_manager_erase$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_erase$so$1_0$92({2}DG,STtag_struct_storage_object:S),R,0,0,[e,d]
...
T:Fstorage_manager$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_frame_index$0_0$0({6}DA3d,SI:U),Z,0,0)({10}S:S$storage_this_command$0_0$0({3}DA3d,SC:U),Z,0,0)({13}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
