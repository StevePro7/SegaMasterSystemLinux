...
S:Lstorage_manager.engine_storage_manager_available$so$1_0$94({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
S:Lstorage_manager.engine_storage_manager_available$foundMagic$1_0$94({1}SC:U),R,0,0,[l]
F:G$engine_storage_manager_read$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_read$so$1_0$95({2}DG,STtag_struct_storage_object:S),R,0,0,[c,b]
F:G$engine_storage_manager_write$0_0$0({2}DF,SV:S),Z,0,-4,0,0,0
S:Lstorage_manager.engine_storage_manager_write$so$1_0$96({2}DG,STtag_struct_storage_object:S),R,0,0,[c,b]
S:Lstorage_manager.engine_storage_manager_write$go$1_0$96({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lstorage_manager.engine_storage_manager_write$index$1_1$97({2}SI:U),R,0,0,[e,d]
...
S:Lstorage_manager.engine_storage_manager_erase$so$1_0$102({2}DG,STtag_struct_storage_object:S),R,0,0,[e,d]
S:Lstorage_manager.engine_storage_manager_erase$index$1_1$103({2}SI:U),R,0,0,[c,b]
