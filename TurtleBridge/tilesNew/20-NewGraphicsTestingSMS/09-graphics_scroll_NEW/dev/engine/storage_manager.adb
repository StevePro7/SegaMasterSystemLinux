...
S:Lstorage_manager.engine_storage_manager_available$so$1_0$101({2}DG,STtag_struct_storage_object:S),R,0,0,[l,h]
S:Lstorage_manager.engine_storage_manager_available$foundMagic$1_0$101({1}SC:U),R,0,0,[l]
F:G$engine_storage_manager_read$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_read$so$1_0$102({2}DG,STtag_struct_storage_object:S),R,0,0,[c,b]
F:G$engine_storage_manager_write$0_0$0({2}DF,SV:S),Z,0,-4,0,0,0
S:Lstorage_manager.engine_storage_manager_write$so$1_0$103({2}DG,STtag_struct_storage_object:S),R,0,0,[c,b]
S:Lstorage_manager.engine_storage_manager_write$go$1_0$103({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lstorage_manager.engine_storage_manager_write$index$1_0$103({2}SI:U),R,0,0,[e,d]
S:Lstorage_manager.engine_storage_manager_write$sloc0$0_1$0({2}DG,DA6d,SC:U),B,1,-2
S:Lstorage_manager.engine_storage_manager_write$sloc1$0_1$0({2}DG,DA64d,SI:U),B,1,-8
S:Lstorage_manager.engine_storage_manager_write$sloc2$0_1$0({2}DG,DA64d,SC:U),B,1,-6
S:Lstorage_manager.engine_storage_manager_write$sloc3$0_1$0({2}DG,SI:U),B,1,-4
S:Lstorage_manager.engine_storage_manager_write$sloc4$0_1$0({2}SI:U),B,1,-2
S:Lstorage_manager.engine_storage_manager_write$sloc5$0_1$0({2}DG,SC:U),B,1,-2
F:G$engine_storage_manager_erase$0_0$0({2}DF,SV:S),Z,0,-2,0,0,0
S:Lstorage_manager.engine_storage_manager_erase$so$1_0$108({2}DG,STtag_struct_storage_object:S),R,0,0,[e,d]
S:Lstorage_manager.engine_storage_manager_erase$index$1_1$109({2}SI:U),R,0,0,[c,b]
S:Lstorage_manager.engine_storage_manager_erase$sloc0$0_1$0({2}DG,DA6d,SC:U),B,1,-2
S:Lstorage_manager.engine_storage_manager_erase$sloc1$0_1$0({2}DG,DA64d,SI:U),B,1,-4
S:Lstorage_manager.engine_storage_manager_erase$sloc2$0_1$0({2}DG,DA64d,SC:U),B,1,-2
T:Fstorage_manager$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_saved$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({7}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
