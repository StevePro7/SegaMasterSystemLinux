...
S:Lbeat_screen.screen_beat_screen_load$game_difficulty$1_0$164({1}SC:U),R,0,0,[]
...
F:G$screen_beat_screen_update$0_0$0({2}DF,SV:S),Z,0,-3,0,0,0
...
S:Lbeat_screen.screen_beat_screen_update$input1$1_0$166({1}SC:U),R,0,0,[e]
...
S:Lbeat_screen.screen_beat_screen_update$command$1_0$166({1}SC:U),B,1,-2
S:Lbeat_screen.screen_beat_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
S:Lbeat_screen.screen_beat_screen_update$sloc1$0_1$0({2}DG,SC:U),B,1,-4
S:Lbeat_screen.screen_beat_screen_update$sloc2$0_1$0({1}SC:U),B,1,-2
...
S:Lbeat_screen.printBeatGame$tiles$1_0$177({2}DG,SC:U),R,0,0,[c,b]
S:Lbeat_screen.printBeatGame$x$1_0$177({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$y$1_0$177({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$d$1_0$177({1}SC:U),R,0,0,[]
