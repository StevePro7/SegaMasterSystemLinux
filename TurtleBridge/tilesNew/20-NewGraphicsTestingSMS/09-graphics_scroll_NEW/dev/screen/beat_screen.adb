...
S:Lbeat_screen.screen_beat_screen_load$po$1_0$156({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$lo$1_0$156({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$go$1_0$156({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$player_loadY$1_0$156({1}SC:U),R,0,0,[a]
S:Lbeat_screen.screen_beat_screen_load$checkScreen$1_0$156({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$beat_level$1_0$156({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$game_world$1_0$156({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$game_point$1_0$156({1}SC:U),R,0,0,[]
F:G$screen_beat_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.screen_beat_screen_update$screen_type$1_0$157({2}DG,SC:U),B,1,4
S:Lbeat_screen.screen_beat_screen_update$input1$1_0$158({1}SC:U),R,0,0,[l]
S:Lbeat_screen.screen_beat_screen_update$input2$1_0$158({1}SC:U),R,0,0,[a]
F:Fbeat_screen$printBeatGame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.printBeatGame$tiles$1_0$161({2}DG,SC:U),R,0,0,[c,b]
S:Lbeat_screen.printBeatGame$x$1_0$161({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$y$1_0$161({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$d$1_0$161({1}SC:U),R,0,0,[]
