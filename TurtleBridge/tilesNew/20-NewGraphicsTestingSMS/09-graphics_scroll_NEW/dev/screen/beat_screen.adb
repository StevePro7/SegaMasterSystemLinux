...
S:Lbeat_screen.screen_beat_screen_load$so$1_0$104({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$value$1_0$104({1}SC:U),R,0,0,[b]
F:G$screen_beat_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.screen_beat_screen_update$screen_type$1_0$105({2}DG,SC:U),B,1,4
S:Lbeat_screen.screen_beat_screen_update$input$1_0$106({1}SC:U),R,0,0,[a]
S:Lbeat_screen.screen_beat_screen_update$index$1_0$106({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$loops$1_0$106({1}SC:U),R,0,0,[e]
S:Lbeat_screen.screen_beat_screen_update$count$1_0$106({1}SC:U),R,0,0,[c]
S:Lbeat_screen.screen_beat_screen_update$value$1_0$106({1}SC:U),R,0,0,[b]
