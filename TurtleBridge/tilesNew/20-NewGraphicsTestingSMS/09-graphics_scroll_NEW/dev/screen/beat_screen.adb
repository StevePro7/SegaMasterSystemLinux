...
S:Lbeat_screen.screen_beat_screen_load$po$1_0$164({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$lo$1_0$164({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$go$1_0$164({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$player_loadY$1_0$164({1}SC:U),R,0,0,[a]
S:Lbeat_screen.screen_beat_screen_load$checkScreen$1_0$164({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$beat_level$1_0$164({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$game_world$1_0$164({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$game_point$1_0$164({1}SC:U),R,0,0,[]
F:G$screen_beat_screen_update$0_0$0({2}DF,SV:S),Z,0,-4,0,0,0
S:Lbeat_screen.screen_beat_screen_update$screen_type$1_0$165({2}DG,SC:U),B,1,4
S:Lbeat_screen.screen_beat_screen_update$fo$1_0$166({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$so$1_0$166({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$po$1_0$166({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$lo$1_0$166({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$go$1_0$166({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$input1$1_0$166({1}SC:U),B,1,-2
S:Lbeat_screen.screen_beat_screen_update$input2$1_0$166({1}SC:U),B,1,-1
S:Lbeat_screen.screen_beat_screen_update$deltaX$1_0$166({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$player_state$1_0$166({1}SC:U),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$command$1_0$166({1}SC:U),B,1,-3
S:Lbeat_screen.screen_beat_screen_update$sloc0$0_1$0({1}SC:U),B,1,-3
S:Lbeat_screen.screen_beat_screen_update$sloc1$0_1$0({1}SC:U),B,1,-2
S:Lbeat_screen.screen_beat_screen_update$sloc2$0_1$0({1}SC:U),B,1,-1
S:Lbeat_screen.screen_beat_screen_update$sloc3$0_1$0({2}SI:U),B,1,-3
S:Lbeat_screen.screen_beat_screen_update$sloc4$0_1$0({1}SC:U),B,1,-1
S:Lbeat_screen.screen_beat_screen_update$sloc5$0_1$0({1}SC:U),B,1,-1
F:Fbeat_screen$printBeatGame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.printBeatGame$tiles$1_0$176({2}DG,SC:U),R,0,0,[c,b]
S:Lbeat_screen.printBeatGame$x$1_0$176({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$y$1_0$176({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$d$1_0$176({1}SC:U),R,0,0,[]
...
T:Fbeat_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)]
