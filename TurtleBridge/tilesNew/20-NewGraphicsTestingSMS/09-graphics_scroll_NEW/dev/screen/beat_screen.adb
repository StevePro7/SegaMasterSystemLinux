...
S:Lbeat_screen.printBeatGame$tiles$1_0$153({2}DG,SC:U),R,0,0,[c,b]
S:Lbeat_screen.printBeatGame$x$1_0$153({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$y$1_0$153({1}SC:U),R,0,0,[]
S:Lbeat_screen.printBeatGame$d$1_0$153({1}SC:U),R,0,0,[]
F:G$screen_beat_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.screen_beat_screen_load$so$1_0$154({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$go$1_0$154({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_beat_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.screen_beat_screen_update$screen_type$1_0$155({2}DG,SC:U),B,1,4
S:Lbeat_screen.screen_beat_screen_update$input1$1_0$156({1}SC:U),R,0,0,[l]
S:Lbeat_screen.screen_beat_screen_update$input2$1_0$156({1}SC:U),R,0,0,[a]
