...
S:Lbeat_screen.screen_beat_screen_load$po$1_0$27({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_beat_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.screen_beat_screen_update$screen_type$1_0$28({2}DG,SC:U),B,1,4
S:Lbeat_screen.screen_beat_screen_update$po$1_0$29({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$input1$1_0$29({1}SC:U),R,0,0,[l]
S:Lbeat_screen.screen_beat_screen_update$input2$1_0$29({1}SC:U),B,1,-1
S:Lbeat_screen.screen_beat_screen_update$command$1_0$29({1}SC:U),R,0,0,[l]
