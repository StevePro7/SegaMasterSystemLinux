...
S:Lbeat_screen.screen_beat_screen_load$so$1_0$131({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$go$1_0$131({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_load$value$1_0$131({1}SC:U),R,0,0,[]
F:G$screen_beat_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbeat_screen.screen_beat_screen_update$screen_type$1_0$132({2}DG,SC:U),B,1,4
S:Lbeat_screen.screen_beat_screen_update$po$1_0$133({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$lo$1_0$133({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$go$1_0$133({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lbeat_screen.screen_beat_screen_update$input$1_0$133({1}SC:U),R,0,0,[a]
S:Lbeat_screen.screen_beat_screen_update$checkScreen$1_0$133({1}SC:U),R,0,0,[c]
