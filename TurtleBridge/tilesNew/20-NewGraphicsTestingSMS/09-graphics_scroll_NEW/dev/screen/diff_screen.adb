...
S:Ldiff_screen.screen_diff_screen_update$input$1_0$124({1}SC:U),R,0,0,[a]
...
S:Ldiff_screen.setupPlayer$po$1_0$133({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldiff_screen.setupPlayer$go$1_0$133({2}DG,STtag_struct_game_object:S),R,0,0,[]
