...
S:Ldiff_screen.screen_diff_screen_load$po$1_0$130({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_load$lo$1_0$130({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_load$go$1_0$130({2}DG,STtag_struct_game_object:S),R,0,0,[]
...
S:Ldiff_screen.setupPlayer$go$1_0$142({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:Fdiff_screen$printCursor$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldiff_screen.printCursor$index$1_0$143({1}SC:U),R,0,0,[c]
...
T:Fdiff_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
