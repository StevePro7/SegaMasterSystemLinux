...
S:Ldiff_screen.screen_diff_screen_update$input1$1_0$125({1}SC:U),R,0,0,[l]
S:Ldiff_screen.screen_diff_screen_update$input2$1_0$125({1}SC:U),R,0,0,[l]
...
S:Ldiff_screen.setupPlayer$po$1_0$135({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldiff_screen.setupPlayer$go$1_0$135({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:Fdiff_screen$printCursor$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldiff_screen.printCursor$index$1_0$136({1}SC:U),R,0,0,[c]
