...
S:Ldead_screen.screen_dead_screen_load$co$1_0$35({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_load$po$1_0$35({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_dead_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldead_screen.screen_dead_screen_update$screen_type$1_0$36({2}DG,SC:U),B,1,4
S:Ldead_screen.screen_dead_screen_update$po$1_0$37({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_update$input1$1_0$37({1}SC:U),R,0,0,[]
S:Ldead_screen.screen_dead_screen_update$input2$1_0$37({1}SC:U),R,0,0,[]
...
T:Fdead_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)]
