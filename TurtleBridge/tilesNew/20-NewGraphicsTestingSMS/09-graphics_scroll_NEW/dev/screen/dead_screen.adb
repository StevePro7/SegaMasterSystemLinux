...
S:Ldead_screen.screen_dead_screen_update$screen_type$1_0$20({2}DG,SC:U),B,1,4
S:Ldead_screen.screen_dead_screen_update$so$1_0$21({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_update$po$1_0$21({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_update$lo$1_0$21({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldead_screen.screen_dead_screen_update$input$1_0$21({1}SC:U),R,0,0,[a]
S:Ldead_screen.screen_dead_screen_update$delta$1_0$21({1}SC:U),R,0,0,[c]
S:Ldead_screen.screen_dead_screen_update$value$1_0$21({1}SC:U),R,0,0,[b]
S:Ldead_screen.screen_dead_screen_update$collision$1_0$21({1}SC:S),R,0,0,[l]
S:Ldead_screen.screen_dead_screen_update$scroll_state$1_0$21({1}SC:U),R,0,0,[l]
