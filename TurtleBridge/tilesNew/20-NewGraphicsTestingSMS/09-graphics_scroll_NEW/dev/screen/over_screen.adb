...
S:Lover_screen.printContinue$tiles$1_0$141({2}DG,SC:U),R,0,0,[c,b]
S:Lover_screen.printContinue$x$1_0$141({1}SC:U),R,0,0,[]
S:Lover_screen.printContinue$y$1_0$141({1}SC:U),R,0,0,[]
S:Lover_screen.printContinue$d$1_0$141({1}SC:U),R,0,0,[]
F:Fover_screen$printBeatGame$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lover_screen.printBeatGame$tiles$1_0$142({2}DG,SC:U),R,0,0,[c,b]
S:Lover_screen.printBeatGame$x$1_0$142({1}SC:U),R,0,0,[]
S:Lover_screen.printBeatGame$y$1_0$142({1}SC:U),R,0,0,[]
S:Lover_screen.printBeatGame$d$1_0$142({1}SC:U),R,0,0,[]
...
S:Lover_screen.screen_over_screen_update$input1$1_0$146({1}SC:U),R,0,0,[c]
S:Lover_screen.screen_over_screen_update$input2$1_0$146({1}SC:U),R,0,0,[l]
F:G$screen_over_screen_loadX$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lover_screen.screen_over_screen_loadX$go$1_0$148({2}DG,STtag_struct_game_object:S),R,0,0,[]
