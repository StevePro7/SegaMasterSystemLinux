...
S:Lover_screen.printBeatGame$tiles$1_0$141({2}DG,SC:U),R,0,0,[c,b]
S:Lover_screen.printBeatGame$x$1_0$141({1}SC:U),R,0,0,[]
S:Lover_screen.printBeatGame$y$1_0$141({1}SC:U),R,0,0,[]
S:Lover_screen.printBeatGame$d$1_0$141({1}SC:U),R,0,0,[]
F:G$screen_over_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_over_screen_loadX$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lover_screen.screen_over_screen_loadX$go$1_0$143({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_over_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1_0$144({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$input1$1_0$145({1}SC:U),B,1,-1
S:Lover_screen.screen_over_screen_update$input2$1_0$145({1}SC:U),R,0,0,[c]
