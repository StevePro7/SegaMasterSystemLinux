...
S:Lover_screen.screen_over_screen_load$go$1_0$130({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_over_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1_0$131({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$input1$1_0$132({1}SC:U),B,1,-1
S:Lover_screen.screen_over_screen_update$input2$1_0$132({1}SC:U),R,0,0,[c]
