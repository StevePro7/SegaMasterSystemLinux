...
S:Lsplash_screen.screen_splash_screen_update$screen_type$1_0$103({2}DG,SC:U),B,1,4
S:Lsplash_screen.screen_splash_screen_update$input$1_0$104({1}SC:U),R,0,0,[a]
S:Lsplash_screen.screen_splash_screen_update$loops$1_0$104({1}SC:U),B,1,-1
S:Lsplash_screen.screen_splash_screen_update$index$1_0$104({1}SC:U),R,0,0,[]
S:Lsplash_screen.screen_splash_screen_update$count$1_0$104({1}SC:U),B,1,-2
S:Lsplash_screen.screen_splash_screen_update$value$1_0$104({1}SC:U),B,1,-3
