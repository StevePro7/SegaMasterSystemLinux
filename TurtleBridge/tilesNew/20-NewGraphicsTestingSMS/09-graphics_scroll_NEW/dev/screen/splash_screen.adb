...
S:Lsplash_screen.screen_splash_screen_update$screen_type$1_0$90({2}DG,SC:U),B,1,4
S:Lsplash_screen.screen_splash_screen_update$input$1_0$91({1}SC:U),R,0,0,[c]
