...
S:Lsplash_screen.screen_splash_screen_update$screen_type$1_0$92({2}DG,SC:U),B,1,4
S:Lsplash_screen.screen_splash_screen_update$input$1_0$93({1}SC:U),R,0,0,[a]
F:Fsplash_screen$draw_title$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsplash_screen.draw_title$tmp$1_0$96({2}SI:U),B,1,4
S:Lsplash_screen.draw_title$tiles$1_0$97({2}DG,SC:U),R,0,0,[]
S:Lsplash_screen.draw_title$idx$1_0$97({2}SI:U),R,0,0,[l,h]
S:Lsplash_screen.draw_title$val$1_0$97({2}SI:U),R,0,0,[e,d]
S:Lsplash_screen.draw_title$row$1_0$97({1}SC:U),R,0,0,[c]
S:Lsplash_screen.draw_title$col$1_0$97({1}SC:U),R,0,0,[b]
S:Lsplash_screen.draw_title$x$1_0$97({1}SC:U),R,0,0,[]
S:Lsplash_screen.draw_title$y$1_0$97({1}SC:U),R,0,0,[]
S:Lsplash_screen.draw_title$size$1_0$97({1}SC:U),R,0,0,[]
S:Lsplash_screen.draw_title$w$1_0$97({1}SC:U),R,0,0,[]
S:Lsplash_screen.draw_title$h$1_0$97({1}SC:U),R,0,0,[]
