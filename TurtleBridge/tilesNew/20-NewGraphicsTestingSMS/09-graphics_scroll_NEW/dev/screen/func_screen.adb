...
S:Lfunc_screen.screen_func_screen_load$po$1_0$20({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_func_screen_update$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
S:Lfunc_screen.screen_func_screen_update$screen_type$1_0$21({2}DG,SC:U),B,1,4
S:Lfunc_screen.screen_func_screen_update$po$1_0$22({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_update$input1$1_0$22({1}SC:U),B,1,-6
S:Lfunc_screen.screen_func_screen_update$input2$1_0$22({1}SC:U),B,1,-5
S:Lfunc_screen.screen_func_screen_update$input3$1_0$22({1}SC:U),B,1,-4
S:Lfunc_screen.screen_func_screen_update$input4$1_0$22({1}SC:U),B,1,-3
S:Lfunc_screen.screen_func_screen_update$input5$1_0$22({1}SC:U),B,1,-2
S:Lfunc_screen.screen_func_screen_update$input6$1_0$22({1}SC:U),B,1,-1
S:Lfunc_screen.screen_func_screen_update$command$1_0$22({1}SC:U),B,1,-1
