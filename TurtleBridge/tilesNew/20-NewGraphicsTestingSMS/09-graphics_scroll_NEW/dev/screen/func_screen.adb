...
S:Lfunc_screen.screen_func_screen_load$po$1_0$135({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_load$lo$1_0$135({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_load$go$1_0$135({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_load$player_loadY$1_0$135({1}SC:U),R,0,0,[a]
S:Lfunc_screen.screen_func_screen_load$checkScreen$1_0$135({1}SC:U),R,0,0,[b]
S:Lfunc_screen.screen_func_screen_load$cloud_formation$1_0$135({1}SC:U),B,1,-1
S:Lfunc_screen.screen_func_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_func_screen_update$0_0$0({2}DF,SV:S),Z,0,-3,0,0,0
S:Lfunc_screen.screen_func_screen_update$screen_type$1_0$136({2}DG,SC:U),B,1,4
S:Lfunc_screen.screen_func_screen_update$fo$1_0$137({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_update$so$1_0$137({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_update$po$1_0$137({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_update$co$1_0$137({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_update$lo$1_0$137({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_update$go$1_0$137({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lfunc_screen.screen_func_screen_update$input1$1_0$137({1}SC:U),B,1,-4
S:Lfunc_screen.screen_func_screen_update$input2$1_0$137({1}SC:U),B,1,-3
S:Lfunc_screen.screen_func_screen_update$input3$1_0$137({1}SC:U),B,1,-2
S:Lfunc_screen.screen_func_screen_update$input4$1_0$137({1}SC:U),B,1,-1
S:Lfunc_screen.screen_func_screen_update$input5$1_0$137({1}SC:U),R,0,0,[c]
S:Lfunc_screen.screen_func_screen_update$input6$1_0$137({1}SC:U),R,0,0,[a]
S:Lfunc_screen.screen_func_screen_update$command$1_0$137({1}SC:U),B,1,-1
S:Lfunc_screen.screen_func_screen_update$deltaX$1_0$137({1}SC:U),R,0,0,[b]
S:Lfunc_screen.screen_func_screen_update$loops$1_0$137({1}SC:U),R,0,0,[c]
S:Lfunc_screen.screen_func_screen_update$scroll_state$1_0$137({1}SC:U),R,0,0,[a]
S:Lfunc_screen.screen_func_screen_update$player_state$1_0$137({1}SC:U),B,1,-5
...
T:Ffunc_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
