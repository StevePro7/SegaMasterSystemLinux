...
S:Lbegin_screen.screen_begin_screen_update$so$1_0$103({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$po$1_0$103({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
...
F:Fbegin_screen$anyPlatforms$0_0$0({2}DF,:S),Z,0,0,0,0,0
F:Fbegin_screen$drawScreen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fbegin_screen$nextPrint$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbegin_screen.nextPrint$so$1_0$111({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$po$1_0$111({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$lo$1_0$111({2}DG,STtag_struct_level_object:S),R,0,0,[]
