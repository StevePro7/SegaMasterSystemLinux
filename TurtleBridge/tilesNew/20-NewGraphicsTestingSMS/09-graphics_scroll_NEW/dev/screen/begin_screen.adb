...
S:Lbegin_screen.screen_begin_screen_load$po$1_0$107({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$lo$1_0$107({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$player_startY$1_0$107({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_load$level$1_0$107({1}SC:U),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$screen$1_0$107({1}SC:U),R,0,0,[]
F:G$screen_begin_screen_update$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
S:Lbegin_screen.screen_begin_screen_update$screen_type$1_0$108({2}DG,SC:U),B,1,4
S:Lbegin_screen.screen_begin_screen_update$so$1_0$109({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$po$1_0$109({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$lo$1_0$109({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$input$1_0$109({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_update$delta$1_0$109({1}SC:U),B,1,-2
S:Lbegin_screen.screen_begin_screen_update$value$1_0$109({1}SC:U),R,0,0,[c]
S:Lbegin_screen.screen_begin_screen_update$collision$1_0$109({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_update$scroll_state$1_0$109({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_update$sloc0$0_1$0({1}SC:U),B,1,-2
S:Lbegin_screen.screen_begin_screen_update$sloc1$0_1$0({1}SC:U),B,1,-1
S:Lbegin_screen.screen_begin_screen_update$sloc2$0_1$0({1}SC:U),B,1,-1
F:Fbegin_screen$anyPlatforms$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lbegin_screen.anyPlatforms$po$1_0$125({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$lo$1_0$125({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$chasm$1_0$125({1}SC:U),R,0,0,[]
S:Lbegin_screen.anyPlatforms$tilelook$1_0$125({1}SC:U),R,0,0,[c]
S:Lbegin_screen.anyPlatforms$lookup_platform$1_0$125({1}SC:U),R,0,0,[b]
S:Lbegin_screen.anyPlatforms$player_platform$1_0$125({1}SC:U),B,1,-2
...
T:Fbegin_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
...
S:Fbegin_screen$complete$0_0$0({1}:S),E,0,0
...
S:G$engine_player_manager_update3$2_0$124({2}DF,SI:S),C,0,0
