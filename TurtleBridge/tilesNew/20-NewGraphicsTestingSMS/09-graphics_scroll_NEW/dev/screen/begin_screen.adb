...
S:Lbegin_screen.nextPrint$so$1_0$107({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$po$1_0$107({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$lo$1_0$107({2}DG,STtag_struct_level_object:S),R,0,0,[]
