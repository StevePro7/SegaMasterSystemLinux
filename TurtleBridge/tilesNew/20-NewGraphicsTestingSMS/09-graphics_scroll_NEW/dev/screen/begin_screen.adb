...
S:Lbegin_screen.screen_begin_screen_load$cloud$1_0$95({1}SC:U),R,0,0,[a]
F:G$screen_begin_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lbegin_screen.screen_begin_screen_update$screen_type$1_0$96({2}DG,SC:U),B,1,4
T:Fbegin_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
