...
S:Lbegin_screen.screen_begin_screen_load$po$1_0$100({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$lo$1_0$100({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$player_startY$1_0$100({1}SC:U),R,0,0,[a]
...
S:Lbegin_screen.screen_begin_screen_update$so$1_0$102({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$po$1_0$102({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$lo$1_0$102({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$input$1_0$102({1}SC:U),R,0,0,[l]
S:Lbegin_screen.screen_begin_screen_update$delta$1_0$102({1}SC:U),R,0,0,[c]
S:Lbegin_screen.screen_begin_screen_update$collision$1_0$102({1}SC:U),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$newTile$1_0$102({1}:S),R,0,0,[l]
...
S:Lbegin_screen.anyPlatforms$po$1_0$108({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$lo$1_0$108({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$tilelook$1_0$108({2}SI:U),R,0,0,[e,d]
S:Lbegin_screen.anyPlatforms$lookup_platform$1_0$108({1}SC:U),R,0,0,[c]
S:Lbegin_screen.anyPlatforms$player_platform$1_0$108({1}SC:U),B,1,-1
...
S:Lbegin_screen.nextPrint$so$1_0$112({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$po$1_0$112({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$lo$1_0$112({2}DG,STtag_struct_level_object:S),R,0,0,[]
...
T:Fbegin_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({1}SC:U),Z,0,0)({3}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({4}S:S$level_draw_offset$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_platforms$0_0$0({32}DA32d,SC:U),Z,0,0)]
