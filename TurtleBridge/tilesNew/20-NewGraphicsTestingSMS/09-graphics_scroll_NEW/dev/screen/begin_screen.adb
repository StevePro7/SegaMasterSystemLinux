...
S:Lbegin_screen.screen_begin_screen_update$delta$1_0$103({1}SC:U),B,1,-1
S:Lbegin_screen.screen_begin_screen_update$newTile$1_0$103({1}:S),R,0,0,[l]
S:Lbegin_screen.screen_begin_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
...
S:Lbegin_screen.nextPrint$so$1_0$110({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$po$1_0$110({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$lo$1_0$110({2}DG,STtag_struct_level_object:S),R,0,0,[]
