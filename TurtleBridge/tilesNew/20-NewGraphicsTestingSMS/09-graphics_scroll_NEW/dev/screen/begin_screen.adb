...
S:Lbegin_screen.screen_begin_screen_update$so$1_0$103({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
...
S:Lbegin_screen.screen_begin_screen_update$delta$1_0$103({1}SC:U),R,0,0,[d]
S:Lbegin_screen.screen_begin_screen_update$collision$1_0$103({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_update$scroll_state$1_0$103({1}SC:U),R,0,0,[a]
...
S:Lbegin_screen.anyPlatforms$po$1_0$114({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$lo$1_0$114({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$chasm$1_0$114({1}SC:U),R,0,0,[]
S:Lbegin_screen.anyPlatforms$tilelook$1_0$114({2}SI:U),R,0,0,[e,d]
S:Lbegin_screen.anyPlatforms$lookup_platform$1_0$114({1}SC:U),R,0,0,[c]
S:Lbegin_screen.anyPlatforms$player_platform$1_0$114({1}SC:U),B,1,-1
...
S:Lbegin_screen.nextPrint$so$1_0$118({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$po$1_0$118({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.nextPrint$lo$1_0$118({2}DG,STtag_struct_level_object:S),R,0,0,[]
