...
S:Lbegin_screen.screen_begin_screen_load$po$1_0$116({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$lo$1_0$116({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$player_startY$1_0$116({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_load$level$1_0$116({1}SC:U),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_load$screen$1_0$116({1}SC:U),R,0,0,[]
F:G$screen_begin_screen_update$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
S:Lbegin_screen.screen_begin_screen_update$screen_type$1_0$117({2}DG,SC:U),B,1,4
S:Lbegin_screen.screen_begin_screen_update$so$1_0$118({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$po$1_0$118({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$lo$1_0$118({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.screen_begin_screen_update$input$1_0$118({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_update$delta$1_0$118({1}SC:U),B,1,-2
S:Lbegin_screen.screen_begin_screen_update$value$1_0$118({1}SC:U),R,0,0,[c]
S:Lbegin_screen.screen_begin_screen_update$collision$1_0$118({1}SC:U),R,0,0,[a]
S:Lbegin_screen.screen_begin_screen_update$scroll_state$1_0$118({1}SC:U),R,0,0,[a]
...
S:Lbegin_screen.anyPlatforms$po$1_0$134({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$lo$1_0$134({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$chasm$1_0$134({1}SC:U),R,0,0,[]
S:Lbegin_screen.anyPlatforms$tilelook$1_0$134({1}SC:U),R,0,0,[c]
S:Lbegin_screen.anyPlatforms$lookup_platform$1_0$134({1}SC:U),R,0,0,[b]
S:Lbegin_screen.anyPlatforms$player_platform$1_0$134({1}SC:U),B,1,-2
