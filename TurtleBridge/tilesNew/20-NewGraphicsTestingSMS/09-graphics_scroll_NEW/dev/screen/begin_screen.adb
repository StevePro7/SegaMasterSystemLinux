...
S:Lbegin_screen.anyPlatforms$tilelook$1_0$110({2}SI:U),R,0,0,[e,d]
S:Lbegin_screen.anyPlatforms$lookup_platform$1_0$110({1}SC:U),R,0,0,[c]
S:Lbegin_screen.anyPlatforms$player_platform$1_0$110({1}SC:U),B,1,-1
