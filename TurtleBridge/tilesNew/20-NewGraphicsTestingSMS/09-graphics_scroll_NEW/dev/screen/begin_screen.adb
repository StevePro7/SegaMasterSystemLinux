...
S:Lbegin_screen.screen_begin_screen_update$input$1_0$103({1}SC:U),R,0,0,[e]
S:Lbegin_screen.screen_begin_screen_update$delta$1_0$103({1}SC:U),R,0,0,[c]
S:Lbegin_screen.screen_begin_screen_update$collision$1_0$103({1}SC:U),R,0,0,[l]
...
S:Lbegin_screen.anyPlatforms$lo$1_0$110({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lbegin_screen.anyPlatforms$tilelook$1_0$110({2}SI:U),R,0,0,[c,b]
S:Lbegin_screen.anyPlatforms$lookup_platform$1_0$110({1}SC:U),R,0,0,[e]
S:Lbegin_screen.anyPlatforms$player_platform$1_0$110({1}SC:U),B,1,-2
...
S:Lbegin_screen.nextPrint$so$1_0$114({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
