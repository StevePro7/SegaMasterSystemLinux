...
S:Lstart_screen.screen_start_screen_update$screen_type$1_0$111({2}DG,SC:U),B,1,4
...
T:Fstart_screen$tag_struct_hack_object[({0}S:S$hack_object_level$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_object_screen$0_0$0({1}SC:U),Z,0,0)]
