...
S:Lstart_screen.screen_start_screen_update$screen_type$1_0$122({2}DG,SC:U),B,1,4
...
T:Fstart_screen$tag_struct_hack_object[({0}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
