...
S:Lstart_screen.screen_start_screen_update$screen_type$1_0$123({2}DG,SC:U),B,1,4
S:Lstart_screen.screen_start_screen_update$ho$1_0$124({2}DG,STtag_struct_hack_object:S),R,0,0,[c,b]
S:Lstart_screen.screen_start_screen_update$input$1_0$124({1}SC:U),R,0,0,[l]
