...
S:Lstart_screen.screen_start_screen_load$go$1_0$133({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_start_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstart_screen.screen_start_screen_update$screen_type$1_0$135({2}DG,SC:U),B,1,4
S:Lstart_screen.screen_start_screen_update$ho$1_0$136({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lstart_screen.screen_start_screen_update$input$1_0$136({1}SC:U),R,0,0,[l]
S:Lstart_screen.screen_start_screen_update$cloud$1_0$136({1}SC:U),R,0,0,[a]
