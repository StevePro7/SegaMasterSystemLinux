...
S:Lstart_screen.screen_start_screen_load$go$1_0$130({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_start_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstart_screen.screen_start_screen_update$screen_type$1_0$132({2}DG,SC:U),B,1,4
S:Lstart_screen.screen_start_screen_update$ho$1_0$133({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lstart_screen.screen_start_screen_update$input$1_0$133({1}SC:U),R,0,0,[l]
S:Lstart_screen.screen_start_screen_update$cloud$1_0$133({1}SC:U),R,0,0,[a]
...
T:Fstart_screen$tag_struct_hack_object[({0}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
T:Fstart_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
...
T:Fstart_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
