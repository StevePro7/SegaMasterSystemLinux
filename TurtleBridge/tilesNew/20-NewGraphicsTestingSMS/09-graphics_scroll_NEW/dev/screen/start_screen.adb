...
S:Lstart_screen.screen_start_screen_update$screen_type$1_0$125({2}DG,SC:U),B,1,4
S:Lstart_screen.screen_start_screen_update$ho$1_0$126({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lstart_screen.screen_start_screen_update$input$1_0$126({1}SC:U),R,0,0,[l]
