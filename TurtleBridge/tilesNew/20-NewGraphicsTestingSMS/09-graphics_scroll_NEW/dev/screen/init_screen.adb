...
S:Linit_screen.screen_init_screen_load$go$1_0$27({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_init_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Linit_screen.screen_init_screen_update$screen_type$1_0$28({2}DG,SC:U),B,1,4
F:G$screen_init_screen_updateX$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Linit_screen.screen_init_screen_updateX$screen_type$1_0$30({2}DG,SC:U),B,1,4
