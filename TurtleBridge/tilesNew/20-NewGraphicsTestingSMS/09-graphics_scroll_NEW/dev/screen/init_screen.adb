...
F:G$screen_init_screen_update$0_0$0({2}DF,SV:S),Z,0,-2,0,0,0
...
S:Linit_screen.screen_init_screen_update$tempPosnY$1_0$95({1}SC:U),R,0,0,[a]
S:Linit_screen.screen_init_screen_update$tempTileY$1_0$95({1}SC:U),B,1,-5
S:Linit_screen.screen_init_screen_update$isMoveDown$1_0$95({1}:S),B,1,-4
...
S:Linit_screen.screen_init_screen_update$sloc2$0_1$0({1}:S),B,1,-4
S:Linit_screen.screen_init_screen_update$sloc3$0_1$0({1}SC:U),B,1,-3
S:Linit_screen.screen_init_screen_update$sloc4$0_1$0({1}SC:S),B,1,-2
S:Linit_screen.screen_init_screen_update$sloc5$0_1$0({1}SC:U),B,1,-1
S:Linit_screen.screen_init_screen_update$sloc6$0_1$0({1}:S),B,1,-2
