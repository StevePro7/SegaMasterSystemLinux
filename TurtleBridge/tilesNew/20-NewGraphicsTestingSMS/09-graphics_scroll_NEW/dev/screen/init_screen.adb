...
S:Linit_screen.screen_init_screen_update$screen_type$1_0$94({2}DG,SC:U),B,1,4
S:Linit_screen.screen_init_screen_update$po$1_0$95({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Linit_screen.screen_init_screen_update$input$1_0$95({1}SC:U),R,0,0,[a]
S:Linit_screen.screen_init_screen_update$tempCollY$1_0$95({1}SC:U),R,0,0,[c]
S:Linit_screen.screen_init_screen_update$tile$1_0$95({1}SC:U),B,1,-1
S:Linit_screen.screen_init_screen_update$tempPosnY$1_0$95({1}SC:U),B,1,-1
S:Linit_screen.screen_init_screen_update$tempTileY$1_0$95({1}SC:U),B,1,-4
S:Linit_screen.screen_init_screen_update$isMoveDown$1_0$95({1}:S),B,1,-3
S:Linit_screen.screen_init_screen_update$onPlatform$1_0$95({1}:S),B,1,-2
