...
F:G$screen_init_screen_update$0_0$0({2}DF,SV:S),Z,0,-3,0,0,0
S:Linit_screen.screen_init_screen_update$screen_type$1_0$97({2}DG,SC:U),B,1,4
S:Linit_screen.screen_init_screen_update$po$1_0$98({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Linit_screen.screen_init_screen_update$input$1_0$98({1}SC:U),R,0,0,[a]
S:Linit_screen.screen_init_screen_update$tempCollY$1_0$98({1}SC:U),R,0,0,[c]
S:Linit_screen.screen_init_screen_update$tile$1_0$98({1}SC:U),B,1,-1
S:Linit_screen.screen_init_screen_update$tempPosnY$1_0$98({1}SC:U),R,0,0,[a]
S:Linit_screen.screen_init_screen_update$tempTileY$1_0$98({1}SC:U),B,1,-6
S:Linit_screen.screen_init_screen_update$isMoveDown$1_0$98({1}:S),B,1,-5
S:Linit_screen.screen_init_screen_update$onPlatform$1_0$98({1}:S),B,1,-2
S:Linit_screen.screen_init_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
S:Linit_screen.screen_init_screen_update$sloc1$0_1$0({1}SC:U),B,1,-6
S:Linit_screen.screen_init_screen_update$sloc2$0_1$0({1}:S),B,1,-5
S:Linit_screen.screen_init_screen_update$sloc3$0_1$0({2}SI:U),B,1,-4
S:Linit_screen.screen_init_screen_update$sloc4$0_1$0({1}SC:U),B,1,-1
S:Linit_screen.screen_init_screen_update$sloc5$0_1$0({1}SC:S),B,1,-2
S:Linit_screen.screen_init_screen_update$sloc6$0_1$0({1}SC:U),B,1,-1
S:Linit_screen.screen_init_screen_update$sloc7$0_1$0({1}:S),B,1,-2
F:Finit_screen$statPlater$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Linit_screen.statPlater$po$1_0$105({2}DG,STtag_struct_player_object:S),R,0,0,[]
