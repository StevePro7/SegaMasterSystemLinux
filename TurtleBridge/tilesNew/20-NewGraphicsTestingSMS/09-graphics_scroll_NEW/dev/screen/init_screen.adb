...
S:Linit_screen.screen_init_screen_load$go$1_0$28({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_init_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Linit_screen.screen_init_screen_update$screen_type$1_0$29({2}DG,SC:U),B,1,4
...
T:Finit_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
