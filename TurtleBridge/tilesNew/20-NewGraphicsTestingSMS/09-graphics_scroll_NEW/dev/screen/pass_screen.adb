...
S:Lpass_screen.screen_pass_screen_load$po$1_0$97({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_pass_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lpass_screen.screen_pass_screen_update$screen_type$1_0$98({2}DG,SC:U),B,1,4
S:Lpass_screen.screen_pass_screen_update$po$1_0$99({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
T:Fpass_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_draw_offset$0_0$0({1}SC:U),Z,0,0)]
