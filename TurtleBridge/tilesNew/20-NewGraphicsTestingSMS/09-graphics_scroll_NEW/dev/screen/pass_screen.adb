...
S:Lpass_screen.screen_pass_screen_update$screen_type$1_0$107({2}DG,SC:U),B,1,4
S:Lpass_screen.screen_pass_screen_update$po$1_0$108({2}DG,STtag_struct_player_object:S),R,0,0,[]
