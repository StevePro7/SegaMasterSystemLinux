...
S:Lpass_screen.screen_pass_screen_load$co$1_0$114({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_load$po$1_0$114({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_pass_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lpass_screen.screen_pass_screen_update$screen_type$1_0$115({2}DG,SC:U),B,1,4
S:Lpass_screen.screen_pass_screen_update$po$1_0$116({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Lpass_screen.screen_pass_screen_update$input1$1_0$116({1}SC:U),R,0,0,[]
S:Lpass_screen.screen_pass_screen_update$input2$1_0$116({1}SC:U),R,0,0,[]
