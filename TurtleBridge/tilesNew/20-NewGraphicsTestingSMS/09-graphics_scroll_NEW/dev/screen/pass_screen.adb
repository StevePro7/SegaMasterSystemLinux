...
S:Lpass_screen.screen_pass_screen_load$co$1_0$126({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_load$po$1_0$126({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_pass_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lpass_screen.screen_pass_screen_update$screen_type$1_0$127({2}DG,SC:U),B,1,4
S:Lpass_screen.screen_pass_screen_update$po$1_0$128({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_update$go$1_0$128({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_update$input1$1_0$128({1}SC:U),R,0,0,[l]
S:Lpass_screen.screen_pass_screen_update$input2$1_0$128({1}SC:U),R,0,0,[a]
S:Lpass_screen.screen_pass_screen_update$game_level$1_0$128({1}SC:U),R,0,0,[a]
S:Lpass_screen.screen_pass_screen_update$check$1_0$128({1}SC:U),R,0,0,[a]
...
T:Fpass_screen$tag_struct_scroll_object[({0}S:S$scrollLeftX$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollCheck$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollColumn$0_0$0({2}SI:U),Z,0,0)({6}S:S$scrollPoints$0_0$0({2}SI:U),Z,0,0)({8}S:S$scrollFinish$0_0$0({2}SI:U),Z,0,0)({10}S:S$scrollLeftX0$0_0$0({1}SC:U),Z,0,0)({11}S:S$scrollLeftX1$0_0$0({1}SC:U),Z,0,0)({12}S:S$scrollLeftX2$0_0$0({1}SC:U),Z,0,0)({13}S:S$scrollLeftX3$0_0$0({1}SC:U),Z,0,0)({14}S:S$scrollLeftX4$0_0$0({1}SC:U),Z,0,0)({15}S:S$scrollLeftX5$0_0$0({1}SC:U),Z,0,0)({16}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({17}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
T:Fpass_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
