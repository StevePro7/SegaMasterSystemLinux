...
S:Llevel_screen.screen_level_screen_update$updateLevel$1_0$132({1}:S),R,0,0,[c]
F:Flevel_screen$printStats$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.printStats$delta$1_0$152({1}SC:U),R,0,0,[]
...
T:Flevel_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
...
S:Flevel_screen$check_width$0_0$0({1}SC:U),E,0,0
