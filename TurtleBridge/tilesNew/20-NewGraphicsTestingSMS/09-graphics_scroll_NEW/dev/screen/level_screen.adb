...
S:Llevel_screen.screen_level_screen_load$go$1_0$114({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_level_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.screen_level_screen_update$screen_type$1_0$115({2}DG,SC:U),B,1,4
S:Llevel_screen.screen_level_screen_update$input$1_0$116({1}SC:U),R,0,0,[a]
