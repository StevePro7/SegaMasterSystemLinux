...
S:Llevel_screen.screen_level_screen_load$po$1_0$148({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_load$lo$1_0$148({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_load$go$1_0$148({2}DG,STtag_struct_game_object:S),R,0,0,[]
...
F:Flevel_screen$printStats2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.printStats2$delta$1_0$177({1}SC:U),R,0,0,[]
