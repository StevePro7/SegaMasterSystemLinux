...
S:Ldemo_screen.screen_demo_screen_load$po$1_0$127({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$go$1_0$127({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$player_loadY$1_0$127({1}SC:U),B,1,-1
S:Ldemo_screen.screen_demo_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_demo_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldemo_screen.screen_demo_screen_update$screen_type$1_0$128({2}DG,SC:U),B,1,4
S:Ldemo_screen.screen_demo_screen_update$po$1_0$129({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input1$1_0$129({2}SI:U),R,0,0,[e,d]
S:Ldemo_screen.screen_demo_screen_update$input2$1_0$129({2}SI:U),R,0,0,[c,b]
S:Ldemo_screen.screen_demo_screen_update$input3$1_0$129({2}SI:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input4$1_0$129({2}SI:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$deltaY$1_0$129({2}SI:S),R,0,0,[c,b]
...
S:Ldemo_screen.swap_player_frame$po$1_0$137({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fdemo_screen$flip_player_frame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldemo_screen.flip_player_frame$input3$1_0$141({1}SC:U),B,1,4
S:Ldemo_screen.flip_player_frame$input4$1_0$141({1}SC:U),B,1,5
S:Ldemo_screen.flip_player_frame$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
