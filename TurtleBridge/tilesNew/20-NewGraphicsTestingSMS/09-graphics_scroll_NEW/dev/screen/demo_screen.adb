...
S:Ldemo_screen.screen_demo_screen_load$po$1_0$108({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$go$1_0$108({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$player_loadY$1_0$108({1}SC:U),B,1,-1
S:Ldemo_screen.screen_demo_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_demo_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldemo_screen.screen_demo_screen_update$screen_type$1_0$109({2}DG,SC:U),B,1,4
S:Ldemo_screen.screen_demo_screen_update$po$1_0$110({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input1$1_0$110({2}SI:U),R,0,0,[e,d]
S:Ldemo_screen.screen_demo_screen_update$input2$1_0$110({2}SI:U),R,0,0,[c,b]
S:Ldemo_screen.screen_demo_screen_update$input3$1_0$110({2}SI:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input4$1_0$110({2}SI:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$deltaY$1_0$110({2}SI:S),R,0,0,[c,b]
S:Ldemo_screen.screen_demo_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
F:Fdemo_screen$swap_player_frame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldemo_screen.swap_player_frame$po$1_0$118({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fdemo_screen$flip_player_frame$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldemo_screen.flip_player_frame$input3$1_0$122({1}SC:U),B,1,4
S:Ldemo_screen.flip_player_frame$input4$1_0$122({1}SC:U),B,1,5
S:Ldemo_screen.flip_player_frame$po$1_0$123({2}DG,STtag_struct_player_object:S),R,0,0,[]
T:Fdemo_screen$tag_struct_player_object[({0}S:S$posnX$0_0$0({2}SI:U),Z,0,0)({2}S:S$tileX$0_0$0({2}SI:U),Z,0,0)({4}S:S$initX$0_0$0({1}SC:U),Z,0,0)({5}S:S$lookX$0_0$0({1}SC:U),Z,0,0)({6}S:S$initY$0_0$0({1}SC:U),Z,0,0)({7}S:S$posnY$0_0$0({1}SC:U),Z,0,0)({8}S:S$tileY$0_0$0({1}SC:U),Z,0,0)({9}S:S$leapY$0_0$0({2}SI:U),Z,0,0)({11}S:S$drawX$0_0$0({1}SC:U),Z,0,0)({12}S:S$drawY$0_0$0({1}SC:U),Z,0,0)({13}S:S$player_state$0_0$0({1}SC:U),Z,0,0)({14}S:S$player_index$0_0$0({1}SC:U),Z,0,0)({15}S:S$player_frame$0_0$0({1}SC:U),Z,0,0)({16}S:S$player_count$0_0$0({2}SI:U),Z,0,0)]
...
T:Fdemo_screen$tag_struct_hack_object[({0}S:S$hack_object_level$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_object_screen$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
...
T:Fdemo_screen$tag_struct_audio_object[({0}S:S$music_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$music_bank$0_0$0({1}SC:U),Z,0,0)({3}S:S$sound_data$0_0$0({2}DG,SC:U),Z,0,0)({5}S:S$sound_bank$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)]
S:Fdemo_screen$jumps$0_0$0({124}DA62d,SI:S),E,0,0
...
S:Fdemo_screen$player_loadY$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$frame$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$landingY$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$index$0_0$0({1}SC:U),E,0,0
