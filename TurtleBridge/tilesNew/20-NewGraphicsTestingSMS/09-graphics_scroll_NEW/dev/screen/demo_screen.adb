...
F:G$screen_demo_screen_update$0_0$0({2}DF,SV:S),Z,0,-2,0,0,0
...
S:Ldemo_screen.screen_demo_screen_update$player_state$1_0$143({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$command$1_0$143({1}SC:U),B,1,-3
