...
S:Ldemo_screen.screen_demo_screen_update$screen_type$1_0$95({2}DG,SC:U),B,1,4
S:Ldemo_screen.screen_demo_screen_update$input$1_0$96({1}SC:U),R,0,0,[a]
F:Fdemo_screen$draw_tiles$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldemo_screen.draw_tiles$tmp$1_0$99({2}SI:U),B,1,4
S:Ldemo_screen.draw_tiles$tiles$1_0$100({2}DG,SC:U),R,0,0,[]
