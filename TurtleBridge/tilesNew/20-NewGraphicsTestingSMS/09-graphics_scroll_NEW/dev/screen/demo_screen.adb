...
S:Ldemo_screen.screen_demo_screen_load$po$1_0$141({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$lo$1_0$141({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$go$1_0$141({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$player_loadY$1_0$141({1}SC:U),R,0,0,[a]
S:Ldemo_screen.screen_demo_screen_load$checkScreen$1_0$141({1}SC:U),B,1,-1
S:Ldemo_screen.screen_demo_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_demo_screen_update$0_0$0({2}DF,SV:S),Z,0,-10,0,0,0
S:Ldemo_screen.screen_demo_screen_update$screen_type$1_0$142({2}DG,SC:U),B,1,4
S:Ldemo_screen.screen_demo_screen_update$fo$1_0$143({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$ho$1_0$143({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$so$1_0$143({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$po$1_0$143({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$lo$1_0$143({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$go$1_0$143({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$co$1_0$143({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input1$1_0$143({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input2$1_0$143({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$deltaX$1_0$143({1}SC:U),R,0,0,[b]
S:Ldemo_screen.screen_demo_screen_update$loops$1_0$143({1}SC:U),R,0,0,[c]
S:Ldemo_screen.screen_demo_screen_update$scroll_state$1_0$143({1}SC:U),R,0,0,[a]
S:Ldemo_screen.screen_demo_screen_update$player_state$1_0$143({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$command$1_0$143({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc0$0_1$0({2}SI:S),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc1$0_1$0({2}SI:U),B,1,-4
S:Ldemo_screen.screen_demo_screen_update$sloc2$0_1$0({2}DD,SI:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc3$0_1$0({2}SI:U),B,1,-4
S:Ldemo_screen.screen_demo_screen_update$sloc4$0_1$0({2}SI:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc5$0_1$0({2}DD,SC:U),B,1,-5
S:Ldemo_screen.screen_demo_screen_update$sloc6$0_1$0({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc7$0_1$0({1}SC:U),B,1,-1
S:Ldemo_screen.screen_demo_screen_update$sloc8$0_1$0({1}SC:U),B,1,-1
...
T:Fdemo_screen$tag_struct_hack_object[({0}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
...
S:Fdemo_screen$printCmds$0_0$0({2}DF,SV:S),C,0,0
