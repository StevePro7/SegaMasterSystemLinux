...
S:Ldemo_screen.screen_demo_screen_load$co$1_0$100({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$idx$1_0$100({1}SC:U),R,0,0,[]
F:G$screen_demo_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldemo_screen.screen_demo_screen_update$screen_type$1_0$101({2}DG,SC:U),B,1,4
