...
S:Ltest_screen.screen_test_screen_load$po$1_0$111({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_load$go$1_0$111({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_test_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.screen_test_screen_update$screen_type$1_0$112({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$po$1_0$113({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Ltest_screen.screen_test_screen_update$tmpY2$1_0$113({2}SI:U),B,1,-2
S:Ltest_screen.screen_test_screen_update$tmpY$1_0$113({1}SC:U),R,0,0,[e]
S:Ltest_screen.screen_test_screen_update$input$1_0$113({1}SC:U),R,0,0,[a]
S:Ltest_screen.screen_test_screen_update$delta$1_0$113({2}SI:S),B,1,-4
...
S:Ltest_screen.screen_test_screen_updateX$screen_type$1_0$119({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_updateX$po$1_0$120({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Ltest_screen.screen_test_screen_updateX$tmpY2$1_0$120({2}SI:U),R,0,0,[l,c]
S:Ltest_screen.screen_test_screen_updateX$tmpY$1_0$120({1}SC:U),R,0,0,[c]
S:Ltest_screen.screen_test_screen_updateX$input$1_0$120({1}SC:U),R,0,0,[a]
S:Ltest_screen.screen_test_screen_updateX$delta$1_0$120({2}SI:S),R,0,0,[c,b]
