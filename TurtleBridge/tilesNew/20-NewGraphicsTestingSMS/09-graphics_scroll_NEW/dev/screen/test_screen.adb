...
S:Ltest_screen.screen_test_screen_update$input$1_0$99({1}SC:U),R,0,0,[a]
F:Ftest_screen$draw_title$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.draw_title$tmp$1_0$102({2}SI:U),B,1,4
S:Ltest_screen.draw_title$tiles$1_0$103({2}DG,SC:U),R,0,0,[]
S:Ltest_screen.draw_title$idx$1_0$103({2}SI:U),R,0,0,[l,h]
S:Ltest_screen.draw_title$val$1_0$103({2}SI:U),R,0,0,[e,d]
S:Ltest_screen.draw_title$row$1_0$103({1}SC:U),R,0,0,[c]
S:Ltest_screen.draw_title$col$1_0$103({1}SC:U),R,0,0,[b]
S:Ltest_screen.draw_title$x$1_0$103({1}SC:U),R,0,0,[]
S:Ltest_screen.draw_title$y$1_0$103({1}SC:U),R,0,0,[]
S:Ltest_screen.draw_title$size$1_0$103({1}SC:U),R,0,0,[]
