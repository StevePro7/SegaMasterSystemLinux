...
S:Ltest_screen.screen_test_screen_update$screen_type$1_0$127({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$fo$1_0$128({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$so$1_0$128({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$po$1_0$128({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$lo$1_0$128({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$go$1_0$128({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$co$1_0$128({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$input1$1_0$128({1}SC:U),R,0,0,[c]
S:Ltest_screen.screen_test_screen_update$input2$1_0$128({1}SC:U),R,0,0,[b]
S:Ltest_screen.screen_test_screen_update$deltaX$1_0$128({1}SC:U),R,0,0,[c]
S:Ltest_screen.screen_test_screen_update$loops$1_0$128({1}SC:U),R,0,0,[e]
S:Ltest_screen.screen_test_screen_update$scroll_state$1_0$128({1}SC:U),R,0,0,[a]
S:Ltest_screen.screen_test_screen_update$player_state$1_0$128({1}SC:U),B,1,-1
S:Ltest_screen.screen_test_screen_update$command$1_0$128({1}SC:U),B,1,-2
...
T:Ftest_screen$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_frame_index$0_0$0({6}DA3d,SI:U),Z,0,0)({10}S:S$storage_this_command$0_0$0({3}DA3d,SC:U),Z,0,0)({13}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
