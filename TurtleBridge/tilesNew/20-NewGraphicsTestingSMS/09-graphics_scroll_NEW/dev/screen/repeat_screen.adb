...
S:Lrepeat_screen.screen_repeat_screen_update$input1$1_0$142({1}SC:U),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$input2$1_0$142({1}SC:U),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$deltaX$1_0$142({1}SC:U),R,0,0,[b]
S:Lrepeat_screen.screen_repeat_screen_update$loops$1_0$142({1}SC:U),R,0,0,[e]
S:Lrepeat_screen.screen_repeat_screen_update$scroll_state$1_0$142({1}SC:U),R,0,0,[a]
S:Lrepeat_screen.screen_repeat_screen_update$player_state$1_0$142({1}SC:U),B,1,-5
S:Lrepeat_screen.screen_repeat_screen_update$command$1_0$142({1}SC:U),R,0,0,[c]
