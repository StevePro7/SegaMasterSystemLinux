...
S:Loption_screen.screen_option_screen_load$idx$1_0$27({1}SC:U),R,0,0,[b]
F:G$screen_option_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Loption_screen.screen_option_screen_update$screen_type$1_0$30({2}DG,SC:U),B,1,4
S:Loption_screen.screen_option_screen_update$input1$1_0$31({1}SC:U),R,0,0,[c]
S:Loption_screen.screen_option_screen_update$input2$1_0$31({1}SC:U),R,0,0,[l]
S:Loption_screen.screen_option_screen_update$input3$1_0$31({1}SC:U),R,0,0,[l]
...
T:Foption_screen$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_frame_index$0_0$0({32}DA16d,SI:U),Z,0,0)({36}S:S$storage_this_command$0_0$0({16}DA16d,SC:U),Z,0,0)({52}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
