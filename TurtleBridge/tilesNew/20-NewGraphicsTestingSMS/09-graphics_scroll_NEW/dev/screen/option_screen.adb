...
S:Loption_screen.screen_option_screen_update$screen_type$1_0$53({2}DG,SC:U),B,1,4
S:Loption_screen.screen_option_screen_update$so$1_0$54({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Loption_screen.screen_option_screen_update$po$1_0$54({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Loption_screen.screen_option_screen_update$lo$1_0$54({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Loption_screen.screen_option_screen_update$go$1_0$54({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Loption_screen.screen_option_screen_update$input$1_0$54({1}SC:U),R,0,0,[a]
S:Loption_screen.screen_option_screen_update$deltaX$1_0$54({1}SC:U),B,1,-4
S:Loption_screen.screen_option_screen_update$deltaY$1_0$54({1}SC:S),R,0,0,[b]
S:Loption_screen.screen_option_screen_update$loops$1_0$54({1}SC:U),B,1,-1
S:Loption_screen.screen_option_screen_update$collision$1_0$54({1}SC:S),R,0,0,[l]
S:Loption_screen.screen_option_screen_update$scroll_state$1_0$54({1}SC:U),R,0,0,[l]
S:Loption_screen.screen_option_screen_update$sloc0$0_1$0({1}SC:U),B,1,-4
S:Loption_screen.screen_option_screen_update$sloc1$0_1$0({1}SC:U),B,1,-1
S:Loption_screen.screen_option_screen_update$sloc2$0_1$0({2}SI:U),B,1,-3
F:Foption_screen$reset$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Foption_screen$tag_struct_player_object[({0}S:S$posnX$0_0$0({2}SI:U),Z,0,0)({2}S:S$tileX$0_0$0({2}SI:U),Z,0,0)({4}S:S$initX$0_0$0({1}SC:U),Z,0,0)({5}S:S$lookX$0_0$0({1}SC:U),Z,0,0)({6}S:S$initY$0_0$0({1}SC:U),Z,0,0)({7}S:S$posnY$0_0$0({1}SC:U),Z,0,0)({8}S:S$tileY$0_0$0({1}SC:U),Z,0,0)({9}S:S$leapY$0_0$0({2}SI:U),Z,0,0)({11}S:S$drawX$0_0$0({1}SC:U),Z,0,0)({12}S:S$drawY$0_0$0({1}SC:U),Z,0,0)({13}S:S$player_state$0_0$0({1}SC:U),Z,0,0)({14}S:S$player_index$0_0$0({1}SC:U),Z,0,0)({15}S:S$player_frame$0_0$0({1}SC:U),Z,0,0)({16}S:S$player_count$0_0$0({2}SI:U),Z,0,0)]
...
T:Foption_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
T:Foption_screen$tag_struct_frame_object[({0}S:S$frame_count$0_0$0({2}SI:U),Z,0,0)]
T:Foption_screen$tag_struct_delay_object[({0}S:S$delay_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
T:Foption_screen$tag_struct_audio_object[({0}S:S$music_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$music_bank$0_0$0({1}SC:U),Z,0,0)({3}S:S$sound_data$0_0$0({2}DG,SC:U),Z,0,0)({5}S:S$sound_bank$0_0$0({1}SC:U),Z,0,0)]
T:Foption_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
T:Foption_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)]
...
S:Foption_screen$ptr$0_0$0({2}DG,SI:S),E,0,0
S:Foption_screen$indexZ$0_0$0({1}SC:S),E,0,0
S:Foption_screen$valueX$0_0$0({1}SC:U),E,0,0
S:Foption_screen$len$0_0$0({1}SC:U),E,0,0
