...
S:Loption_screen.screen_option_screen_load$idx$1_0$21({1}SC:U),R,0,0,[b]
F:G$screen_option_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Loption_screen.screen_option_screen_update$screen_type$1_0$24({2}DG,SC:U),B,1,4
S:Loption_screen.screen_option_screen_update$input1$1_0$25({1}SC:U),R,0,0,[c]
S:Loption_screen.screen_option_screen_update$input2$1_0$25({1}SC:U),R,0,0,[l]
S:Loption_screen.screen_option_screen_update$input3$1_0$25({1}SC:U),R,0,0,[l]
