...
S:Lrecord_screen.screen_record_screen_load$po$1_0$138({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_load$lo$1_0$138({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_load$go$1_0$138({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_load$player_loadY$1_0$138({1}SC:U),R,0,0,[a]
S:Lrecord_screen.screen_record_screen_load$checkScreen$1_0$138({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_load$cloud_formation$1_0$138({1}SC:U),R,0,0,[]
...
S:Lrecord_screen.screen_record_screen_update$screen_type$1_0$139({2}DG,SC:U),B,1,4
S:Lrecord_screen.screen_record_screen_update$fo$1_0$140({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$so$1_0$140({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$po$1_0$140({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$co$1_0$140({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$lo$1_0$140({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$go$1_0$140({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$input1$1_0$140({1}SC:U),B,1,-4
S:Lrecord_screen.screen_record_screen_update$input2$1_0$140({1}SC:U),B,1,-3
S:Lrecord_screen.screen_record_screen_update$input3$1_0$140({1}SC:U),B,1,-2
S:Lrecord_screen.screen_record_screen_update$input4$1_0$140({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$input5$1_0$140({1}SC:U),R,0,0,[c]
S:Lrecord_screen.screen_record_screen_update$input6$1_0$140({1}SC:U),R,0,0,[a]
S:Lrecord_screen.screen_record_screen_update$command$1_0$140({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$deltaX$1_0$140({1}SC:U),R,0,0,[b]
S:Lrecord_screen.screen_record_screen_update$loops$1_0$140({1}SC:U),R,0,0,[c]
S:Lrecord_screen.screen_record_screen_update$scroll_state$1_0$140({1}SC:U),R,0,0,[a]
S:Lrecord_screen.screen_record_screen_update$player_state$1_0$140({1}SC:U),B,1,-5
S:Lrecord_screen.screen_record_screen_update$sloc0$0_1$0({1}SC:U),B,1,-5
S:Lrecord_screen.screen_record_screen_update$sloc1$0_1$0({1}SC:U),B,1,-4
S:Lrecord_screen.screen_record_screen_update$sloc2$0_1$0({1}SC:U),B,1,-3
S:Lrecord_screen.screen_record_screen_update$sloc3$0_1$0({1}SC:U),B,1,-2
S:Lrecord_screen.screen_record_screen_update$sloc4$0_1$0({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$sloc5$0_1$0({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$sloc6$0_1$0({1}SC:U),B,1,-2
S:Lrecord_screen.screen_record_screen_update$sloc7$0_1$0({1}SC:U),B,1,-1
...
T:Frecord_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)]
...
S:G$global_game_object$0_0$0({9}STtag_struct_game_object:S),E,0,0
...
S:Frecord_screen$deltaY$0_0$0({2}SI:S),E,0,0
...
S:G$engine_game_manager_set_start_game$0_0$0({2}DF,SV:S),C,0,0
