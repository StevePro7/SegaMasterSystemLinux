...
S:Lload_screen.screen_load_screen_load$po$1_0$112({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$lo$1_0$112({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$go$1_0$112({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$player_loadY$1_0$112({1}SC:U),R,0,0,[a]
F:G$screen_load_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lload_screen.screen_load_screen_update$screen_type$1_0$113({2}DG,SC:U),B,1,4
...
T:Fload_screen$tag_struct_audio_object[({0}S:S$music_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$music_bank$0_0$0({1}SC:U),Z,0,0)({3}S:S$sound_data$0_0$0({2}DG,SC:U),Z,0,0)({5}S:S$sound_bank$0_0$0({1}SC:U),Z,0,0)]
