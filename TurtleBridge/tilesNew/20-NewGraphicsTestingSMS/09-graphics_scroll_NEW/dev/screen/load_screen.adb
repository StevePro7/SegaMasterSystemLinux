...
S:Lload_screen.screen_load_screen_update$screen_type$1_0$97({2}DG,SC:U),B,1,4
S:Lload_screen.screen_load_screen_update$input$1_0$98({1}SC:U),R,0,0,[a]
F:Fload_screen$drawScreen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lload_screen.drawScreen$tile$1_0$102({2}SI:U),R,0,0,[]
