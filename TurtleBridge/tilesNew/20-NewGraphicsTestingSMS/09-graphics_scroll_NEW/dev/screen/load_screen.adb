...
S:Lload_screen.screen_load_screen_update$screen_type$1_0$100({2}DG,SC:U),B,1,4
S:Lload_screen.screen_load_screen_update$input$1_0$101({1}SC:U),R,0,0,[a]
F:Fload_screen$drawScreen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lload_screen.drawScreen$tile$1_0$105({2}SI:U),R,0,0,[]
...
T:Fload_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({1}SC:U),Z,0,0)({3}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({4}S:S$level_draw_offset$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_platforms$0_0$0({32}DA32d,SC:U),Z,0,0)]
