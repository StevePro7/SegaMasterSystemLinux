...
S:Lload_screen.screen_load_screen_load$po$1_0$129({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$lo$1_0$129({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$go$1_0$129({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$player_loadY$1_0$129({1}SC:U),R,0,0,[a]
S:Lload_screen.screen_load_screen_load$checkScreen$1_0$129({1}SC:U),R,0,0,[c]
F:G$screen_load_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lload_screen.screen_load_screen_update$screen_type$1_0$130({2}DG,SC:U),B,1,4
