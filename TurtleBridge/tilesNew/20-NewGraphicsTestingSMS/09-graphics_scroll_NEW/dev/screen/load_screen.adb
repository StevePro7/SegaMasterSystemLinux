...
S:Lload_screen.screen_load_screen_load$po$1_0$141({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$lo$1_0$141({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$go$1_0$141({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$player_loadY$1_0$141({1}SC:U),R,0,0,[a]
S:Lload_screen.screen_load_screen_load$checkScreen$1_0$141({1}SC:U),B,1,-1
S:Lload_screen.screen_load_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_load_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lload_screen.screen_load_screen_update$screen_type$1_0$142({2}DG,SC:U),B,1,4
S:Lload_screen.screen_load_screen_update$go$1_0$143({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$ho$1_0$143({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$index$1_0$143({1}SC:U),R,0,0,[]
S:Lload_screen.screen_load_screen_update$maxim$1_0$143({1}SC:U),R,0,0,[]
S:Lload_screen.screen_load_screen_update$input$1_0$143({1}SC:U),R,0,0,[e]
...
T:Fload_screen$tag_struct_hack_object[({0}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_inair$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
