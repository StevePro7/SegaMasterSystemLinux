...
S:Lcont_screen.screen_cont_screen_update$screen_type$1_0$114({2}DG,SC:U),B,1,4
S:Lcont_screen.screen_cont_screen_update$po$1_0$115({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_update$go$1_0$115({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_update$input$1_0$115({1}SC:U),R,0,0,[l]
...
T:Fcont_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_saved$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({7}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)]
