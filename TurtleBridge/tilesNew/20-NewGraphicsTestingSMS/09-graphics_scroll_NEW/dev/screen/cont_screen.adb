...
S:Lcont_screen.screen_cont_screen_update$screen_type$1_0$113({2}DG,SC:U),B,1,4
S:Lcont_screen.screen_cont_screen_update$po$1_0$114({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_update$go$1_0$114({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_update$input$1_0$114({1}SC:U),R,0,0,[l]
