...
S:Lready_screen.screen_ready_screen_update$screen_type$1_0$97({2}DG,SC:U),B,1,4
S:Lready_screen.screen_ready_screen_update$input$1_0$98({2}SI:U),R,0,0,[l,h]
F:Fready_screen$drawScreen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lready_screen.drawScreen$tile$1_0$100({2}SI:U),R,0,0,[]
