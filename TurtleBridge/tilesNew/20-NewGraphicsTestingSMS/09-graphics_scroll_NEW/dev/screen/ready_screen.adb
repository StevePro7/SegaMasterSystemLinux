...
S:Lready_screen.screen_ready_screen_update$screen_type$1_0$105({2}DG,SC:U),B,1,4
S:Lready_screen.screen_ready_screen_update$input1$1_0$106({2}SI:U),R,0,0,[]
S:Lready_screen.screen_ready_screen_update$input2$1_0$106({2}SI:U),R,0,0,[l,h]
F:Fready_screen$drawScreen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lready_screen.drawScreen$tile$1_0$108({2}SI:U),R,0,0,[]
