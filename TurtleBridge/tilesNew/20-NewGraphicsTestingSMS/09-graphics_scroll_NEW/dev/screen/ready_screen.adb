...
S:Lready_screen.screen_ready_screen_update$screen_type$1_0$27({2}DG,SC:U),B,1,4
S:Lready_screen.screen_ready_screen_update$fo$1_0$28({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lready_screen.screen_ready_screen_update$po$1_0$28({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lready_screen.screen_ready_screen_update$co$1_0$28({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lready_screen.screen_ready_screen_update$input1$1_0$28({1}SC:U),B,1,-4
S:Lready_screen.screen_ready_screen_update$input2$1_0$28({1}SC:U),B,1,-3
S:Lready_screen.screen_ready_screen_update$input3$1_0$28({1}SC:U),B,1,-2
S:Lready_screen.screen_ready_screen_update$input4$1_0$28({1}SC:U),B,1,-1
S:Lready_screen.screen_ready_screen_update$input5$1_0$28({1}SC:U),R,0,0,[c]
S:Lready_screen.screen_ready_screen_update$input6$1_0$28({1}SC:U),R,0,0,[l]
S:Lready_screen.screen_ready_screen_update$command$1_0$28({1}SC:U),R,0,0,[c]
