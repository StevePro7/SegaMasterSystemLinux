...
S:Lready_screen.screen_ready_screen_load$posnX$1_0$110({2}SI:U),R,0,0,[]
S:Lready_screen.screen_ready_screen_load$tileX$1_0$110({1}SC:U),R,0,0,[]
F:G$screen_ready_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lready_screen.screen_ready_screen_update$screen_type$1_0$111({2}DG,SC:U),B,1,4
