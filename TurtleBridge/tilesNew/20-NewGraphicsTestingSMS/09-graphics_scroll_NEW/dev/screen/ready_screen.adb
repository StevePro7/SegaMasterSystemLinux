...
S:Lready_screen.screen_ready_screen_update$screen_type$1_0$96({2}DG,SC:U),B,1,4
S:Lready_screen.screen_ready_screen_update$input$1_0$97({2}SI:U),R,0,0,[l,h]
F:Fready_screen$drawScreen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lready_screen.drawScreen$tile$1_0$99({2}SI:U),R,0,0,[]
...
T:Fready_screen$tag_struct_tile_object[({0}S:S$tilemap_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$tile_wide$0_0$0({1}SC:U),Z,0,0)({3}S:S$tile_platform$0_0$0({1}SC:U),Z,0,0)]
T:Fready_screen$tag_struct_level_object[({0}S:S$xlevel_planesA$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$xlevel_columnA$0_0$0({2}DG,SC:U),Z,0,0)({4}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({6}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({7}S:S$level_cols_offset$0_0$0({2}SI:U),Z,0,0)({9}S:S$level_draw_offset$0_0$0({1}SC:U),Z,0,0)]
