...
S:Lintro_screen.screen_intro_screen_update$so$1_0$107({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
...
S:Lintro_screen.screen_intro_screen_update$delta$1_0$107({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$value$1_0$107({1}SC:U),R,0,0,[b]
