...
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$99({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$so$1_0$100({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$lo$1_0$100({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$input$1_0$100({1}SC:U),R,0,0,[a]
