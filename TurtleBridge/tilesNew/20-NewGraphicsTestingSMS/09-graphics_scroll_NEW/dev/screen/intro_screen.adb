...
S:Lintro_screen.screen_intro_screen_load$lo$1_0$120({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$go$1_0$120({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_intro_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$121({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$so$1_0$122({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$input0$1_0$122({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_update$input1$1_0$122({1}SC:U),R,0,0,[d]
S:Lintro_screen.screen_intro_screen_update$input2$1_0$122({1}SC:U),R,0,0,[l]
S:Lintro_screen.screen_intro_screen_update$deltaX$1_0$122({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_update$loops$1_0$122({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$scroll_state$1_0$122({1}SC:U),R,0,0,[a]
