...
S:Lintro_screen.screen_intro_screen_load$po$1_0$127({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$lo$1_0$127({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$go$1_0$127({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$player_loadY$1_0$127({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_load$cloud_formation$1_0$127({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_intro_screen_update$0_0$0({2}DF,SV:S),Z,0,-3,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$128({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$fo$1_0$129({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$so$1_0$129({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$po$1_0$129({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$co$1_0$129({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$lo$1_0$129({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$go$1_0$129({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$input1$1_0$129({1}SC:U),B,1,-4
S:Lintro_screen.screen_intro_screen_update$input2$1_0$129({1}SC:U),B,1,-3
S:Lintro_screen.screen_intro_screen_update$input3$1_0$129({1}SC:U),B,1,-2
S:Lintro_screen.screen_intro_screen_update$input4$1_0$129({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_update$input5$1_0$129({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$input6$1_0$129({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_update$command$1_0$129({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_update$deltaX$1_0$129({1}SC:U),R,0,0,[b]
S:Lintro_screen.screen_intro_screen_update$loops$1_0$129({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$scroll_state$1_0$129({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_update$player_state$1_0$129({1}SC:U),B,1,-5
S:Lintro_screen.screen_intro_screen_update$sloc0$0_1$0({1}SC:U),B,1,-5
S:Lintro_screen.screen_intro_screen_update$sloc1$0_1$0({1}SC:U),B,1,-4
S:Lintro_screen.screen_intro_screen_update$sloc2$0_1$0({1}SC:U),B,1,-3
S:Lintro_screen.screen_intro_screen_update$sloc3$0_1$0({1}SC:U),B,1,-2
S:Lintro_screen.screen_intro_screen_update$sloc4$0_1$0({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_update$sloc5$0_1$0({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_update$sloc6$0_1$0({1}SC:U),B,1,-2
S:Lintro_screen.screen_intro_screen_update$sloc7$0_1$0({1}SC:U),B,1,-1
...
T:Fintro_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$curr_command$0_0$0({1}SC:U),Z,0,0)({3}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
T:Fintro_screen$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_difficulty$0_0$0({1}SC:U),Z,0,0)({5}S:S$storage_world$0_0$0({1}SC:U),Z,0,0)({6}S:S$storage_round$0_0$0({1}SC:U),Z,0,0)({7}S:S$storage_level$0_0$0({1}SC:U),Z,0,0)({8}S:S$storage_point$0_0$0({1}SC:U),Z,0,0)({9}S:S$storage_padding$0_0$0({7}DA7d,SC:U),Z,0,0)({16}S:S$storage_frame_index$0_0$0({128}DA64d,SI:U),Z,0,0)({144}S:S$storage_this_command$0_0$0({64}DA64d,SC:U),Z,0,0)({208}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
...
T:Fintro_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({1}SC:U),Z,0,0)({1}S:S$reset_timer$0_0$0({1}SC:U),Z,0,0)]
...
S:Fintro_screen$deltaY$0_0$0({2}SI:S),E,0,0
