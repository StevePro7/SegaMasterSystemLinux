...
T:Fintro_screen$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_frame_index$0_0$0({4}DA2d,SI:U),Z,0,0)({8}S:S$storage_this_command$0_0$0({2}DA2d,SC:U),Z,0,0)({10}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
