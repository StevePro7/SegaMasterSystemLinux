...
S:Lintro_screen.screen_intro_screen_load$ho$1_0$103({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$po$1_0$103({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$lo$1_0$103({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$player_startY$1_0$103({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_load$level$1_0$103({1}SC:U),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$screen$1_0$103({1}SC:U),R,0,0,[]
F:G$screen_intro_screen_update$0_0$0({2}DF,SV:S),Z,0,-4,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$104({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$so$1_0$105({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$lo$1_0$105({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$input$1_0$105({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_update$delta$1_0$105({1}SC:U),B,1,-2
S:Lintro_screen.screen_intro_screen_update$value$1_0$105({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_update$scroll_state$1_0$105({1}SC:U),B,1,-3
