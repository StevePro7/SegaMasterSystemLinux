...
S:Lintro_screen.screen_intro_screen_load$po$1_0$100({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$lo$1_0$100({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$player_startY$1_0$100({1}SC:U),R,0,0,[a]
F:G$screen_intro_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$101({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$so$1_0$102({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$lo$1_0$102({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$input$1_0$102({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_update$delta$1_0$102({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$value$1_0$102({1}SC:U),R,0,0,[b]
S:Lintro_screen.screen_intro_screen_update$newTile$1_0$102({1}:S),R,0,0,[l]
