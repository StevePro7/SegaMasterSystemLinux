...
T:Fintro_screen$tag_struct_scroll_object[({0}S:S$scrollLeftX$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollDeltaX$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollFinish$0_0$0({2}SI:U),Z,0,0)({6}S:S$scroll_x0$0_0$0({1}SC:U),Z,0,0)({7}S:S$scroll_x1$0_0$0({1}SC:U),Z,0,0)({8}S:S$scroll_x2$0_0$0({1}SC:U),Z,0,0)({9}S:S$scroll_x3$0_0$0({1}SC:U),Z,0,0)({10}S:S$scroll_x4$0_0$0({1}SC:U),Z,0,0)({11}S:S$scroll_x5$0_0$0({1}SC:U),Z,0,0)({12}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({13}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
