...
S:Lintro_screen.screen_intro_screen_update$input0$1_0$127({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_update$input1$1_0$127({1}SC:U),R,0,0,[e]
S:Lintro_screen.screen_intro_screen_update$input2$1_0$127({1}SC:U),R,0,0,[l]
S:Lintro_screen.screen_intro_screen_update$deltaX$1_0$127({1}SC:U),R,0,0,[d]
S:Lintro_screen.screen_intro_screen_update$loops$1_0$127({1}SC:U),R,0,0,[e]
...
T:Fintro_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$check_width$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
