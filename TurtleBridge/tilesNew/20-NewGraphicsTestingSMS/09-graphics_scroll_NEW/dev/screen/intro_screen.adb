...
S:Lintro_screen.screen_intro_screen_load$ho$1_0$106({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$po$1_0$106({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$lo$1_0$106({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$player_startY$1_0$106({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_load$level$1_0$106({1}SC:U),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$screen$1_0$106({1}SC:U),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$difficulty$1_0$106({1}SC:U),R,0,0,[]
F:G$screen_intro_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$107({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$so$1_0$108({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
S:Lintro_screen.screen_intro_screen_update$po$1_0$108({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$lo$1_0$108({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lintro_screen.screen_intro_screen_update$input$1_0$108({1}SC:U),R,0,0,[a]
S:Lintro_screen.screen_intro_screen_update$delta$1_0$108({1}SC:U),R,0,0,[e]
S:Lintro_screen.screen_intro_screen_update$value$1_0$108({1}SC:U),R,0,0,[d]
S:Lintro_screen.screen_intro_screen_update$collision$1_0$108({1}SC:S),R,0,0,[l]
S:Lintro_screen.screen_intro_screen_update$scroll_state$1_0$108({1}SC:U),R,0,0,[a]
