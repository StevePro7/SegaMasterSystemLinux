...
S:Lplay_screen.screen_play_screen_update$screen_type$1_0$20({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$so$1_0$21({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$po$1_0$21({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$lo$1_0$21({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$delta$1_0$21({1}SC:U),R,0,0,[c]
S:Lplay_screen.screen_play_screen_update$value$1_0$21({1}SC:U),R,0,0,[b]
S:Lplay_screen.screen_play_screen_update$collision$1_0$21({1}SC:S),R,0,0,[l]
S:Lplay_screen.screen_play_screen_update$scroll_state$1_0$21({1}SC:U),R,0,0,[a]
F:Fplay_screen$getDelta$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplay_screen.getDelta$input$1_0$32({1}SC:U),R,0,0,[a]
S:Lplay_screen.getDelta$delta$1_0$32({1}SC:U),R,0,0,[l]
