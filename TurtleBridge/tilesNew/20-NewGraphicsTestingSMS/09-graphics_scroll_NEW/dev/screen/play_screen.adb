...
S:Lplay_screen.printScrollInfo$so$1_0$50({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lplay_screen.printScrollInfo$lookup1$1_0$50({1}SC:U),R,0,0,[a]
S:Lplay_screen.printScrollInfo$lookup2$1_0$50({1}SC:U),R,0,0,[a]
F:G$screen_play_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplay_screen.screen_play_screen_load$go$1_0$51({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_play_screen_update$0_0$0({2}DF,SV:S),Z,0,-4,0,0,0
S:Lplay_screen.screen_play_screen_update$screen_type$1_0$52({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$fo$1_0$53({2}DG,STtag_struct_frame_object:S),R,0,0,[e,d]
S:Lplay_screen.screen_play_screen_update$so$1_0$53({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$po$1_0$53({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$lo$1_0$53({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$go$1_0$53({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$input1$1_0$53({1}SC:U),B,1,-1
S:Lplay_screen.screen_play_screen_update$input2$1_0$53({1}SC:U),R,0,0,[l]
S:Lplay_screen.screen_play_screen_update$input3$1_0$53({1}SC:U),R,0,0,[b]
S:Lplay_screen.screen_play_screen_update$deltaX$1_0$53({1}SC:U),R,0,0,[b]
S:Lplay_screen.screen_play_screen_update$loops$1_0$53({1}SC:U),R,0,0,[e]
S:Lplay_screen.screen_play_screen_update$scroll_state$1_0$53({1}SC:U),R,0,0,[a]
S:Lplay_screen.screen_play_screen_update$player_state$1_0$53({1}SC:U),B,1,-3
S:Lplay_screen.screen_play_screen_update$command$1_0$53({1}SC:U),R,0,0,[c]
...
S:Lplay_screen.screen_play_screen_update$sloc5$0_1$0({2}DG,SC:U),B,1,-2
