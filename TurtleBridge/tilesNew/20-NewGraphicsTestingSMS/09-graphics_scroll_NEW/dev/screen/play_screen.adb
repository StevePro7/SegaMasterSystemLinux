...
S:Lplay_screen.screen_play_screen_load$so$1_0$102({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$screen_play_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplay_screen.screen_play_screen_update$screen_type$1_0$103({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$so$1_0$104({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
S:Lplay_screen.screen_play_screen_update$input$1_0$104({1}SC:U),R,0,0,[a]
S:Lplay_screen.screen_play_screen_update$delta$1_0$104({1}SC:U),R,0,0,[e]
S:Lplay_screen.screen_play_screen_update$value$1_0$104({1}SC:U),R,0,0,[d]
S:Lplay_screen.screen_play_screen_update$newTile$1_0$104({1}:S),R,0,0,[]
...
T:Fplay_screen$tag_struct_scroll_object[({0}S:S$scroll$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$offset_right$0_0$0({2}SI:U),Z,0,0)({4}S:S$scroll_complete$0_0$0({2}SI:U),Z,0,0)({6}S:S$scroll_x$0_0$0({12}DA6d,SI:U),Z,0,0)({18}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({19}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
...
T:Fplay_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_draw_offset$0_0$0({1}SC:U),Z,0,0)]
