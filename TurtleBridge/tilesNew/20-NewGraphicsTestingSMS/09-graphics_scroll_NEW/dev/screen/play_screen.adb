...
S:Lplay_screen.screen_play_screen_load$so$1_0$105({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
...
S:Lplay_screen.screen_play_screen_update$so$1_0$107({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
S:Lplay_screen.screen_play_screen_update$input$1_0$107({1}SC:U),R,0,0,[a]
S:Lplay_screen.screen_play_screen_update$delta$1_0$107({1}SC:U),R,0,0,[e]
S:Lplay_screen.screen_play_screen_update$value$1_0$107({1}SC:U),R,0,0,[d]
S:Lplay_screen.screen_play_screen_update$newTile$1_0$107({1}:S),R,0,0,[]
