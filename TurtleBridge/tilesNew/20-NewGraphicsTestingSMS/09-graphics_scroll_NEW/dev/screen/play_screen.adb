...
S:Lplay_screen.screen_play_screen_update$screen_type$1_0$98({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$so$1_0$99({2}DG,STtag_struct_scroll_object:S),R,0,0,[c,b]
S:Lplay_screen.screen_play_screen_update$input$1_0$99({1}SC:U),R,0,0,[a]
S:Lplay_screen.screen_play_screen_update$delta$1_0$99({1}SC:U),R,0,0,[e]
S:Lplay_screen.screen_play_screen_update$value$1_0$99({1}SC:U),R,0,0,[d]
S:Lplay_screen.screen_play_screen_update$newTile$1_0$99({1}:S),R,0,0,[l]
F:Fplay_screen$drawScreen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplay_screen.drawScreen$idx$1_0$111({1}SC:U),R,0,0,[c]
