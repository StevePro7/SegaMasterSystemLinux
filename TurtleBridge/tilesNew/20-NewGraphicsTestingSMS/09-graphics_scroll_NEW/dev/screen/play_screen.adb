...
S:Lplay_screen.screen_play_screen_update$screen_type$1_0$106({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$input$1_0$107({1}SC:U),R,0,0,[a]
F:Fplay_screen$getDelta$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplay_screen.getDelta$input$1_0$109({1}SC:U),R,0,0,[a]
S:Lplay_screen.getDelta$delta$1_0$109({1}SC:U),R,0,0,[l]
...
S:Fplay_screen$foo$0_0$0({1}SC:U),E,0,0
