...
S:Lplay_screen.screen_play_screen_update$screen_type$1_0$49({2}DG,SC:U),B,1,4
S:Lplay_screen.screen_play_screen_update$fo$1_0$50({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$so$1_0$50({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$po$1_0$50({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$lo$1_0$50({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$go$1_0$50({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lplay_screen.screen_play_screen_update$input1$1_0$50({1}SC:U),B,1,-2
S:Lplay_screen.screen_play_screen_update$input2$1_0$50({1}SC:U),B,1,-1
S:Lplay_screen.screen_play_screen_update$deltaX$1_0$50({1}SC:U),R,0,0,[c]
S:Lplay_screen.screen_play_screen_update$loops$1_0$50({1}SC:U),R,0,0,[b]
S:Lplay_screen.screen_play_screen_update$scroll_state$1_0$50({1}SC:U),R,0,0,[a]
S:Lplay_screen.screen_play_screen_update$player_state$1_0$50({1}SC:U),B,1,-3
S:Lplay_screen.screen_play_screen_update$command$1_0$50({1}SC:U),B,1,-4
...
T:Fplay_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
