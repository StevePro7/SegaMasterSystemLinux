...
S:Lmain.main$input$1_0$142({1}SC:U),R,0,0,[a]
F:Fmain$start$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.start$open_screen_type$1_0$150({1}SC:U),R,0,0,[]
...
T:Fmain$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_draw_offset$0_0$0({1}SC:U),Z,0,0)]
...
S:Lmain.main$global_pause$1_0$142({1}:S),E,0,0
