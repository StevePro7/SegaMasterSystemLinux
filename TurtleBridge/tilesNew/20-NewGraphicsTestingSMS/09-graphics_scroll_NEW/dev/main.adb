...
S:Lmain.main$input$1_0$143({1}SC:U),R,0,0,[a]
F:Fmain$start$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmain.start$open_screen_type$1_0$151({1}SC:U),R,0,0,[]
...
S:Lmain.main$global_pause$1_0$143({1}:S),E,0,0
