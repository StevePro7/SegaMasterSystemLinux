...
S:Lcontroller.game_controller_setup_player$game_difficulty$1_0$23({1}SC:U),B,1,4
S:Lcontroller.game_controller_setup_player$game_world$1_0$23({1}SC:U),B,1,5
S:Lcontroller.game_controller_setup_player$game_point$1_0$23({1}SC:U),B,1,6
S:Lcontroller.game_controller_setup_player$po$1_0$24({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lcontroller.game_controller_setup_player$player_loadY$1_0$24({1}SC:U),R,0,0,[a]
...
T:Fcontroller$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
