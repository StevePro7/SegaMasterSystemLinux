...
S:Lscreen_manager.engine_screen_manager_update$tmpY2$2_0$121({2}SI:U),R,0,0,[l,h]
S:Lscreen_manager.engine_screen_manager_update$tmpY$2_0$121({1}SC:U),R,0,0,[h]
F:Fscreen_manager$draw_sprite$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_sprite$idx$1_0$122({1}SC:U),B,1,4
S:Lscreen_manager.draw_sprite$x$1_0$122({1}SC:U),B,1,5
S:Lscreen_manager.draw_sprite$y$1_0$122({1}SC:U),B,1,6
S:Lscreen_manager.draw_sprite$wide$1_0$123({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$high$1_0$123({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$num$1_0$123({1}SC:U),R,0,0,[a]
S:Lscreen_manager.draw_sprite$i$1_0$123({1}SC:U),R,0,0,[c]
S:Lscreen_manager.draw_sprite$j$1_0$123({1}SC:U),B,1,-1
