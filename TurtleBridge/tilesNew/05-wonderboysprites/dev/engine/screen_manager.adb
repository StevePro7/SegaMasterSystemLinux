...
S:Lscreen_manager.draw_sprite$num$1_0$106({1}SC:U),R,0,0,[l]
S:Lscreen_manager.draw_sprite$i$1_0$106({1}SC:U),R,0,0,[d]
S:Lscreen_manager.draw_sprite$j$1_0$106({1}SC:U),R,0,0,[e]
