...
S:Lscreen_manager.draw_sprite$idx$1_0$106({1}SC:U),B,1,4
S:Lscreen_manager.draw_sprite$x$1_0$106({1}SC:U),B,1,5
S:Lscreen_manager.draw_sprite$y$1_0$106({1}SC:U),B,1,6
S:Lscreen_manager.draw_sprite$num$1_0$107({1}SC:U),R,0,0,[l]
S:Lscreen_manager.draw_sprite$i$1_0$107({1}SC:U),R,0,0,[d]
S:Lscreen_manager.draw_sprite$j$1_0$107({1}SC:U),R,0,0,[e]
