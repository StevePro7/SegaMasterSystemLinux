...
S:Lstorage_manager.engine_storage_manager_write$so$1_0$84({2}DG,STtag_struct_storage_object:S),R,0,0,[]
F:G$engine_storage_manager_erase$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstorage_manager.engine_storage_manager_erase$so$1_0$85({2}DG,STtag_struct_storage_object:S),R,0,0,[]
