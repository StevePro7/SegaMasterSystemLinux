...
S:Lscreen_manager.draw_sprite$size$1_0$112({1}SC:U),B,1,5
S:Lscreen_manager.draw_sprite$x$1_0$112({1}SC:U),B,1,6
S:Lscreen_manager.draw_sprite$y$1_0$112({1}SC:U),B,1,7
S:Lscreen_manager.draw_sprite$wide$1_0$113({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$high$1_0$113({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$tile$1_0$113({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$num$1_0$113({1}SC:U),R,0,0,[a]
S:Lscreen_manager.draw_sprite$i$1_0$113({1}SC:U),R,0,0,[d]
S:Lscreen_manager.draw_sprite$j$1_0$113({1}SC:U),R,0,0,[e]
