...
S:Lscreen_manager.engine_screen_manager_init$jo$1_0$105({2}DG,STtag_struct_jump_object:S),R,0,0,[]
S:Lscreen_manager.engine_screen_manager_init$index$1_0$105({1}SC:U),R,0,0,[]
F:G$engine_screen_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.engine_screen_manager_update$jo$1_0$108({2}DG,STtag_struct_jump_object:S),R,0,0,[]
S:Lscreen_manager.engine_screen_manager_update$input$1_0$108({1}SC:U),R,0,0,[a]
S:Lscreen_manager.engine_screen_manager_update$tmpY2$2_0$127({2}SI:U),R,0,0,[l,h]
S:Lscreen_manager.engine_screen_manager_update$tmpY$2_0$127({1}SC:U),R,0,0,[h]
F:Fscreen_manager$draw_sprite$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_sprite$idx$1_0$128({1}SC:U),B,1,4
S:Lscreen_manager.draw_sprite$x$1_0$128({1}SC:U),B,1,5
S:Lscreen_manager.draw_sprite$y$1_0$128({1}SC:U),B,1,6
S:Lscreen_manager.draw_sprite$wide$1_0$129({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$high$1_0$129({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$num$1_0$129({1}SC:U),R,0,0,[a]
S:Lscreen_manager.draw_sprite$i$1_0$129({1}SC:U),R,0,0,[c]
S:Lscreen_manager.draw_sprite$j$1_0$129({1}SC:U),B,1,-1
...
S:Fscreen_manager$delta$0_0$0({2}SI:U),E,0,0
S:Fscreen_manager$posY$0_0$0({1}SC:U),E,0,0
S:Fscreen_manager$posY2$0_0$0({2}SI:U),E,0,0
S:Fscreen_manager$scrollX$0_0$0({1}SC:U),E,0,0
S:Fscreen_manager$scrollY$0_0$0({1}SC:U),E,0,0
S:Fscreen_manager$storage_available$0_0$0({1}SC:U),E,0,0
