...
S:Lsprite_manager.engine_tile_manager_seaX$equator$1$73({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_seaX$tiles$1$74({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_seaX$array$1$74({2}DG,SC:U),R,0,0,[c,b]
S:Lsprite_manager.engine_tile_manager_seaX$wide$1$74({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_seaX$high$1$74({1}SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_seaX$idx$1$74({1}SC:U),R,0,0,[l]
S:Lsprite_manager.engine_tile_manager_seaX$val$1$74({1}SC:U),B,1,-9
S:Lsprite_manager.engine_tile_manager_seaX$row$1$74({1}SC:U),R,0,0,[d]
S:Lsprite_manager.engine_tile_manager_seaX$col$1$74({1}SC:U),B,1,-7
S:Lsprite_manager.engine_tile_manager_seaX$mul$1$74({1}SC:U),B,1,-6
S:Lsprite_manager.engine_tile_manager_seaX$x$1$74({1}SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_seaX$y$1$74({1}SC:U),B,1,-8
...
S:Lsprite_manager.engine_tile_manager_draw_normX$type$1$81({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_normX$x$1$81({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_normX$y$1$81({1}SC:U),B,1,6
F:G$engine_tile_manager_draw_flipX$0$0({2}DF,SV:S),Z,0,8,0,0,0
S:Lsprite_manager.engine_tile_manager_draw_flipX$type$1$83({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_flipX$x$1$83({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_flipX$y$1$83({1}SC:U),B,1,6
S:Lsprite_manager.engine_tile_manager_draw_flipX$tiles$1$84({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_draw_flipX$array$1$84({2}DG,SC:U),B,1,-9
S:Lsprite_manager.engine_tile_manager_draw_flipX$wide$1$84({1}SC:U),B,1,-10
S:Lsprite_manager.engine_tile_manager_draw_flipX$high$1$84({1}SC:U),B,1,-3
S:Lsprite_manager.engine_tile_manager_draw_flipX$idx$1$84({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_draw_flipX$val$1$84({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_tile_manager_draw_flipX$row$1$84({1}SC:U),B,1,-6
S:Lsprite_manager.engine_tile_manager_draw_flipX$col$1$84({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_tile_manager_draw_flipX$spc$1$84({1}SC:U),B,1,-7
S:Lsprite_manager.engine_tile_manager_draw_flipX$tmp$1$84({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_tile_manager_draw_flipX$flip$1$84({2}SI:U),B,1,-5
...
S:Lsprite_manager.engine_tile_manager_draw_offsetX$type$1$89({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_offsetX$offset$1$89({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_offsetX$x$1$89({1}SC:U),B,1,6
S:Lsprite_manager.engine_tile_manager_draw_offsetX$y$1$89({1}SC:U),B,1,7
S:Lsprite_manager.engine_tile_manager_draw_offsetX$tiles$1$90({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$array$1$90({2}DG,SC:U),B,1,-7
S:Lsprite_manager.engine_tile_manager_draw_offsetX$wide$1$90({1}SC:U),B,1,-3
S:Lsprite_manager.engine_tile_manager_draw_offsetX$high$1$90({1}SC:U),B,1,-5
S:Lsprite_manager.engine_tile_manager_draw_offsetX$idx$1$90({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$val$1$90({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$row$1$90({1}SC:U),B,1,-8
S:Lsprite_manager.engine_tile_manager_draw_offsetX$col$1$90({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$spc$1$90({1}SC:U),B,1,-4
S:Lsprite_manager.engine_tile_manager_draw_offsetX$tmp$1$90({1}SC:U),B,1,-9
S:Lsprite_manager.engine_tile_manager_draw_offsetX$sloc0$1$0({1}SC:U),B,1,-1
S:Lsprite_manager.engine_tile_manager_draw_offsetX$sloc1$1$0({1}SC:U),B,1,-2
F:G$engine_tile_manager_draw_scrollX$0$0({2}DF,SV:S),Z,0,3,0,0,0
S:Lsprite_manager.engine_tile_manager_draw_scrollX$type$1$95({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_scrollX$x$1$95({2}SI:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_scrollX$y$1$95({1}SC:U),B,1,7
S:Lsprite_manager.engine_tile_manager_draw_scrollX$col$1$95({1}SC:U),B,1,8
S:Lsprite_manager.engine_tile_manager_draw_scrollX$tiles$1$96({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$array$1$96({2}DG,SC:U),R,0,0,[c,b]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$wide$1$96({1}SC:U),B,1,-3
S:Lsprite_manager.engine_tile_manager_draw_scrollX$high$1$96({1}SC:U),B,1,-4
S:Lsprite_manager.engine_tile_manager_draw_scrollX$idx$1$96({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$val$1$96({1}SC:U),R,0,0,[l]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$off$1$96({2}SI:U),R,0,0,[l,h]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$row$1$96({1}SC:U),B,1,-5
...
S:Lsprite_manager.engine_tile_manager_draw_turtleX$type$1$99({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_turtleX$offset$1$99({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_turtleX$x$1$99({2}SI:U),B,1,6
S:Lsprite_manager.engine_tile_manager_draw_turtleX$y$1$99({1}SC:U),B,1,8
F:G$engine_sprite_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_draw$x$1$101({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw$y$1$101({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$tile$1$101({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1$102({1}SC:U),R,0,0,[]
F:G$engine_sprite_manager_fish$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_fish$x$1$103({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_fish$y$1$103({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_fish$tile$1$104({2}SI:U),R,0,0,[]
