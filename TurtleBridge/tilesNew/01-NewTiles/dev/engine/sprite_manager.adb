...
S:Lsprite_manager.engine_tile_manager_seaX$equator$1$68({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_seaX$tiles$1$69({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_seaX$array$1$69({2}DG,SC:U),R,0,0,[c,b]
S:Lsprite_manager.engine_tile_manager_seaX$wide$1$69({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_seaX$high$1$69({1}SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_seaX$idx$1$69({1}SC:U),R,0,0,[l]
S:Lsprite_manager.engine_tile_manager_seaX$val$1$69({1}SC:U),B,1,-9
S:Lsprite_manager.engine_tile_manager_seaX$row$1$69({1}SC:U),R,0,0,[d]
S:Lsprite_manager.engine_tile_manager_seaX$col$1$69({1}SC:U),B,1,-6
S:Lsprite_manager.engine_tile_manager_seaX$mul$1$69({1}SC:U),B,1,-7
S:Lsprite_manager.engine_tile_manager_seaX$x$1$69({1}SC:U),R,0,0,[]
S:Lsprite_manager.engine_tile_manager_seaX$y$1$69({1}SC:U),B,1,-8
S:Lsprite_manager.engine_tile_manager_seaX$sloc0$1$0({1}SC:U),B,1,-1
S:Lsprite_manager.engine_tile_manager_seaX$sloc1$1$0({1}SC:U),B,1,-2
...
S:Lsprite_manager.engine_sprite_manager_draw$x$1$76({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw$y$1$76({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$tile$1$76({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1$77({1}SC:U),R,0,0,[]
F:G$engine_sprite_manager_fish$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_fish$x$1$78({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_fish$y$1$78({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_fish$tile$1$79({2}SI:U),R,0,0,[]
