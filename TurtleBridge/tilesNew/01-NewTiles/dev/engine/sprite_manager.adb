M:sprite_manager
F:Fsprite_manager$load_variables$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lsprite_manager.load_variables$type$1$94({1}SC:U),B,1,4
...
S:Lsprite_manager.engine_tile_manager_seaX$y$1$97({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_tile_manager_seaX$sloc0$1$0({2}SI:S),B,1,-2
F:G$engine_tile_manager_draw_normX$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_tile_manager_draw_normX$type$1$104({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_normX$x$1$104({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_normX$y$1$104({1}SC:U),B,1,6
F:G$engine_tile_manager_draw_flipX$0$0({2}DF,SV:S),Z,0,4,0,0,0
S:Lsprite_manager.engine_tile_manager_draw_flipX$type$1$106({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_flipX$x$1$106({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_flipX$y$1$106({1}SC:U),B,1,6
S:Lsprite_manager.engine_tile_manager_draw_flipX$idx$1$107({1}SC:U),R,0,0,[c]
...
S:Lsprite_manager.engine_tile_manager_draw_offsetX$x$1$112({1}SC:U),B,1,6
S:Lsprite_manager.engine_tile_manager_draw_offsetX$y$1$112({1}SC:U),B,1,7
S:Lsprite_manager.engine_tile_manager_draw_offsetX$idx$1$113({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$val$1$113({1}SC:U),R,0,0,[e]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$row$1$113({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$col$1$113({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_tile_manager_draw_offsetX$spc$1$113({1}SC:U),B,1,-4
S:Lsprite_manager.engine_tile_manager_draw_offsetX$tmp$1$113({1}SC:U),B,1,-3
...
F:G$engine_tile_manager_draw_scrollX$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_tile_manager_draw_scrollX$type$1$118({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_scrollX$x$1$118({2}SI:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_scrollX$y$1$118({1}SC:U),B,1,7
S:Lsprite_manager.engine_tile_manager_draw_scrollX$col$1$118({1}SC:U),B,1,8
S:Lsprite_manager.engine_tile_manager_draw_scrollX$idx$1$119({1}SC:U),R,0,0,[b]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$val$1$119({1}SC:U),R,0,0,[l]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$off$1$119({2}SI:U),R,0,0,[l,h]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$row$1$119({1}SC:U),R,0,0,[c]
S:Lsprite_manager.engine_tile_manager_draw_scrollX$sloc0$1$0({1}SC:U),B,1,-1
F:G$engine_tile_manager_draw_turtleX$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_tile_manager_draw_turtleX$type$1$122({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_turtleX$offset$1$122({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_turtleX$x$1$122({2}SI:U),B,1,6
S:Lsprite_manager.engine_tile_manager_draw_turtleX$y$1$122({1}SC:U),B,1,8
F:G$engine_tile_manager_draw_groundX$0$0({2}DF,SV:S),Z,0,3,0,0,0
S:Lsprite_manager.engine_tile_manager_draw_groundX$type$1$124({1}SC:U),B,1,4
S:Lsprite_manager.engine_tile_manager_draw_groundX$x$1$124({1}SC:U),B,1,5
S:Lsprite_manager.engine_tile_manager_draw_groundX$y$1$124({1}SC:U),B,1,6
S:Lsprite_manager.engine_tile_manager_draw_groundX$beg$1$124({1}SC:U),B,1,7
S:Lsprite_manager.engine_tile_manager_draw_groundX$end$1$124({1}SC:U),B,1,8
S:Lsprite_manager.engine_tile_manager_draw_groundX$idx$1$125({1}SC:U),R,0,0,[c]
...
S:Lsprite_manager.engine_sprite_manager_draw$y$1$130({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$tile$1$130({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1$131({1}SC:U),R,0,0,[]
F:G$engine_sprite_manager_fish$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_fish$x$1$132({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_fish$y$1$132({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_fish$tile$1$133({2}SI:U),R,0,0,[]
S:G$tiles$0$0({2}DG,SC:U),E,0,0
S:G$array$0$0({2}DG,SC:U),E,0,0
S:G$wide$0$0({1}SC:U),E,0,0
S:G$high$0$0({1}SC:U),E,0,0
...
S:Fsprite_manager$load_variables$0$0({2}DF,SV:S),C,0,0
