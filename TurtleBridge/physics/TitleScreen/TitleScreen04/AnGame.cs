...
namespace Test
{
	public class AnGame : Game
	{
		...
		int wide= 0;
		int high = 0;
		string[] names = new string[MAX_SPRITES] { "Font128x32","Title128x96" };
		private bool save;
		...
		protected override void LoadContent()
		{
			...
			high = sprites[0].Height + sprites[1].Height;
		...
		protected override void Draw(GameTime gameTime)
		{
			...
			spriteBatch.Draw(sprites[1], new Vector2(0, 32), Color.White);
