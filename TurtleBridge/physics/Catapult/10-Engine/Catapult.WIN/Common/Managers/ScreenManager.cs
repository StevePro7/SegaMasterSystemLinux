	...
	public class ScreenManager : IScreenManager
	{
		...
		private static Dictionary<ScreenType, IScreen> GetScreens()
		{
			return new Dictionary<ScreenType, IScreen>
			{
				...
				{ScreenType.Rolling, new RollingScreen()},
				{ScreenType.Firing, new FiringScreen()},
				{ScreenType.Crash, new CrashScreen()},
				{ScreenType.ProjectileFlying, new ProjectileFlyingScreen()},
				{ScreenType.ProjectileHit, new ProjectileHitScreen()},
				//{ScreenType.Quiz, new QuizScreen()},
				{ScreenType.Reset, new ResetScreen()},
