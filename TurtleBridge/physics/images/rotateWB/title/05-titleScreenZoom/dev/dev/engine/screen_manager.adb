...
S:Lscreen_manager.engine_screen_manager_update$x$1_0$89({1}SC:U),R,0,0,[c]
S:Lscreen_manager.engine_screen_manager_update$y$1_0$89({1}SC:U),R,0,0,[b]
F:Fscreen_manager$draw_sprite$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscreen_manager.draw_sprite$idx$1_0$96({1}SC:U),B,1,4
S:Lscreen_manager.draw_sprite$x$1_0$96({1}SC:U),B,1,5
S:Lscreen_manager.draw_sprite$y$1_0$96({1}SC:U),B,1,6
S:Lscreen_manager.draw_sprite$wide$1_0$97({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$high$1_0$97({1}SC:U),R,0,0,[]
S:Lscreen_manager.draw_sprite$num$1_0$97({1}SC:U),R,0,0,[a]
S:Lscreen_manager.draw_sprite$i$1_0$97({1}SC:U),R,0,0,[b]
S:Lscreen_manager.draw_sprite$j$1_0$97({1}SC:U),R,0,0,[c]
...
S:Fscreen_manager$posX$0_0$0({9}DA9d,SC:U),E,0,0
S:Fscreen_manager$posY$0_0$0({9}DA9d,SC:U),E,0,0
