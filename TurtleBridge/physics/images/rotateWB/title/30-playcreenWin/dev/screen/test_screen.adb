...
S:Ltest_screen.screen_test_screen_update$screen_type$1_0$94({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$input$1_0$95({1}SC:U),R,0,0,[a]
S:Ltest_screen.screen_test_screen_update$x$1_0$95({1}SC:U),R,0,0,[c]
S:Ltest_screen.screen_test_screen_update$y$1_0$95({1}SC:U),R,0,0,[b]
S:Ltest_screen.screen_test_screen_update$f$1_0$95({1}SC:U),R,0,0,[a]
S:Ltest_screen.screen_test_screen_update$sloc0$0_1$0({2}DG,SC:U),B,1,-2
F:Ftest_screen$draw_sprite$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.draw_sprite$idx$1_0$99({1}SC:U),B,1,4
S:Ltest_screen.draw_sprite$mode$1_0$99({1}SC:U),B,1,5
S:Ltest_screen.draw_sprite$x$1_0$99({1}SC:U),B,1,6
S:Ltest_screen.draw_sprite$y$1_0$99({1}SC:U),B,1,7
...
S:G$engine_sprite_manager_draw_tile$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_tile_manager_draw_title$0_0$0({2}DF,SV:S),C,0,0
S:G$engine_tile_manager_draw_block$0_0$0({2}DF,SV:S),C,0,0
