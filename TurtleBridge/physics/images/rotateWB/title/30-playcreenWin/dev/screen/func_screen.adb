...
S:Lfunc_screen.screen_func_screen_load$x$1_0$91({1}SC:U),R,0,0,[b]
S:Lfunc_screen.screen_func_screen_load$y$1_0$91({1}SC:U),R,0,0,[c]
F:G$screen_func_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.screen_func_screen_update$screen_type$1_0$96({2}DG,SC:U),B,1,4
S:Lfunc_screen.screen_func_screen_update$input$1_0$97({1}SC:U),R,0,0,[a]
S:Lfunc_screen.screen_func_screen_update$sloc0$0_1$0({2}DG,SC:U),B,1,-2
