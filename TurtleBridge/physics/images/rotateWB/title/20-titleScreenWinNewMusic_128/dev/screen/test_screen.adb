...
S:Ltest_screen.screen_test_screen_update$x$1_0$94({1}SC:U),B,1,-2
S:Ltest_screen.screen_test_screen_update$y$1_0$94({1}SC:U),B,1,-1
...
S:Ltest_screen.draw_sprite$idx$1_0$100({1}SC:U),B,1,4
S:Ltest_screen.draw_sprite$mode$1_0$100({1}SC:U),B,1,5
S:Ltest_screen.draw_sprite$x$1_0$100({1}SC:U),B,1,6
S:Ltest_screen.draw_sprite$y$1_0$100({1}SC:U),B,1,7
