...
S:Llevel_manager.engine_level_manager_update$planeB_column$1$17({2}SI:U),B,1,-4
S:Llevel_manager.engine_level_manager_update$sloc0$1$0({2}SI:U),B,1,-2
T:Flevel_manager$tag_struct_level_object[({0}S:S$planeA_index$0$0({1}SC:U),Z,0,0)({1}S:S$planeA_count$0$0({1}SC:U),Z,0,0)({2}S:S$planeA_type$0$0({1}SC:U),Z,0,0)({3}S:S$planeA_data$0$0({1}SC:U),Z,0,0)({4}S:S$planeB_index$0$0({1}SC:U),Z,0,0)({5}S:S$planeB_count$0$0({1}SC:U),Z,0,0)({6}S:S$planeB_type$0$0({1}SC:U),Z,0,0)({7}S:S$planeB_data$0$0({1}SC:U),Z,0,0)]
S:G$tile_object_data$0$0({0}DA0d,DG,SC:U),E,0,0
S:G$global_level_object$0$0({8}STtag_struct_level_object:S),E,0,0
