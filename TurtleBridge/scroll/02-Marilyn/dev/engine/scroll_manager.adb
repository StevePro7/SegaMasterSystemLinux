...
S:Lscroll_manager.engine_scroll_manager_down$so$1_0$72({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_down$blah$1_0$72({2}SI:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_down$y$1_0$72({2}SI:U),R,0,0,[]
T:Fscroll_manager$tag_struct_scroll_object[({0}S:S$scroll$0_0$0({2}SI:U),Z,0,0)({2}S:S$test$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollleft$0_0$0({1}SC:U),Z,0,0)({5}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({6}S:S$scrollRightDivided8$0_0$0({1}SC:U),Z,0,0)({7}S:S$column_X$0_0$0({1}SC:U),Z,0,0)({8}S:S$scroll_X$0_0$0({2}SI:U),Z,0,0)]
