...
T:Fmain$tag_struct_scroll_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$next_row$0_0$0({2}DG,SC:U),Z,0,0)({4}S:S$background_y$0_0$0({1}SC:U),Z,0,0)({5}S:S$scrollleft$0_0$0({1}SC:U),Z,0,0)({6}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({7}S:S$scrollRightDivided8$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_X$0_0$0({1}SC:U),Z,0,0)({9}S:S$scroll_X$0_0$0({2}SI:U),Z,0,0)]
