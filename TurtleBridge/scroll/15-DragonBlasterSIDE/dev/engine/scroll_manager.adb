...
S:Lscroll_manager.engine_scroll_manager_update$so$1_0$71({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_draw$0_0$0({2}DF,SV:S),Z,0,16,0,0,0
S:Lscroll_manager.engine_scroll_manager_draw$so$1_0$73({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$column_X$1_0$73({1}SC:U),B,1,-4
S:Lscroll_manager.engine_scroll_manager_draw$scroll_X$1_0$73({2}SI:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$y$1_0$73({1}SC:U),R,0,0,[b]
S:Lscroll_manager.engine_scroll_manager_draw$base_tile$1_0$73({2}SI:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$tile$1_0$73({2}SI:U),R,0,0,[l,h]
S:Lscroll_manager.engine_scroll_manager_draw$map_char$1_0$73({2}DG,SC:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$buffer$1_0$73({16}DA16d,SC:U),B,1,-20
S:Lscroll_manager.engine_scroll_manager_draw$sloc0$0_1$0({1}SC:U),B,1,-4
S:Lscroll_manager.engine_scroll_manager_draw$sloc1$0_1$0({2}DG,SC:U),B,1,-2
S:Lscroll_manager.engine_scroll_manager_draw$sloc2$0_1$0({1}SC:S),B,1,-3
F:G$engine_scroll_manager_getPosY$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_getPosY$col$1_0$78({2}SI:U),B,1,4
F:Fscroll_manager$decompress_map_row$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.decompress_map_row$buffer$1_0$80({2}DG,SC:U),B,1,4
S:Lscroll_manager.decompress_map_row$so$1_0$81({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.decompress_map_row$o$1_0$81({2}DG,SC:U),R,0,0,[c,b]
S:Lscroll_manager.decompress_map_row$d$1_0$81({2}DG,SC:U),R,0,0,[l,h]
S:Lscroll_manager.decompress_map_row$remaining$1_0$81({1}SC:U),R,0,0,[e]
S:Lscroll_manager.decompress_map_row$ch$1_0$81({1}SC:U),R,0,0,[d]
S:Lscroll_manager.decompress_map_row$repeat$1_0$81({1}SC:U),R,0,0,[]
S:Lscroll_manager.decompress_map_row$test$1_0$81({1}SC:U),R,0,0,[]
