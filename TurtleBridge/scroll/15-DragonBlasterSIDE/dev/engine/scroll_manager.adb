...
S:Lscroll_manager.engine_scroll_manager_init$level_data$1_0$69({2}DG,SC:U),B,1,4
S:Lscroll_manager.engine_scroll_manager_init$so$1_0$70({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_scroll_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$so$1_0$73({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_draw$0_0$0({2}DF,SV:S),Z,0,16,0,0,0
S:Lscroll_manager.engine_scroll_manager_draw$so$1_0$75({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$column_X$1_0$75({1}SC:U),R,0,0,[b]
S:Lscroll_manager.engine_scroll_manager_draw$scroll_X$1_0$75({2}SI:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$y$1_0$75({1}SC:U),R,0,0,[c]
S:Lscroll_manager.engine_scroll_manager_draw$base_tile$1_0$75({2}SI:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$tile$1_0$75({2}SI:U),R,0,0,[l,h]
S:Lscroll_manager.engine_scroll_manager_draw$map_char$1_0$75({2}DG,SC:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$buffer$1_0$75({16}DA16d,SC:U),B,1,-17
S:Lscroll_manager.engine_scroll_manager_draw$sloc0$0_1$0({1}SC:S),B,1,-1
F:G$engine_scroll_manager_getPosY$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_getPosY$col$1_0$80({2}SI:U),B,1,4
F:Fscroll_manager$decompress_map_row$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.decompress_map_row$buffer$1_0$82({2}DG,SC:U),B,1,4
S:Lscroll_manager.decompress_map_row$so$1_0$83({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.decompress_map_row$o$1_0$83({2}DG,SC:U),R,0,0,[c,b]
S:Lscroll_manager.decompress_map_row$d$1_0$83({2}DG,SC:U),R,0,0,[l,h]
S:Lscroll_manager.decompress_map_row$remaining$1_0$83({1}SC:U),R,0,0,[e]
S:Lscroll_manager.decompress_map_row$ch$1_0$83({1}SC:U),R,0,0,[d]
S:Lscroll_manager.decompress_map_row$repeat$1_0$83({1}SC:U),R,0,0,[]
S:Lscroll_manager.decompress_map_row$test$1_0$83({1}SC:U),R,0,0,[]
T:Fscroll_manager$tag_struct_scroll_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$next_row$0_0$0({2}DG,SC:U),Z,0,0)({4}S:S$scrollleft$0_0$0({1}SC:U),Z,0,0)({5}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({6}S:S$scrollRightDivided8$0_0$0({1}SC:U),Z,0,0)({7}S:S$column_X$0_0$0({1}SC:U),Z,0,0)({8}S:S$scroll_X$0_0$0({2}SI:U),Z,0,0)]
