...
S:Lscroll_manager.engine_scroll_manager_init$so$1_0$67({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_scroll_manager_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_update$so$1_0$70({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$engine_scroll_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_draw$so$1_0$72({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$column_X$1_0$72({1}SC:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$scroll_X$1_0$72({2}SI:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$y$1_0$72({1}SC:U),R,0,0,[b]
S:Lscroll_manager.engine_scroll_manager_draw$base_tile$1_0$72({2}SI:U),R,0,0,[]
S:Lscroll_manager.engine_scroll_manager_draw$tile$1_0$72({2}SI:U),R,0,0,[]
F:G$engine_scroll_manager_getPosY$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lscroll_manager.engine_scroll_manager_getPosY$col$1_0$75({2}SI:U),B,1,4
T:Fscroll_manager$tag_struct_scroll_object[({0}S:S$scrollleft$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollRightDivided8$0_0$0({1}SC:U),Z,0,0)({3}S:S$column_X$0_0$0({1}SC:U),Z,0,0)({4}S:S$scroll_X$0_0$0({2}SI:U),Z,0,0)]
