...
F:G$engine_map_manager_draw_map2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_map_manager_draw_map$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap_manager.engine_map_manager_draw_map$map_data$1_0$69({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.engine_map_manager_draw_map$lines_before_next$1_0$69({1}SC:U),R,0,0,[]
S:Lmap_manager.engine_map_manager_draw_map$scroll_y$1_0$69({1}SC:U),R,0,0,[]
F:Fmap_manager$draw_map_row2$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fmap_manager$draw_map_row$0_0$0({2}DF,SV:S),Z,0,16,0,0,0
S:Lmap_manager.draw_map_row$map_data$1_0$76({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.draw_map_row$i$1_0$76({1}SC:U),B,1,-4
S:Lmap_manager.draw_map_row$j$1_0$76({1}SC:U),B,1,-1
S:Lmap_manager.draw_map_row$y$1_0$76({1}SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$map_char$1_0$76({2}DG,SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$base_tile$1_0$76({2}SI:U),R,0,0,[e,d]
S:Lmap_manager.draw_map_row$tile$1_0$76({2}SI:U),R,0,0,[l,h]
S:Lmap_manager.draw_map_row$buffer$1_0$76({16}DA16d,SC:U),B,1,-23
...
S:Lmap_manager.decompress_map_row$buffer$1_0$84({2}DG,SC:U),B,1,4
S:Lmap_manager.decompress_map_row$map_data$1_0$85({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.decompress_map_row$o$1_0$85({2}DG,SC:U),R,0,0,[c,b]
S:Lmap_manager.decompress_map_row$d$1_0$85({2}DG,SC:U),R,0,0,[l,h]
S:Lmap_manager.decompress_map_row$remaining$1_0$85({1}SC:U),R,0,0,[e]
S:Lmap_manager.decompress_map_row$ch$1_0$85({1}SC:U),R,0,0,[d]
S:Lmap_manager.decompress_map_row$repeat$1_0$85({1}SC:U),R,0,0,[]
S:Lmap_manager.decompress_map_row$test$1_0$85({1}SC:U),R,0,0,[]
T:Fmap_manager$tag_struct_map_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$next_row$0_0$0({2}DG,SC:U),Z,0,0)({4}S:S$background_x$0_0$0({1}SC:U),Z,0,0)({5}S:S$background_y$0_0$0({1}SC:U),Z,0,0)({6}S:S$lines_before_next$0_0$0({1}SC:U),Z,0,0)({7}S:S$lines_before_side$0_0$0({1}SC:U),Z,0,0)({8}S:S$scroll_x$0_0$0({1}SC:U),Z,0,0)({9}S:S$scroll_y$0_0$0({1}SC:U),Z,0,0)]
