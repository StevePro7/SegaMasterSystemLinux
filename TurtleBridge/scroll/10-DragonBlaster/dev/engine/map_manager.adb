...
S:Lmap_manager.draw_map_row$map_data$1_0$72({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.draw_map_row$i$1_0$72({1}SC:U),B,1,-4
S:Lmap_manager.draw_map_row$j$1_0$72({1}SC:U),B,1,-1
S:Lmap_manager.draw_map_row$y$1_0$72({1}SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$map_char$1_0$72({2}DG,SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$base_tile$1_0$72({2}SI:U),R,0,0,[e,d]
S:Lmap_manager.draw_map_row$tile$1_0$72({2}SI:U),R,0,0,[l,h]
S:Lmap_manager.draw_map_row$buffer$1_0$72({16}DA16d,SC:U),B,1,-23
...
S:Lmap_manager.decompress_map_row$buffer$1_0$80({2}DG,SC:U),B,1,4
S:Lmap_manager.decompress_map_row$map_data$1_0$81({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.decompress_map_row$o$1_0$81({2}DG,SC:U),R,0,0,[c,b]
S:Lmap_manager.decompress_map_row$d$1_0$81({2}DG,SC:U),R,0,0,[l,h]
S:Lmap_manager.decompress_map_row$remaining$1_0$81({1}SC:U),R,0,0,[e]
S:Lmap_manager.decompress_map_row$ch$1_0$81({1}SC:U),R,0,0,[d]
S:Lmap_manager.decompress_map_row$repeat$1_0$81({1}SC:U),R,0,0,[]
