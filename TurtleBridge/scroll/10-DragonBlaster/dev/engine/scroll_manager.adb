...
S:Lscroll_manager.engine_scroll_manager_init$so$1_0$68({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
...
S:Lscroll_manager.engine_scroll_manager_getPosY$col$1_0$73({2}SI:U),B,1,4
F:Fscroll_manager$print$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lscroll_manager.print$so$1_0$75({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
...
T:Fscroll_manager$tag_struct_level_object[({0}S:S$byte$0_0$0({1}SC:U),Z,0,0)]
...
S:G$engine_level_manager_update$0_0$0({2}DF,SV:S),C,0,0
