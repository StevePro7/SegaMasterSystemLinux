...
S:Lsprite_manager.engine_sprite_manager_draw$x$1_0$64({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_draw$y$1_0$64({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_draw$tile$1_0$64({2}SI:U),B,1,6
S:Lsprite_manager.engine_sprite_manager_draw$size$1_0$65({1}SC:U),R,0,0,[]
F:G$engine_sprite_manager_fish$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_sprite_manager_fish$x$1_0$66({1}SC:U),B,1,4
S:Lsprite_manager.engine_sprite_manager_fish$y$1_0$66({1}SC:U),B,1,5
S:Lsprite_manager.engine_sprite_manager_fish$tile$1_0$67({2}SI:U),R,0,0,[]
