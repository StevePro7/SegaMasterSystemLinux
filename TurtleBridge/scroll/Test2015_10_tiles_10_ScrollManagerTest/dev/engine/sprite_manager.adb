M:sprite_manager
F:G$engine_content_manager_draw_tileX$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsprite_manager.engine_content_manager_draw_tileX$x$1$87({1}SC:U),B,1,4
S:Lsprite_manager.engine_content_manager_draw_tileX$y$1$87({1}SC:U),B,1,5
S:Lsprite_manager.engine_content_manager_draw_tileX$pnt$1$88({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_content_manager_draw_tileX$offset$1$88({1}SC:U),R,0,0,[]
...
S:Lsprite_manager.engine_tilemap_manager_draw_tile$x$1$89({1}SC:U),B,1,4
S:Lsprite_manager.engine_tilemap_manager_draw_tile$y$1$89({1}SC:U),B,1,5
S:Lsprite_manager.engine_tilemap_manager_draw_tile$pnt$1$90({2}DG,SC:U),R,0,0,[]
S:Lsprite_manager.engine_tilemap_manager_draw_tile$index$1$90({2}SI:U),R,0,0,[l,h]
S:Lsprite_manager.engine_tilemap_manager_draw_tile$base$1$90({1}SC:U),R,0,0,[]
