...
bmp2tile.exe raw/back_tiles.bmp -savetiles "back_tiles (tiles).psgcompr" -removedupes -planar -tileoffset 64 -savetilemap "back_tiles (tilemap).bin" -savepalette "back_tiles (palette).bin" -fullpalette -exit
