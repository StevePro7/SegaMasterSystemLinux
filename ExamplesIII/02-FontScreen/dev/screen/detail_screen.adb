...
S:Ldetail_screen.section03$index$1$12({1}SC:U),R,0,0,[b]
S:Ldetail_screen.section03$row$1$12({1}SC:U),R,0,0,[c]
F:Fdetail_screen$section02$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fdetail_screen$section01$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldetail_screen.section01$row$1$16({1}SC:U),R,0,0,[b]
