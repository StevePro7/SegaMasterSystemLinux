...
S:Lfont_manager.engine_font_manager_data$quotient$1$77({2}SI:U),B,1,-2
...
S:Lfont_manager.engine_font_manager_zero$idx$1$82({1}SC:U),B,1,-3
S:Lfont_manager.engine_font_manager_zero$tile$1$82({2}SI:U),R,0,0,[e,d]
S:Lfont_manager.engine_font_manager_zero$hold$1$82({4}DA4d,SC:U),B,1,-7
