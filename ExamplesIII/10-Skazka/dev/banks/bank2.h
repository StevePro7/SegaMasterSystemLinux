...
extern const unsigned char	font_tiles__tilemap__stmcompr[];
#define				font_tiles__tilemap__stmcompr_size 49
#define				font_tiles__tilemap__stmcompr_bank 2

extern const unsigned char	font_tiles__tiles__psgcompr[];
#define				font_tiles__tiles__psgcompr_size 3142
