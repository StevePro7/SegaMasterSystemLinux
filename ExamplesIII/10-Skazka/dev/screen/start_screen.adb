...
S:Lstart_screen.screen_start_screen_load$row$1$77({1}SC:U),R,0,0,[]
F:G$screen_start_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstart_screen.screen_start_screen_update$screen_type$1$78({2}DG,SC:U),B,1,4
S:Lstart_screen.screen_start_screen_update$ho$1$79({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lstart_screen.screen_start_screen_update$timer$1$79({1}SC:U),R,0,0,[l]
S:Lstart_screen.screen_start_screen_update$input1$1$79({1}SC:U),R,0,0,[b]
S:Lstart_screen.screen_start_screen_update$input2$1$79({1}SC:U),R,0,0,[l]
S:Lstart_screen.screen_start_screen_update$nextr$1$79({1}SC:U),R,0,0,[c]
