...
S:Lstart_screen.screen_start_screen_load$row$1$93({1}SC:U),R,0,0,[]
F:G$screen_start_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstart_screen.screen_start_screen_update$screen_type$1$94({2}DG,SC:U),B,1,4
S:Lstart_screen.screen_start_screen_update$ho$1$95({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lstart_screen.screen_start_screen_update$timer$1$95({1}SC:U),R,0,0,[l]
S:Lstart_screen.screen_start_screen_update$input1$1$95({1}SC:U),R,0,0,[b]
S:Lstart_screen.screen_start_screen_update$input2$1$95({1}SC:U),R,0,0,[l]
S:Lstart_screen.screen_start_screen_update$nextr$1$95({1}SC:U),R,0,0,[c]
...
T:Fstart_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)]
