...
S:Lstart_screen.screen_start_screen_load$row$1$90({1}SC:U),R,0,0,[c]
S:Lstart_screen.screen_start_screen_load$idx$1$90({1}SC:U),R,0,0,[b]
F:G$screen_start_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstart_screen.screen_start_screen_update$screen_type$1$93({2}DG,SC:U),B,1,4
