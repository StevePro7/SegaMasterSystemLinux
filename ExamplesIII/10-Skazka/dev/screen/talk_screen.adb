...
S:Ltalk_screen.screen_talk_screen_load$row$1$106({1}SC:U),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_load$val$1$106({1}SC:U),R,0,0,[b]
F:G$screen_talk_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltalk_screen.screen_talk_screen_update$screen_type$1$109({2}DG,SC:U),B,1,4
S:Ltalk_screen.screen_talk_screen_update$input1$1$110({1}SC:U),R,0,0,[c]
S:Ltalk_screen.screen_talk_screen_update$input2$1$110({1}SC:U),R,0,0,[b]
F:Ftalk_screen$display_msg$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Ltalk_screen.display_msg$val$1$112({1}SC:U),B,1,4
S:Ltalk_screen.display_msg$row$1$113({1}SC:U),R,0,0,[c]
S:Ltalk_screen.display_msg$idx$1$113({1}SC:U),R,0,0,[e]
S:Ltalk_screen.display_msg$beg$1$113({1}SC:U),B,1,-1
S:Ltalk_screen.display_msg$txt$1$113({1}SC:U),R,0,0,[l]
