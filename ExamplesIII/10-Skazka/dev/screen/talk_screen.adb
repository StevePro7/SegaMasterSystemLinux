...
S:Ltalk_screen.screen_talk_screen_load$row$1$98({1}SC:U),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_load$idx$1$98({1}SC:U),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_load$val$1$98({1}SC:U),R,0,0,[b]
S:Ltalk_screen.screen_talk_screen_load$beg$1$98({1}SC:U),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_load$txt$1$98({1}SC:U),R,0,0,[]
F:G$screen_talk_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltalk_screen.screen_talk_screen_update$screen_type$1$99({2}DG,SC:U),B,1,4
F:Ftalk_screen$print$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Ltalk_screen.print$val$1$101({1}SC:U),B,1,4
S:Ltalk_screen.print$row$1$102({1}SC:U),R,0,0,[c]
S:Ltalk_screen.print$idx$1$102({1}SC:U),R,0,0,[e]
S:Ltalk_screen.print$beg$1$102({1}SC:U),B,1,-1
S:Ltalk_screen.print$txt$1$102({1}SC:U),R,0,0,[l]
T:Ftalk_screen$tag_struct_player_object[({0}S:S$xp$0$0({1}SC:U),Z,0,0)({1}S:S$hp$0$0({1}SC:U),Z,0,0)({2}S:S$gold$0$0({2}SI:U),Z,0,0)({4}S:S$weapon$0$0({1}SC:U),Z,0,0)({5}S:S$armor$0$0({1}SC:U),Z,0,0)({6}S:S$life$0$0({1}SC:U),Z,0,0)({7}S:S$level$0$0({1}SC:U),Z,0,0)({8}S:S$max_hp$0$0({1}SC:U),Z,0,0)({9}S:S$max_xp$0$0({1}SC:U),Z,0,0)]
T:Ftalk_screen$tag_struct_aelect_object[({0}S:S$select_index$0$0({3}DA3d,SC:U),Z,0,0)({3}S:S$select_X$0$0({1}SC:U),Z,0,0)({4}S:S$select_Y$0$0({1}SC:U),Z,0,0)({5}S:S$select_min$0$0({1}SC:U),Z,0,0)({6}S:S$select_max$0$0({1}SC:U),Z,0,0)]
