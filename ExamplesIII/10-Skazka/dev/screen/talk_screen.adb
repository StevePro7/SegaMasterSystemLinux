...
S:Ltalk_screen.screen_talk_screen_load$row$1$126({1}SC:U),R,0,0,[]
F:G$screen_talk_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltalk_screen.screen_talk_screen_update$screen_type$1$127({2}DG,SC:U),B,1,4
S:Ltalk_screen.screen_talk_screen_update$ho$1$128({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_update$input1$1$128({1}SC:U),R,0,0,[l]
S:Ltalk_screen.screen_talk_screen_update$input2$1$128({1}SC:U),R,0,0,[l]
F:Ftalk_screen$display_msg$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Ltalk_screen.display_msg$row$1$135({1}SC:U),R,0,0,[b]
S:Ltalk_screen.display_msg$val$1$135({1}SC:U),B,1,-2
S:Ltalk_screen.display_msg$idx$1$135({1}SC:U),R,0,0,[c]
S:Ltalk_screen.display_msg$beg$1$135({1}SC:U),B,1,-1
S:Ltalk_screen.display_msg$txt$1$135({1}SC:U),R,0,0,[l]
