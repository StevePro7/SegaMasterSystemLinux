...
S:Ltalk_screen.screen_talk_screen_load$row$1$97({1}SC:U),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_load$idx$1$97({1}SC:U),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_load$val$1$97({1}SC:U),R,0,0,[b]
S:Ltalk_screen.screen_talk_screen_load$beg$1$97({1}SC:U),R,0,0,[]
S:Ltalk_screen.screen_talk_screen_load$txt$1$97({1}SC:U),R,0,0,[]
F:G$screen_talk_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltalk_screen.screen_talk_screen_update$screen_type$1$98({2}DG,SC:U),B,1,4
S:Ltalk_screen.screen_talk_screen_update$input1$1$99({1}SC:U),R,0,0,[c]
S:Ltalk_screen.screen_talk_screen_update$input2$1$99({1}SC:U),R,0,0,[b]
