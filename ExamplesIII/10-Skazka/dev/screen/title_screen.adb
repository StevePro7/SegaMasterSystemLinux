...
S:Ltitle_screen.screen_title_screen_load$row$1$77({1}SC:U),R,0,0,[]
F:G$screen_title_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltitle_screen.screen_title_screen_update$screen_type$1$78({2}DG,SC:U),B,1,4
S:Ltitle_screen.screen_title_screen_update$input$1$79({1}SC:U),R,0,0,[c]
S:Ltitle_screen.screen_title_screen_update$timer$1$79({1}SC:U),R,0,0,[b]
