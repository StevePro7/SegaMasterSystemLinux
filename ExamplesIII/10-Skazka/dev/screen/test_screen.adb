...
S:Ltest_screen.screen_test_screen_load$po$1$28({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_test_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.screen_test_screen_update$screen_type$1$29({2}DG,SC:U),B,1,4
F:Ftest_screen$player_to_boss$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Ltest_screen.player_to_boss$damage$1$31({1}SC:U),B,1,-1
S:Ltest_screen.player_to_boss$random$1$31({1}SC:U),R,0,0,[c]
F:Ftest_screen$player_to_enemy$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Ltest_screen.player_to_enemy$damage$1$34({1}SC:U),B,1,-1
S:Ltest_screen.player_to_enemy$random$1$34({1}SC:U),R,0,0,[c]
