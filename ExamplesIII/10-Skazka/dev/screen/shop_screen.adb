...
S:Lshop_screen.screen_shop_screen_load$po$1$81({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_shop_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lshop_screen.screen_shop_screen_update$screen_type$1$82({2}DG,SC:U),B,1,4
S:Lshop_screen.screen_shop_screen_update$input$1$83({1}SC:U),R,0,0,[l]
S:Lshop_screen.screen_shop_screen_update$value$1$83({1}SC:U),R,0,0,[e]
S:Lshop_screen.screen_shop_screen_update$selection$1$83({1}SC:U),R,0,0,[e]
F:Fshop_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lshop_screen.setup$row$1$87({1}SC:U),R,0,0,[c]
S:Lshop_screen.setup$idx$1$87({1}SC:U),R,0,0,[b]
