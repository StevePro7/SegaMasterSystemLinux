...
S:Lintro_screen.screen_intro_screen_load$row$1$98({1}SC:U),R,0,0,[]
F:G$screen_intro_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1$99({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$input$1$100({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$timer$1$100({1}SC:U),R,0,0,[b]
F:Fintro_screen$print_intro$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.print_intro$row$1$102({1}SC:U),R,0,0,[d]
S:Lintro_screen.print_intro$idx$1$102({1}SC:U),R,0,0,[e]
T:Fintro_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)({4}S:S$difficulty$0$0({1}SC:U),Z,0,0)]
T:Fintro_screen$tag_struct_timer_object[({0}S:S$timer_count$0$0({2}SI:U),Z,0,0)({2}S:S$timer_value$0$0({2}SI:U),Z,0,0)]
