...
S:Lintro_screen.screen_intro_screen_load$row$1$97({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_load$idx$1$97({1}SC:U),R,0,0,[b]
F:G$screen_intro_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1$100({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$input$1$101({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$timer$1$101({1}SC:U),R,0,0,[b]
