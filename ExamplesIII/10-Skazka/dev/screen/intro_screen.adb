...
S:Lintro_screen.screen_intro_screen_load$row$1$77({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_load$idx$1$77({1}SC:U),R,0,0,[b]
F:G$screen_intro_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1$80({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$input$1$81({1}SC:U),R,0,0,[c]
S:Lintro_screen.screen_intro_screen_update$timer$1$81({1}SC:U),R,0,0,[b]
