...
S:Ldetail_screen.screen_detail_screen_update$screen_type$1$9({2}DG,SC:U),B,1,4
F:Fdetail_screen$section05$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fdetail_screen$section04$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldetail_screen.section04$row$1$12({1}SC:U),R,0,0,[b]
S:Ldetail_screen.section04$col$1$12({1}SC:U),R,0,0,[b]
F:Fdetail_screen$section03$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldetail_screen.section03$index$1$17({1}SC:U),R,0,0,[b]
S:Ldetail_screen.section03$row$1$17({1}SC:U),R,0,0,[c]
F:Fdetail_screen$section02$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fdetail_screen$section01$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldetail_screen.section01$row$1$21({1}SC:U),R,0,0,[b]
