...
S:Lcomplete_screen.screen_complete_screen_load$row$1$79({1}SC:U),R,0,0,[c]
S:Lcomplete_screen.screen_complete_screen_load$idx$1$79({1}SC:U),R,0,0,[b]
F:G$screen_complete_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lcomplete_screen.screen_complete_screen_update$screen_type$1$82({2}DG,SC:U),B,1,4
