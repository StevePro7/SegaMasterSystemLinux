...
S:Lcomplete_screen.screen_complete_screen_load$row$1$76({1}SC:U),R,0,0,[]
F:G$screen_complete_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lcomplete_screen.screen_complete_screen_update$screen_type$1$77({2}DG,SC:U),B,1,4
S:Lcomplete_screen.screen_complete_screen_update$input1$1$78({1}SC:U),R,0,0,[c]
S:Lcomplete_screen.screen_complete_screen_update$input2$1$78({1}SC:U),R,0,0,[b]
F:Fcomplete_screen$beat_game$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lcomplete_screen.beat_game$row$1$80({1}SC:U),R,0,0,[c]
S:Lcomplete_screen.beat_game$idx$1$80({1}SC:U),R,0,0,[b]
T:Fcomplete_screen$tag_struct_game_object[({0}S:S$play_intro$0$0({1}:S),Z,0,0)]
