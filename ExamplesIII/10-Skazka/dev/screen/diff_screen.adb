...
S:Ldiff_screen.screen_diff_screen_load$row$1$81({1}SC:U),R,0,0,[]
F:G$screen_diff_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldiff_screen.screen_diff_screen_update$screen_type$1$82({2}DG,SC:U),B,1,4
S:Ldiff_screen.screen_diff_screen_update$ho$1$83({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_update$go$1$83({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_update$selection$1$83({1}SC:U),R,0,0,[l]
S:Ldiff_screen.screen_diff_screen_update$timer$1$83({1}SC:U),R,0,0,[l]
...
T:Fdiff_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)]
