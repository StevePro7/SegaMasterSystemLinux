...
S:Ldiff_screen.screen_diff_screen_load$row$1$78({1}SC:U),R,0,0,[]
F:G$screen_diff_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldiff_screen.screen_diff_screen_update$screen_type$1$79({2}DG,SC:U),B,1,4
S:Ldiff_screen.screen_diff_screen_update$go$1$80({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_update$selection$1$80({1}SC:U),R,0,0,[l]
