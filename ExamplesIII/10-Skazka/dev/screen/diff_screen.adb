...
S:Ldiff_screen.screen_diff_screen_load$row$1$82({1}SC:U),R,0,0,[]
F:G$screen_diff_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldiff_screen.screen_diff_screen_update$screen_type$1$83({2}DG,SC:U),B,1,4
S:Ldiff_screen.screen_diff_screen_update$ho$1$84({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_update$go$1$84({2}DG,STtag_struct_game_object:S),R,0,0,[c,b]
S:Ldiff_screen.screen_diff_screen_update$selection$1$84({1}SC:U),R,0,0,[l]
S:Ldiff_screen.screen_diff_screen_update$timer$1$84({1}SC:U),R,0,0,[l]
...
T:Fdiff_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)({4}S:S$difficulty$0$0({1}SC:U),Z,0,0)]
T:Fdiff_screen$tag_struct_timer_object[({0}S:S$timer_count$0$0({2}SI:U),Z,0,0)({2}S:S$timer_value$0$0({2}SI:U),Z,0,0)]
T:Fdiff_screen$tag_struct_aelect_object[({0}S:S$select_index$0$0({8}DA8d,SC:U),Z,0,0)({8}S:S$select_X$0$0({1}SC:U),Z,0,0)({9}S:S$select_Y$0$0({1}SC:U),Z,0,0)({10}S:S$select_min$0$0({1}SC:U),Z,0,0)({11}S:S$select_max$0$0({1}SC:U),Z,0,0)]
...
S:Fdiff_screen$event_stage$0$0({1}SC:U),E,0,0
S:Fdiff_screen$select_type$0$0({1}SC:U),E,0,0
