...
S:Lvictory_screen.screen_victory_screen_load$po$1$90({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lvictory_screen.screen_victory_screen_load$row$1$90({1}SC:U),R,0,0,[]
F:G$screen_victory_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lvictory_screen.screen_victory_screen_update$screen_type$1$91({2}DG,SC:U),B,1,4
S:Lvictory_screen.screen_victory_screen_update$input1$1$92({1}SC:U),R,0,0,[c]
S:Lvictory_screen.screen_victory_screen_update$input2$1$92({1}SC:U),R,0,0,[b]
F:Fvictory_screen$victory$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lvictory_screen.victory$row$1$94({1}SC:U),R,0,0,[c]
S:Lvictory_screen.victory$idx$1$94({1}SC:U),R,0,0,[b]
