M:victory_screen
F:G$screen_victory_screen_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$screen_victory_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lvictory_screen.screen_victory_screen_update$screen_type$1$7({2}DG,SC:U),B,1,4
