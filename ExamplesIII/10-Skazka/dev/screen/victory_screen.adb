...
S:Lvictory_screen.screen_victory_screen_load$po$1$78({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lvictory_screen.screen_victory_screen_load$row$1$78({1}SC:U),R,0,0,[]
F:G$screen_victory_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lvictory_screen.screen_victory_screen_update$screen_type$1$79({2}DG,SC:U),B,1,4
F:Fvictory_screen$victory$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lvictory_screen.victory$row$1$81({1}SC:U),R,0,0,[c]
S:Lvictory_screen.victory$idx$1$81({1}SC:U),R,0,0,[b]
T:Fvictory_screen$tag_struct_player_object[({0}S:S$xp$0$0({1}SC:U),Z,0,0)({1}S:S$hp$0$0({1}SC:U),Z,0,0)({2}S:S$gold$0$0({2}SI:U),Z,0,0)({4}S:S$weapon$0$0({1}SC:U),Z,0,0)({5}S:S$armor$0$0({1}SC:U),Z,0,0)({6}S:S$life$0$0({1}SC:U),Z,0,0)({7}S:S$level$0$0({1}SC:U),Z,0,0)({8}S:S$max_hp$0$0({1}SC:U),Z,0,0)({9}S:S$max_xp$0$0({1}SC:U),Z,0,0)({10}S:S$won$0$0({1}SC:U),Z,0,0)]
T:Fvictory_screen$tag_struct_aelect_object[({0}S:S$select_index$0$0({5}DA5d,SC:U),Z,0,0)({5}S:S$select_X$0$0({1}SC:U),Z,0,0)({6}S:S$select_Y$0$0({1}SC:U),Z,0,0)({7}S:S$select_min$0$0({1}SC:U),Z,0,0)({8}S:S$select_max$0$0({1}SC:U),Z,0,0)]
