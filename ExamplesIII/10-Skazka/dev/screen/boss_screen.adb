...
S:Lboss_screen.screen_boss_screen_load$row$1$121({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_load$idx$1$121({1}SC:U),R,0,0,[e]
F:G$screen_boss_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1$124({2}DG,SC:U),B,1,4
S:Lboss_screen.screen_boss_screen_update$ho$1$125({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$selection$1$125({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_update$random$1$125({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_update$input$1$125({1}SC:U),R,0,0,[l]
S:Lboss_screen.screen_boss_screen_update$idx$1$125({1}SC:U),R,0,0,[b]
S:Lboss_screen.screen_boss_screen_update$row$1$125({1}SC:U),R,0,0,[b]
F:Fboss_screen$boss_laugh$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_laugh$selection$1$143({1}SC:U),B,1,4
