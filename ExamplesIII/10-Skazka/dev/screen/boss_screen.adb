...
S:Lboss_screen.screen_boss_screen_load$row$1$126({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_load$idx$1$126({1}SC:U),R,0,0,[e]
F:G$screen_boss_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1$129({2}DG,SC:U),B,1,4
S:Lboss_screen.screen_boss_screen_update$po$1$130({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$ho$1$130({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$selection$1$130({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_update$random$1$130({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_update$input$1$130({1}SC:U),R,0,0,[l]
S:Lboss_screen.screen_boss_screen_update$idx$1$130({1}SC:U),R,0,0,[b]
S:Lboss_screen.screen_boss_screen_update$row$1$130({1}SC:U),R,0,0,[b]
F:Fboss_screen$boss_init$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_init$p_weapon$1$148({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_init$p_armor$1$148({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_init$po$1$149({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fboss_screen$boss_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_stats$p_weapon$1$150({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_stats$p_armor$1$150({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_stats$po$1$151({2}DG,STtag_struct_player_object:S),R,0,0,[l,h]
F:Fboss_screen$boss_laugh$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_laugh$selection$1$153({1}SC:U),B,1,4
