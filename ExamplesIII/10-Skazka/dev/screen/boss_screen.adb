...
S:Lboss_screen.screen_boss_screen_load$go$1$127({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_load$row$1$127({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_load$idx$1$127({1}SC:U),R,0,0,[e]
F:G$screen_boss_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1$131({2}DG,SC:U),B,1,4
S:Lboss_screen.screen_boss_screen_update$po$1$132({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$ho$1$132({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lboss_screen.screen_boss_screen_update$selection$1$132({1}SC:U),B,1,-1
S:Lboss_screen.screen_boss_screen_update$random$1$132({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_update$input$1$132({1}SC:U),R,0,0,[l]
S:Lboss_screen.screen_boss_screen_update$idx$1$132({1}SC:U),R,0,0,[b]
S:Lboss_screen.screen_boss_screen_update$row$1$132({1}SC:U),R,0,0,[b]
F:Fboss_screen$boss_init$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_init$p_weapon$1$150({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_init$p_armor$1$150({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_init$po$1$151({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fboss_screen$boss_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_stats$p_weapon$1$152({2}DG,SC:U),B,1,4
S:Lboss_screen.boss_stats$p_armor$1$152({2}DG,SC:U),B,1,6
S:Lboss_screen.boss_stats$po$1$153({2}DG,STtag_struct_player_object:S),R,0,0,[l,h]
F:Fboss_screen$boss_laugh$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_laugh$selection$1$155({1}SC:U),B,1,4
...
T:Fboss_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)({4}S:S$difficulty$0$0({1}SC:U),Z,0,0)]
...
T:Fboss_screen$tag_struct_aelect_object[({0}S:S$select_index$0$0({8}DA8d,SC:U),Z,0,0)({8}S:S$select_X$0$0({1}SC:U),Z,0,0)({9}S:S$select_Y$0$0({1}SC:U),Z,0,0)({10}S:S$select_min$0$0({1}SC:U),Z,0,0)({11}S:S$select_max$0$0({1}SC:U),Z,0,0)]
...
S:Fboss_screen$event_stage$0$0({1}SC:U),E,0,0
S:Fboss_screen$enemys_damage$0$0({1}SC:U),E,0,0
S:Fboss_screen$player_damage$0$0({1}SC:U),E,0,0
S:Fboss_screen$player_weapon$0$0({1}SC:U),E,0,0
S:Fboss_screen$player_armor$0$0({1}SC:U),E,0,0
S:Fboss_screen$first_time$0$0({1}:S),E,0,0
