...
S:Lboss_screen.screen_boss_screen_load$row$1$118({1}SC:U),R,0,0,[d]
S:Lboss_screen.screen_boss_screen_load$idx$1$118({1}SC:U),R,0,0,[e]
F:G$screen_boss_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1$121({2}DG,SC:U),B,1,4
S:Lboss_screen.screen_boss_screen_update$selection$1$122({1}SC:U),R,0,0,[b]
F:Fboss_screen$boss_laugh$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.boss_laugh$selection$1$131({1}SC:U),B,1,4
