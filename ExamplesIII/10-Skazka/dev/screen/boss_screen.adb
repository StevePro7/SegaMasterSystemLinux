...
S:Lboss_screen.screen_boss_screen_load$row$1$78({1}SC:U),R,0,0,[c]
S:Lboss_screen.screen_boss_screen_load$idx$1$78({1}SC:U),R,0,0,[b]
F:G$screen_boss_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lboss_screen.screen_boss_screen_update$screen_type$1$81({2}DG,SC:U),B,1,4
T:Fboss_screen$tag_struct_aelect_object[({0}S:S$select_index$0$0({5}DA5d,SC:U),Z,0,0)({5}S:S$select_X$0$0({1}SC:U),Z,0,0)({6}S:S$select_Y$0$0({1}SC:U),Z,0,0)({7}S:S$select_min$0$0({1}SC:U),Z,0,0)({8}S:S$select_max$0$0({1}SC:U),Z,0,0)]
