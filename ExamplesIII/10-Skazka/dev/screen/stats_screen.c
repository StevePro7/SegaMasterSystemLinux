...
static void print_player()
{
	engine_text_manager_args( LEFT_X + 2, 12, 8, 0x20, 0x20, 0x20, 0x20, 0x20, 0x8A, 0x81, 0x8C );
	engine_text_manager_args( LEFT_X + 2, 13, 8, 0x20, 0x20, 0x20, 0x20, 0x20, 0x80, 0x20, 0x80 );
	engine_text_manager_args( LEFT_X + 2, 14, 8, 0x20, 0x20, 0x20, 0x8E, 0x20, 0x8B, 0x83, 0x8D );
	engine_text_manager_args( LEFT_X + 2, 15, 11, 0x20, 0x20, 0x20, 0x80, 0x20, 0x86, 0x82, 0x88, 0x8A, 0x81, 0x8C );
	engine_text_manager_args( LEFT_X + 2, 16, 11, 0x20, 0x20, 0x20, 0xF8, 0x81, 0x84, 0x20, 0x85, 0x84, 0x20, 0x80 );
	engine_text_manager_args( LEFT_X + 2, 17, 11, 0x20, 0x20, 0x20, 0x20, 0x20, 0x87, 0x83, 0x89, 0x8B, 0x81, 0x8D );

	engine_text_manager_args( LEFT_X + 2, 18, 8, 0x20, 0x20, 0x20, 0x20, 0x20, 0x93, 0x20, 0x94 );
	engine_text_manager_args( LEFT_X + 2, 19, 9, 0x20, 0x20, 0x20, 0x20, 0x93, 0x20, 0x20, 0x20, 0x94 );
}