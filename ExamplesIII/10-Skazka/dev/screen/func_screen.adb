...
S:Lfunc_screen.screen_func_screen_load$index$1$86({1}SC:U),R,0,0,[b]
F:G$screen_func_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.screen_func_screen_update$screen_type$1$89({2}DG,SC:U),B,1,4
F:Ffunc_screen$player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.player$po$1$91({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Ffunc_screen$enemy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfunc_screen.enemy$index$1$92({1}SC:U),B,1,4
S:Lfunc_screen.enemy$eo$1$93({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
