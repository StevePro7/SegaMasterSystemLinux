...
S:Lload_screen.screen_load_screen_update$screen_type$1$18({2}DG,SC:U),B,1,4
S:Lload_screen.screen_load_screen_update$go$1$19({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$flash_arrow$1$19({1}:S),R,0,0,[c]
