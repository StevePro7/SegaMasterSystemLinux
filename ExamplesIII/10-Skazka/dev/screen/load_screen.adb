...
S:Lload_screen.screen_load_screen_update$screen_type$1$17({2}DG,SC:U),B,1,4
S:Lload_screen.screen_load_screen_update$go$1$18({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$flash_arrow$1$18({1}:S),R,0,0,[c]
...
T:Fload_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)]
