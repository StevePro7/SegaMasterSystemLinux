...
S:Lforest_screen.screen_forest_screen_load$po$1$119({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lforest_screen.setup$row$1$138({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$138({1}SC:U),R,0,0,[b]
