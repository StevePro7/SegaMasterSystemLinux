...
S:Lforest_screen.screen_forest_screen_load$po$1$103({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_forest_screen_update$0$0({2}DF,SV:S),Z,0,2,0,0,0
...
S:Lforest_screen.screen_forest_screen_update$e_damage$1$105({1}SC:U),B,1,-1
S:Lforest_screen.screen_forest_screen_update$p_damage$1$105({1}SC:U),B,1,-2
F:Fforest_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.setup$row$1$117({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$117({1}SC:U),R,0,0,[b]
