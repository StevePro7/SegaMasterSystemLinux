...
S:Lforest_screen.screen_forest_screen_update$value$1$125({1}SC:U),R,0,0,[]
...
S:Lforest_screen.setup$row$1$143({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$143({1}SC:U),R,0,0,[b]
