...
S:Lforest_screen.screen_forest_screen_load$po$1$121({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_forest_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1$122({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$ho$1$123({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$random$1$123({1}SC:U),R,0,0,[b]
S:Lforest_screen.screen_forest_screen_update$input$1$123({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$value$1$123({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$xp$1$123({1}SC:U),B,1,-3
S:Lforest_screen.screen_forest_screen_update$sloc0$1$0({2}DG,SC:U),B,1,-2
F:Fforest_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.setup$row$1$140({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$140({1}SC:U),R,0,0,[b]
...
T:Fforest_screen$tag_struct_aelect_object[({0}S:S$select_index$0$0({7}DA7d,SC:U),Z,0,0)({7}S:S$select_X$0$0({1}SC:U),Z,0,0)({8}S:S$select_Y$0$0({1}SC:U),Z,0,0)({9}S:S$select_min$0$0({1}SC:U),Z,0,0)({10}S:S$select_max$0$0({1}SC:U),Z,0,0)]
