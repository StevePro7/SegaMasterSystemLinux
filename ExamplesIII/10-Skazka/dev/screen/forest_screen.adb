...
S:Lforest_screen.screen_forest_screen_load$po$1$101({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_forest_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1$102({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$input$1$103({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$value$1$103({1}SC:U),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$selection$1$103({1}SC:U),B,1,-1
F:Fforest_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.setup$row$1$116({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$116({1}SC:U),R,0,0,[b]
...
T:Fforest_screen$tag_struct_enemy_object[({0}S:S$index$0$0({1}SC:U),Z,0,0)({1}S:S$hplo$0$0({1}SC:U),Z,0,0)({2}S:S$ax$0$0({1}SC:U),Z,0,0)({3}S:S$gldo$0$0({1}SC:U),Z,0,0)({4}S:S$xpo$0$0({1}SC:U),Z,0,0)({5}S:S$damage$0$0({1}SC:U),Z,0,0)]
...
S:Fforest_screen$prev_event_stage$0$0({1}SC:U),E,0,0
...
S:G$engine_fight_manager_fight$0$0({2}DF,SV:S),C,0,0
S:G$engine_fight_manager_draw$0$0({2}DF,SV:S),C,0,0
...
S:G$engine_player_manager_hp$0$0({2}DF,SV:S),C,0,0
