...
S:Lforest_screen.screen_forest_screen_load$po$1$124({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_load$go$1$124({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_forest_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1$125({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$po$1$126({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$ho$1$126({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$go$1$126({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$random$1$126({1}SC:U),R,0,0,[b]
S:Lforest_screen.screen_forest_screen_update$input$1$126({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$value$1$126({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$xp$1$126({1}SC:U),B,1,-3
S:Lforest_screen.screen_forest_screen_update$add_armor$1$126({1}:S),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$sloc0$1$0({2}DG,SC:U),B,1,-2
F:Fforest_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.setup$row$1$147({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$147({1}SC:U),R,0,0,[b]
F:Fforest_screen$calc_add_armor$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lforest_screen.calc_add_armor$go$1$152({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$eo$1$152({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$po$1$152({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.calc_add_armor$add_armor$1$152({1}:S),R,0,0,[c]
T:Fforest_screen$tag_struct_player_object[({0}S:S$xp$0$0({1}SC:U),Z,0,0)({1}S:S$hp$0$0({1}SC:U),Z,0,0)({2}S:S$gold$0$0({2}SI:U),Z,0,0)({4}S:S$weapon$0$0({1}SC:U),Z,0,0)({5}S:S$armor$0$0({1}SC:U),Z,0,0)({6}S:S$life$0$0({1}SC:U),Z,0,0)({7}S:S$level$0$0({1}SC:U),Z,0,0)({8}S:S$max_hp$0$0({1}SC:U),Z,0,0)({9}S:S$max_xp$0$0({1}SC:U),Z,0,0)({10}S:S$won$0$0({1}SC:U),Z,0,0)({11}S:S$def_xp$0$0({1}SC:U),Z,0,0)({12}S:S$def_hp$0$0({1}SC:U),Z,0,0)({13}S:S$def_gold$0$0({2}SI:U),Z,0,0)({15}S:S$def_weapon$0$0({1}SC:U),Z,0,0)({16}S:S$def_armor$0$0({1}SC:U),Z,0,0)({17}S:S$def_life$0$0({1}SC:U),Z,0,0)]
