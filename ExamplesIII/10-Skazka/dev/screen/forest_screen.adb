...
S:Lforest_screen.screen_forest_screen_load$po$1$78({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_load$row$1$78({1}SC:U),R,0,0,[c]
S:Lforest_screen.screen_forest_screen_load$idx$1$78({1}SC:U),R,0,0,[b]
F:G$screen_forest_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1$83({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$selection$1$84({1}SC:U),R,0,0,[c]
