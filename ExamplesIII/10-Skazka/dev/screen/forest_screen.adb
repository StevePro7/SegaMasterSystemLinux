...
S:Lforest_screen.screen_forest_screen_load$po$1$80({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_load$row$1$80({1}SC:U),R,0,0,[c]
S:Lforest_screen.screen_forest_screen_load$idx$1$80({1}SC:U),R,0,0,[b]
F:G$screen_forest_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1$85({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$input$1$86({1}SC:U),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$selection$1$86({1}SC:U),R,0,0,[l]
...
T:Fforest_screen$tag_struct_aelect_object[({0}S:S$select_index$0$0({4}DA4d,SC:U),Z,0,0)({4}S:S$select_X$0$0({1}SC:U),Z,0,0)({5}S:S$select_Y$0$0({1}SC:U),Z,0,0)({6}S:S$select_min$0$0({1}SC:U),Z,0,0)({7}S:S$select_max$0$0({1}SC:U),Z,0,0)]
