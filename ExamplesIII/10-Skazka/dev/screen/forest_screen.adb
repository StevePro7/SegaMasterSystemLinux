...
S:Lforest_screen.screen_forest_screen_load$po$1$123({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$screen_forest_screen_update$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lforest_screen.screen_forest_screen_update$screen_type$1$124({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$po$1$125({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$ho$1$125({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lforest_screen.screen_forest_screen_update$random$1$125({1}SC:U),R,0,0,[b]
S:Lforest_screen.screen_forest_screen_update$input$1$125({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$value$1$125({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$xp$1$125({1}SC:U),B,1,-3
S:Lforest_screen.screen_forest_screen_update$sloc0$1$0({2}DG,SC:U),B,1,-2
F:Fforest_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.setup$row$1$142({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$142({1}SC:U),R,0,0,[b]
