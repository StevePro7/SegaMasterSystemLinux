...
S:Lforest_screen.screen_forest_screen_update$screen_type$1$81({2}DG,SC:U),B,1,4
S:Lforest_screen.screen_forest_screen_update$input$1$82({1}SC:U),R,0,0,[l]
S:Lforest_screen.screen_forest_screen_update$selection$1$82({1}SC:U),R,0,0,[l]
F:Fforest_screen$setup$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lforest_screen.setup$row$1$87({1}SC:U),R,0,0,[c]
S:Lforest_screen.setup$idx$1$87({1}SC:U),R,0,0,[b]
