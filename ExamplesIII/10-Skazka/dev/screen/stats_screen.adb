...
S:Lstats_screen.screen_stats_screen_load$row$1$85({1}SC:U),R,0,0,[c]
S:Lstats_screen.screen_stats_screen_load$idx$1$85({1}SC:U),R,0,0,[b]
...
S:Lstats_screen.print_village$row$1$93({1}SC:U),R,0,0,[]
F:Fstats_screen$print_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstats_screen.print_player$row$1$94({1}SC:U),R,0,0,[]
