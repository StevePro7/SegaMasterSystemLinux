...
S:Lstats_screen.screen_stats_screen_load$row$1$75({1}SC:U),R,0,0,[c]
S:Lstats_screen.screen_stats_screen_load$idx$1$75({1}SC:U),R,0,0,[b]
F:G$screen_stats_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstats_screen.screen_stats_screen_update$screen_type$1$78({2}DG,SC:U),B,1,4
F:Fstats_screen$print_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:Fstats_screen$print_village$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstats_screen.print_village$row$1$81({1}SC:U),R,0,0,[]
F:Fstats_screen$print_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstats_screen.print_player$row$1$82({1}SC:U),R,0,0,[]
