...
S:Lover_screen.game_over$row$1$88({1}SC:U),R,0,0,[c]
S:Lover_screen.game_over$idx$1$88({1}SC:U),R,0,0,[b]
T:Fover_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)({4}S:S$difficulty$0$0({1}SC:U),Z,0,0)]
