...
S:Lover_screen.screen_over_screen_load$row$1$79({1}SC:U),R,0,0,[]
F:G$screen_over_screen_update$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1$80({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$input1$1$81({1}SC:U),B,1,-1
S:Lover_screen.screen_over_screen_update$input2$1$81({1}SC:U),B,1,-2
S:Lover_screen.screen_over_screen_update$timer$1$81({1}SC:U),R,0,0,[c]
S:Lover_screen.screen_over_screen_update$index$1$81({1}SC:U),R,0,0,[b]
F:Fover_screen$game_over$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.game_over$row$1$87({1}SC:U),R,0,0,[c]
S:Lover_screen.game_over$idx$1$87({1}SC:U),R,0,0,[b]
T:Fover_screen$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)]
T:Fover_screen$tag_struct_timer_object[({0}S:S$timer_count$0$0({2}SI:U),Z,0,0)({2}S:S$timer_value$0$0({2}SI:U),Z,0,0)]
...
S:Fover_screen$first_time$0$0({1}:S),E,0,0
