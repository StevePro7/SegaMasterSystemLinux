...
S:Lover_screen.screen_over_screen_load$row$1$78({1}SC:U),R,0,0,[]
F:G$screen_over_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1$79({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$input1$1$80({1}SC:U),R,0,0,[b]
S:Lover_screen.screen_over_screen_update$input2$1$80({1}SC:U),R,0,0,[c]
S:Lover_screen.screen_over_screen_update$index$1$80({1}SC:U),R,0,0,[b]
