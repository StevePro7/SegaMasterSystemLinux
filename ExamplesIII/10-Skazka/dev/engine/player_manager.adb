...
S:Lplayer_manager.engine_player_manager_init$po$1$73({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_calc$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_calc$po$1$74({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_stats$po$1$79({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_rest$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_rest$po$1$81({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_hplo$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_hplo$po$1$83({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_gold$gold$1$84({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_gold$po$1$85({2}DG,STtag_struct_player_object:S),R,0,0,[]
