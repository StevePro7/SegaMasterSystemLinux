...
S:Lplayer_manager.engine_player_manager_init$po$1$84({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_load$po$1$85({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
F:G$engine_player_manager_calc$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_calc$po$1$86({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_stats$po$1$91({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_rest$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_rest$po$1$93({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_hplo$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_hplo$po$1$95({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dec_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dec_gold$gold$1$96({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_dec_gold$po$1$97({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_inc_gold$xp$1$100({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_inc_gold$gold$1$100({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_inc_gold$po$1$101({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
F:G$engine_player_manager_hit$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_hit$hp$1$104({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_hit$po$1$105({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dead$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dead$po$1$108({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_life$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_life$po$1$109({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_boss$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_boss$po$1$110({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_def_currxp$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_def_currxp$currxp$1$112({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_def_currxp$po$1$113({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_def_currhp$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_def_currhp$currhp$1$114({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_def_currhp$po$1$115({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_def_goldno$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_def_goldno$goldno$1$116({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_def_goldno$po$1$117({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_def_weapon$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_def_weapon$weapon$1$118({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_def_weapon$po$1$119({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_def_armors$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_def_armors$armors$1$120({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_def_armors$po$1$121({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_def_oneups$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_def_oneups$oneups$1$122({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_def_oneups$po$1$123({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_set_weapon$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_set_weapon$weapon$1$124({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_weapon$po$1$125({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_set_armors$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_set_armors$armors$1$126({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_armors$po$1$127({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_set_oneups$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_set_oneups$oneups$1$128({2}SI:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_oneups$po$1$129({2}DG,STtag_struct_player_object:S),R,0,0,[]
