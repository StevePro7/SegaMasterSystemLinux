...
S:Lplayer_manager.engine_player_manager_init$po$1$72({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_calc$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_calc$po$1$73({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_stats$po$1$78({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_hplo$po$1$82({2}DG,STtag_struct_player_object:S),R,0,0,[]
