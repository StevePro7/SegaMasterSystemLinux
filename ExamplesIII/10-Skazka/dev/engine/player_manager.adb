...
S:Lplayer_manager.engine_player_manager_init$po$1$74({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_calc$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_calc$po$1$75({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_stats$po$1$80({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_rest$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_rest$po$1$82({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_hplo$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_hplo$po$1$84({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_gold$gold$1$85({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_gold$po$1$86({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_hp$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_hp$hp$1$89({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_hp$po$1$90({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dead$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dead$po$1$92({2}DG,STtag_struct_player_object:S),R,0,0,[]
T:Fplayer_manager$tag_struct_player_object[({0}S:S$xp$0$0({1}SC:U),Z,0,0)({1}S:S$hp$0$0({1}SC:U),Z,0,0)({2}S:S$gold$0$0({2}SI:U),Z,0,0)({4}S:S$weapon$0$0({1}SC:U),Z,0,0)({5}S:S$armor$0$0({1}SC:U),Z,0,0)({6}S:S$life$0$0({1}SC:U),Z,0,0)({7}S:S$level$0$0({1}SC:U),Z,0,0)({8}S:S$max_hp$0$0({1}SC:U),Z,0,0)({9}S:S$max_xp$0$0({1}SC:U),Z,0,0)]
