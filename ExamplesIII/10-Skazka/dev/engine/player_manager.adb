...
S:Lplayer_manager.engine_player_manager_load$po$1$75({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_calc$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_calc$po$1$76({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_stats$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_stats$po$1$81({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_rest$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_rest$po$1$83({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_hplo$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_hplo$po$1$85({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dec_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dec_gold$gold$1$86({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_dec_gold$po$1$87({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_inc_gold$xp$1$90({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_inc_gold$gold$1$90({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_inc_gold$po$1$91({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
F:G$engine_player_manager_hit$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_hit$hp$1$94({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_hit$po$1$95({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dead$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dead$po$1$98({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_boss$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_boss$po$1$99({2}DG,STtag_struct_player_object:S),R,0,0,[]
