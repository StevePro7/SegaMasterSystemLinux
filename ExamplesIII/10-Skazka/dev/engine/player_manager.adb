...
S:Lplayer_manager.engine_player_manager_hit$hp$1$89({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_hit$po$1$90({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dead$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dead$po$1$91({2}DG,STtag_struct_player_object:S),R,0,0,[]
