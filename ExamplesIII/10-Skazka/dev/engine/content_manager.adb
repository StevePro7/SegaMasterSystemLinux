...
S:Lcontent_manager.engine_content_manager_load_title$go$1$69({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lcontent_manager.engine_content_manager_load_title$blue_screen$1$69({1}:S),R,0,0,[]
