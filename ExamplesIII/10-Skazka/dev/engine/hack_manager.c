...
void engine_hack_manager_load()
{
	...
	ho->hack_armors = PEEK( HACKER_START + 3 );			// 0x0054		// Set value to 1 or 2 for armor else 0.
	ho->hack_oneups = PEEK( HACKER_START + 4 );			// 0x0055		// Set value to 1=Life otherwise 0=None.
	ho->hack_musics = PEEK( HACKER_START + 5 );			// 0x0056		// Set 0=Music to play otherwise silent.
	ho->hack_sounds = PEEK( HACKER_START + 6 );			// 0x0057		// Set 0=Sound to play otherwise silent.
