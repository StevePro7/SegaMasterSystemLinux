...
S:Laudio_manager.engine_sound_manager_fight$value$1$109({1}SC:U),R,0,0,[]
F:G$engine_music_manager_play$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Laudio_manager.engine_music_manager_play$index$1$115({1}SC:U),B,1,4
S:Laudio_manager.engine_music_manager_play$ho$1$116({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Laudio_manager.engine_music_manager_play$data$1$116({2}DG,SC:U),R,0,0,[c,b]
S:Laudio_manager.engine_music_manager_play$bank$1$116({1}SC:U),R,0,0,[e]
