...
S:Laudio_manager.engine_sound_manager_play$index$1$86({1}SC:U),B,1,4
S:Laudio_manager.engine_sound_manager_play$ho$1$87({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Laudio_manager.engine_sound_manager_play$data$1$87({2}DG,SC:U),B,1,-2
S:Laudio_manager.engine_sound_manager_play$bank$1$87({1}SC:U),R,0,0,[c]
