...
S:Lsound_manager.engine_sound_manager_play$index$1$86({1}SC:U),B,1,4
...
S:Lsound_manager.engine_sound_manager_play$bank$1$87({1}SC:U),R,0,0,[d]
...
S:G$effect_sample_data$0$0({0}DA0d,DG,SC:U),E,0,0
