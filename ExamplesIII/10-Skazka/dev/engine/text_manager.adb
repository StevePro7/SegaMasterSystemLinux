...
S:Ltext_manager.engine_text_manager_args$num$1$86({1}SC:U),B,1,6
S:Ltext_manager.engine_text_manager_args$ch$1$87({1}SC:U),R,0,0,[e]
S:Ltext_manager.engine_text_manager_args$idx$1$87({1}SC:U),R,0,0,[b]
S:Ltext_manager.engine_text_manager_args$arglist$1$87({2}DG,SC:U),B,1,-2
T:Ftext_manager$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)({4}S:S$difficulty$0$0({1}SC:U),Z,0,0)]
