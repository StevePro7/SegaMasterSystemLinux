...
S:Ltext_manager.engine_text_manager_clear$start$1$72({1}SC:U),B,1,4
S:Ltext_manager.engine_text_manager_clear$stop$1$72({1}SC:U),B,1,5
S:Ltext_manager.engine_text_manager_clear$row$1$73({1}SC:U),R,0,0,[]
F:G$engine_text_manager_border$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltext_manager.engine_text_manager_border$row$1$76({1}SC:U),R,0,0,[b]
S:Ltext_manager.engine_text_manager_border$col$1$76({1}SC:U),R,0,0,[b]
F:G$engine_text_manager_args$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Ltext_manager.engine_text_manager_args$x$1$81({1}SC:U),B,1,4
S:Ltext_manager.engine_text_manager_args$y$1$81({1}SC:U),B,1,5
S:Ltext_manager.engine_text_manager_args$num$1$81({1}SC:U),B,1,6
S:Ltext_manager.engine_text_manager_args$ch$1$82({1}SC:U),R,0,0,[e]
S:Ltext_manager.engine_text_manager_args$idx$1$82({1}SC:U),R,0,0,[b]
S:Ltext_manager.engine_text_manager_args$arglist$1$82({2}DG,SC:U),B,1,-2
F:G$engine_text_manager_list$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltext_manager.engine_text_manager_list$x$1$87({1}SC:U),B,1,4
S:Ltext_manager.engine_text_manager_list$y$1$87({1}SC:U),B,1,5
S:Ltext_manager.engine_text_manager_list$num$1$87({1}SC:U),B,1,6
S:Ltext_manager.engine_text_manager_list$arr$1$87({2}DG,SC:U),B,1,7
S:Ltext_manager.engine_text_manager_list$ch$1$88({1}SC:U),R,0,0,[e]
S:Ltext_manager.engine_text_manager_list$idx$1$88({1}SC:U),R,0,0,[b]
