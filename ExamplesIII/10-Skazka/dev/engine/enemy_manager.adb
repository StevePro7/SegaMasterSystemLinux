...
S:Lenemy_manager.engine_enemy_manager_init$eo$1$29({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_load$level$1$30({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_load$eo$1$31({2}DG,STtag_struct_enemy_object:S),R,0,0,[c,b]
S:Lenemy_manager.engine_enemy_manager_load$value$1$31({1}SC:U),R,0,0,[l]
S:Lenemy_manager.engine_enemy_manager_load$index$1$31({1}SC:U),R,0,0,[e]
