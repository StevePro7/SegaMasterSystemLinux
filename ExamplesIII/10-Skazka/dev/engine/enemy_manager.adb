...
F:G$engine_boss_manager_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_enemy_manager_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_load$level$1$33({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_load$value$1$34({1}SC:U),R,0,0,[l]
S:Lenemy_manager.engine_enemy_manager_load$index$1$34({1}SC:U),R,0,0,[b]
F:Fenemy_manager$enemy_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.enemy_load$index$1$45({1}SC:U),B,1,4
S:Lenemy_manager.enemy_load$eo$1$46({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_draw$eo$1$47({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_hplo$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_hplo$eo$1$48({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_hit$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_hit$hp$1$49({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_hit$eo$1$50({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_dead$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_dead$eo$1$53({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
