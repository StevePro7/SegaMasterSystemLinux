...
S:Lenemy_manager.engine_enemy_manager_init$eo$1$30({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_load$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_load$level$1$31({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_load$eo$1$32({2}DG,STtag_struct_enemy_object:S),R,0,0,[c,b]
S:Lenemy_manager.engine_enemy_manager_load$value$1$32({1}SC:U),R,0,0,[l]
S:Lenemy_manager.engine_enemy_manager_load$index$1$32({1}SC:U),R,0,0,[e]
F:G$engine_enemy_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_draw$eo$1$43({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_hplo$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_hplo$eo$1$44({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_hit$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_hit$hp$1$45({1}SC:U),B,1,4
S:Lenemy_manager.engine_enemy_manager_hit$eo$1$46({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_enemy_manager_dead$0$0({2}DF,:S),Z,0,0,0,0,0
S:Lenemy_manager.engine_enemy_manager_dead$eo$1$49({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
...
S:G$xpo_num$0$0({5}DA5d,SC:U),E,0,0
