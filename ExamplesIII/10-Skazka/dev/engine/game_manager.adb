...
S:Lgame_manager.engine_game_manager_print_village$row$1$92({1}SC:U),R,0,0,[]
F:G$engine_game_manager_print_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_print_player$row$1$93({1}SC:U),R,0,0,[]
...
S:Lgame_manager.engine_game_manager_print_texts$row$1$95({1}SC:U),R,0,0,[c]
S:Lgame_manager.engine_game_manager_print_texts$idx$1$95({1}SC:U),R,0,0,[b]
...
T:Fgame_manager$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)]
