...
F:G$engine_game_manager_black$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_black$go$1$86({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_blue$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_blue$go$1$87({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_intro_on$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_intro_on$go$1$88({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_intro_off$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_intro_off$go$1$89({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_music_on$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_music_on$go$1$90({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_music_off$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_music_off$go$1$91({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_flash_on$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_flash_on$go$1$92({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_flash_off$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_flash_off$go$1$93({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$engine_game_manager_difficulty$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_difficulty$difficulty$1$94({1}SC:U),B,1,4
S:Lgame_manager.engine_game_manager_difficulty$go$1$95({2}DG,STtag_struct_game_object:S),R,0,0,[]
...
S:Lgame_manager.engine_game_manager_print_village$row$1$97({1}SC:U),R,0,0,[]
F:G$engine_game_manager_print_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_print_player$row$1$98({1}SC:U),R,0,0,[]
F:G$engine_game_manager_print_version$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_game_manager_print_texts$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgame_manager.engine_game_manager_print_texts$row$1$100({1}SC:U),R,0,0,[c]
S:Lgame_manager.engine_game_manager_print_texts$idx$1$100({1}SC:U),R,0,0,[b]
...
T:Fgame_manager$tag_struct_game_object[({0}S:S$blue_screen$0$0({1}:S),Z,0,0)({1}S:S$intro_once$0$0({1}:S),Z,0,0)({2}S:S$play_music$0$0({1}:S),Z,0,0)({3}S:S$flash_arrow$0$0({1}:S),Z,0,0)({4}S:S$difficulty$0$0({1}SC:U),Z,0,0)]
