...
S:Lfight_manager.engine_fight_manager_battle$e_damage$1$32({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_battle$p_damage$1$32({2}DG,SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_battle$po$1$33({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Lfight_manager.engine_fight_manager_battle$eo$1$33({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_battle$enemys$1$33({1}SC:U),R,0,0,[]
S:Lfight_manager.engine_fight_manager_battle$player$1$33({1}SC:U),R,0,0,[l]
...
S:Lfight_manager.engine_fight_manager_gold$p_xp$1$44({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_gold$p_gold$1$44({2}DG,SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_gold$po$1$45({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_gold$eo$1$45({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_boss_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_boss_manager_draw$x$1$46({1}SC:U),B,1,4
S:Lfight_manager.engine_boss_manager_draw$y$1$46({1}SC:U),B,1,5
