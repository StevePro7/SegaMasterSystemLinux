...
S:Lfight_manager.engine_fight_manager_player_to_enemy$e_damage$1$43({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_player_to_enemy$po$1$44({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_player_to_enemy$eo$1$44({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_player_to_enemy$damage$1$44({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_player_to_enemy$extra$1$44({1}SC:U),R,0,0,[b]
F:G$engine_fight_manager_enemy_to_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_enemy_to_player$p_damage$1$48({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_enemy_to_player$po$1$49({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$eo$1$49({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$ho$1$49({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$damage$1$49({1}SC:U),R,0,0,[c]
...
S:Lfight_manager.engine_fight_manager_boss_to_player$p_damage$1$51({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_boss_to_player$po$1$52({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$eo$1$52({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$ho$1$52({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$damage$1$52({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_boss_to_player$extra$1$52({1}SC:U),R,0,0,[]
...
S:Lfight_manager.get_damage$damage$1$54({1}SC:U),R,0,0,[]
S:Lfight_manager.get_damage$random$1$54({1}SC:U),R,0,0,[]
F:G$engine_fight_manager_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_gold$p_xp$1$60({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_gold$p_gold$1$60({2}DG,SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_gold$po$1$61({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_gold$eo$1$61({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_boss_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_boss_manager_draw$x$1$62({1}SC:U),B,1,4
S:Lfight_manager.engine_boss_manager_draw$y$1$62({1}SC:U),B,1,5
