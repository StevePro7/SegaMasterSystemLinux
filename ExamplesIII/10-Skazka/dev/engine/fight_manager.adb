...
S:Lfight_manager.engine_fight_manager_player_to_enemy$e_damage$1$47({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_player_to_enemy$random$1$47({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_player_to_enemy$po$1$48({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_player_to_enemy$damage$1$48({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_player_to_enemy$extra$1$48({1}SC:U),R,0,0,[b]
F:G$engine_fight_manager_enemy_to_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_enemy_to_player$p_damage$1$52({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_enemy_to_player$random$1$52({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_enemy_to_player$eo$1$53({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$ho$1$53({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$damage$1$53({1}SC:U),R,0,0,[b]
S:Lfight_manager.engine_fight_manager_enemy_to_player$extra$1$53({1}SC:U),R,0,0,[c]
F:G$engine_fight_manager_player_to_boss$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_player_to_boss$b_damage$1$56({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_player_to_boss$random$1$56({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_player_to_boss$weapon$1$56({1}SC:U),B,1,7
S:Lfight_manager.engine_fight_manager_player_to_boss$po$1$57({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_player_to_boss$damage$1$57({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_player_to_boss$extra$1$57({1}SC:U),R,0,0,[c]
F:G$engine_fight_manager_boss_to_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_boss_to_player$p_damage$1$59({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_boss_to_player$random$1$59({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_boss_to_player$eo$1$60({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$ho$1$60({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$damage$1$60({1}SC:U),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$extra$1$60({1}SC:U),R,0,0,[c]
F:Ffight_manager$get_damage$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lfight_manager.get_damage$random$1$63({1}SC:U),B,1,4
S:Lfight_manager.get_damage$damage$1$64({1}SC:U),R,0,0,[c]
F:G$engine_fight_manager_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_gold$p_xp$1$70({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_gold$p_gold$1$70({2}DG,SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_gold$po$1$71({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_gold$eo$1$71({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_boss_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_boss_manager_draw$x$1$72({1}SC:U),B,1,4
S:Lfight_manager.engine_boss_manager_draw$y$1$72({1}SC:U),B,1,5
