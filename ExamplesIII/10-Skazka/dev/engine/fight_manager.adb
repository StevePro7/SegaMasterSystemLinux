M:fight_manager
F:G$engine_fight_manager_battle$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lfight_manager.engine_fight_manager_battle$po$1$25({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_battle$eo$1$25({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_battle$enemys$1$25({1}SC:U),R,0,0,[]
S:Lfight_manager.engine_fight_manager_battle$e_damage$1$25({1}SC:U),B,1,-3
S:Lfight_manager.engine_fight_manager_battle$player$1$25({1}SC:U),R,0,0,[]
S:Lfight_manager.engine_fight_manager_battle$p_damage$1$25({1}SC:U),B,1,-4
...
T:Ffight_manager$tag_struct_player_object[({0}S:S$xp$0$0({1}SC:U),Z,0,0)({1}S:S$hp$0$0({1}SC:U),Z,0,0)({2}S:S$gold$0$0({2}SI:U),Z,0,0)({4}S:S$weapon$0$0({1}SC:U),Z,0,0)({5}S:S$armor$0$0({1}SC:U),Z,0,0)({6}S:S$life$0$0({1}SC:U),Z,0,0)({7}S:S$level$0$0({1}SC:U),Z,0,0)({8}S:S$max_hp$0$0({1}SC:U),Z,0,0)({9}S:S$max_xp$0$0({1}SC:U),Z,0,0)]
