...
S:Lfight_manager.engine_fight_manager_player_to_enemy$e_damage$1$45({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_player_to_enemy$random$1$45({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_player_to_enemy$po$1$46({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_player_to_enemy$damage$1$46({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_player_to_enemy$extra$1$46({1}SC:U),R,0,0,[b]
F:G$engine_fight_manager_player_to_boss$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_player_to_boss$b_damage$1$50({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_player_to_boss$random$1$50({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_player_to_boss$po$1$51({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_player_to_boss$damage$1$51({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_player_to_boss$extra$1$51({1}SC:U),R,0,0,[c]
F:G$engine_fight_manager_enemy_to_player$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_enemy_to_player$p_damage$1$53({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_enemy_to_player$po$1$54({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$eo$1$54({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$ho$1$54({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$damage$1$54({1}SC:U),R,0,0,[c]
...
S:Lfight_manager.engine_fight_manager_boss_to_player$p_damage$1$56({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_boss_to_player$po$1$57({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$eo$1$57({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$ho$1$57({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$damage$1$57({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_boss_to_player$extra$1$57({1}SC:U),R,0,0,[]
...
S:Lfight_manager.get_damage$random$1$59({1}SC:U),B,1,4
S:Lfight_manager.get_damage$damage$1$60({1}SC:U),R,0,0,[c]
F:G$engine_fight_manager_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_gold$p_xp$1$66({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_gold$p_gold$1$66({2}DG,SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_gold$po$1$67({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_gold$eo$1$67({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_boss_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_boss_manager_draw$x$1$68({1}SC:U),B,1,4
S:Lfight_manager.engine_boss_manager_draw$y$1$68({1}SC:U),B,1,5
