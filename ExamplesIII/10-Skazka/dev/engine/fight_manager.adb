...
S:Lfight_manager.engine_fight_manager_enemy_to_player$po$1$55({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lfight_manager.engine_fight_manager_boss_to_player$po$1$59({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lfight_manager.engine_fight_manager_boss_to_player$damage$1$59({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_boss_to_player$extra$1$59({1}SC:U),R,0,0,[]
S:Lfight_manager.engine_fight_manager_boss_to_player$sloc0$1$0({2}DG,SC:U),B,1,-2
F:Ffight_manager$get_damage$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lfight_manager.get_damage$random$1$61({1}SC:U),B,1,4
S:Lfight_manager.get_damage$damage$1$62({1}SC:U),R,0,0,[c]
F:G$engine_fight_manager_gold$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_gold$p_xp$1$68({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_gold$p_gold$1$68({2}DG,SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_gold$po$1$69({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_gold$eo$1$69({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
F:G$engine_boss_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_boss_manager_draw$x$1$70({1}SC:U),B,1,4
S:Lfight_manager.engine_boss_manager_draw$y$1$70({1}SC:U),B,1,5
