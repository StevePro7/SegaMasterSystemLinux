M:fight_manager
F:G$engine_fight_manager_fight$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_fight$po$1$24({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_fight$eo$1$24({2}DG,STtag_struct_enemy_object:S),R,0,0,[c,b]
S:Lfight_manager.engine_fight_manager_fight$enemys$1$24({1}SC:U),R,0,0,[l]
S:Lfight_manager.engine_fight_manager_fight$player$1$24({1}SC:U),R,0,0,[l]
S:Lfight_manager.engine_fight_manager_fight$sloc0$1$0({2}SI:S),B,1,-2
F:G$engine_fight_manager_draw$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
T:Ffight_manager$tag_struct_enemy_object[({0}S:S$index$0$0({1}SC:U),Z,0,0)({1}S:S$hplo$0$0({1}SC:U),Z,0,0)({2}S:S$ax$0$0({1}SC:U),Z,0,0)({3}S:S$gldo$0$0({1}SC:U),Z,0,0)({4}S:S$xpo$0$0({1}SC:U),Z,0,0)({5}S:S$damage$0$0({1}SC:U),Z,0,0)]
