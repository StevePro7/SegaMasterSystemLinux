...
S:Lfight_manager.engine_fight_manager_battle$e_damage$1$26({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_battle$p_damage$1$26({2}DG,SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_battle$po$1$27({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_battle$eo$1$27({2}DG,STtag_struct_enemy_object:S),R,0,0,[c,b]
S:Lfight_manager.engine_fight_manager_battle$enemys$1$27({1}SC:U),R,0,0,[l]
S:Lfight_manager.engine_fight_manager_battle$player$1$27({1}SC:U),R,0,0,[l]
