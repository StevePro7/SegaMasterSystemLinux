...
S:Lfight_manager.engine_fight_manager_enemy_to_player$p_damage$1$51({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_enemy_to_player$random$1$51({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_enemy_to_player$eo$1$52({2}DG,STtag_struct_enemy_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$ho$1$52({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_enemy_to_player$damage$1$52({1}SC:U),R,0,0,[b]
S:Lfight_manager.engine_fight_manager_enemy_to_player$extra$1$52({1}SC:U),R,0,0,[c]
F:G$engine_fight_manager_player_to_boss$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lfight_manager.engine_fight_manager_player_to_boss$b_damage$1$55({2}DG,SC:U),B,1,4
S:Lfight_manager.engine_fight_manager_player_to_boss$random$1$55({1}SC:U),B,1,6
S:Lfight_manager.engine_fight_manager_player_to_boss$po$1$56({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lfight_manager.engine_fight_manager_player_to_boss$damage$1$56({1}SC:U),R,0,0,[c]
S:Lfight_manager.engine_fight_manager_player_to_boss$extra$1$56({1}SC:U),R,0,0,[c]
