...
T:Fmain$tag_struct_hack_object[({0}S:S$hack_steps$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_hands$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_paths$0_0$0({1}SC:U),Z,0,0)]
S:G$global_hack_object$0_0$0({6}STtag_struct_hack_object:S),E,0,0
S:Lmain.main$global_pause$1_0$113({1}:S),E,0,0
