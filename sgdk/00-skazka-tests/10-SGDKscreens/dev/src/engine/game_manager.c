...
void engine_game_manager_print_stats()
{
	...
	engine_font_manager_text( LOCALE_GOLD, LEFT_X + 2, TOP_Y + 9 );
}
...
//	devkit_SMS_mapROMBank( FIXED_BANK );
	...
	engine_font_manager_punc( LOCALE_COLON, LEFT_X + 19, TOP_Y + 14 );
	engine_font_manager_punc( LOCALE_QMARK, LEFT_X + 29, TOP_Y + 14 );
}
