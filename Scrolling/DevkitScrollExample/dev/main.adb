M:main
F:G$loadAssets$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$lineIRQhandler$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$scrollBG$0_0$0({2}DF,SV:S),C,0,-9,0,0,0
S:Lmain.scrollBG$which$1_0$99({1}SC:U),B,1,4
S:Lmain.scrollBG$dir$1_0$99({1}:S),B,1,5
S:Lmain.scrollBG$y$1_0$100({1}SC:U),B,1,-1
S:Lmain.scrollBG$p$1_0$100({2}DG,SI:U),R,0,0,[]
S:Lmain.scrollBG$sloc0$0_1$0({2}DG,SI:U),B,1,-3
S:Lmain.scrollBG$sloc1$0_1$0({1}SC:U),B,1,-1
S:Lmain.scrollBG$sloc2$0_1$0({2}SI:S),B,1,-7
S:Lmain.scrollBG$sloc3$0_1$0({2}SI:S),B,1,-5
S:Lmain.scrollBG$sloc4$0_1$0({1}SC:U),B,1,-1
S:Lmain.scrollBG$sloc5$0_1$0({2}DG,SI:U),B,1,-3
S:Lmain.scrollBG$sloc6$0_1$0({1}SC:U),B,1,-1
S:Lmain.scrollBG$sloc7$0_1$0({2}SI:S),B,1,-7
S:Lmain.scrollBG$sloc8$0_1$0({2}SI:S),B,1,-5
S:Lmain.scrollBG$sloc9$0_1$0({1}SC:U),B,1,-1
F:G$prepare$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lmain.prepare$i$1_0$116({1}SC:U),R,0,0,[c]
S:Lmain.prepare$y$1_0$116({1}SC:U),R,0,0,[b]
S:Lmain.prepare$p$1_0$116({2}DG,SI:U),R,0,0,[]
F:G$main$0_0$0({2}DF,SV:S),C,0,-1,0,0,0
S:Lmain.main$sloc0$0_1$0({2}DD,SC:U),B,1,-3
S:Lmain.main$sloc1$0_1$0({1}SC:S),B,1,-1
S:Lmain.main$sloc2$0_1$0({1}:S),B,1,-1
S:G$scroll$0_0$0({2}DA2d,SC:U),E,0,0
S:G$scroll_dir$0_0$0({2}DA2d,:S),E,0,0
...
S:G$loadAssets$0_0$0({2}DF,SV:S),C,0,0
S:G$lineIRQhandler$0_0$0({2}DF,SV:S),C,0,0
S:G$scrollBG$0_0$0({2}DF,SV:S),C,0,-9
S:G$prepare$0_0$0({2}DF,SV:S),C,0,0
