...
// Check what size hardware sprite the metasprite is using (from sprite.h)
    ...
    while (1)
    {
        ...
        {
            idx++;
            if (idx >= (sizeof(sprite_metasprites) >> 1))
                idx = 0;
            jitter = 10;
        }
        ...
        if (hide)
            ...
            case 0:
                ...
                break;
            case 1:
                hiwater = move_metasprite_hflip(sprite_metasprites[idx], TILE_NUM_START, SPR_NUM_START, (PosX >> 4), (PosY >> 4));
                break;
            case 2:
                hiwater = move_metasprite_hvflip(sprite_metasprites[idx], TILE_NUM_START, SPR_NUM_START, (PosX >> 4), (PosY >> 4));
                break;
            case 3:
                hiwater = move_metasprite_vflip(sprite_metasprites[idx], TILE_NUM_START, SPR_NUM_START, (PosX >> 4), (PosY >> 4));
                break;
            };
