...
::%GBDK_WIN%/bin/lcc -Wa-l -Wl-m -Wl-j -o sound.gb sound.c
%GBDK_WIN%/bin/lcc -Wa-l -Wl-m -Wl-j -c -o sound.o sound.c
%GBDK_WIN%/bin/lcc -Wa-l -Wl-m -Wl-j -o output.gb sound.o
