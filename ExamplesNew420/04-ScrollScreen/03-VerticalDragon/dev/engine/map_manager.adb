...
S:Lmap_manager.engine_map_manager_init$level_data$1_0$0({2}DG,SC:U),R,0,0,[e,d]
S:Lmap_manager.engine_map_manager_init$map_data$1_0$121({2}DG,STtag_struct_map_object:S),R,0,0,[]
F:G$engine_map_manager_draw_map_screen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap_manager.engine_map_manager_draw_map_screen$map_data$1_0$122({2}DG,STtag_struct_map_object:S),R,0,0,[]
F:G$engine_map_manager_draw_map$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap_manager.engine_map_manager_draw_map$map_data$1_0$124({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.engine_map_manager_draw_map$lines_before_next$1_0$124({1}SC:U),R,0,0,[]
S:Lmap_manager.engine_map_manager_draw_map$scroll_y$1_0$124({1}SC:U),R,0,0,[]
F:Fmap_manager$draw_map_row$0_0$0({2}DF,SV:S),Z,0,16,0,0,0
S:Lmap_manager.draw_map_row$map_data$1_0$129({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.draw_map_row$i$1_0$129({1}SC:U),B,1,-4
S:Lmap_manager.draw_map_row$j$1_0$129({1}SC:U),B,1,-1
S:Lmap_manager.draw_map_row$y$1_0$129({1}SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$map_char$1_0$129({2}DG,SC:U),R,0,0,[]
S:Lmap_manager.draw_map_row$base_tile$1_0$129({2}SI:U),R,0,0,[e,d]
S:Lmap_manager.draw_map_row$tile$1_0$129({2}SI:U),R,0,0,[l,h]
S:Lmap_manager.draw_map_row$buffer$1_0$129({16}DA16d,SC:U),B,1,-21
S:Lmap_manager.draw_map_row$sloc0$0_1$0({1}SC:U),B,1,-5
S:Lmap_manager.draw_map_row$sloc1$0_1$0({1}SC:U),B,1,-4
S:Lmap_manager.draw_map_row$sloc2$0_1$0({2}DG,SC:U),B,1,-3
S:Lmap_manager.draw_map_row$sloc3$0_1$0({1}SC:U),B,1,-1
F:Fmap_manager$decompress_map_row$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap_manager.decompress_map_row$buffer$1_0$0({2}DG,SC:U),R,0,0,[e,d]
S:Lmap_manager.decompress_map_row$map_data$1_0$138({2}DG,STtag_struct_map_object:S),R,0,0,[]
S:Lmap_manager.decompress_map_row$o$1_0$138({2}DG,SC:U),R,0,0,[c,b]
S:Lmap_manager.decompress_map_row$d$1_0$138({2}DG,SC:U),R,0,0,[l,h]
S:Lmap_manager.decompress_map_row$remaining$1_0$138({1}SC:U),R,0,0,[e]
S:Lmap_manager.decompress_map_row$ch$1_0$138({1}SC:U),R,0,0,[d]
S:Lmap_manager.decompress_map_row$repeat$1_0$138({1}SC:U),R,0,0,[]
S:Lmap_manager.decompress_map_row$test$1_0$138({1}SC:U),R,0,0,[]
