...
S:Lgamer_manager.engine_gamer_manager_init$vel$1_0$121({1}SC:U),B,1,4
S:Lgamer_manager.engine_gamer_manager_init$tile$1_0$121({2}SI:U),B,1,5
S:Lgamer_manager.engine_gamer_manager_init$py$1_0$0({1}SC:U),R,0,0,[c]
S:Lgamer_manager.engine_gamer_manager_init$px$1_0$0({1}SC:U),R,0,0,[b]
S:Lgamer_manager.engine_gamer_manager_init$go$1_0$122({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
F:G$engine_gamer_manager_update$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lgamer_manager.engine_gamer_manager_update$dy$1_0$0({1}SC:U),B,1,-1
S:Lgamer_manager.engine_gamer_manager_update$dx$1_0$0({1}SC:U),R,0,0,[e]
S:Lgamer_manager.engine_gamer_manager_update$go$1_0$124({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
F:G$engine_gamer_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lgamer_manager.engine_gamer_manager_draw$go$1_0$125({2}DG,STtag_struct_gamer_object:S),R,0,0,[]
