...
S:Lriff_manager.engine_riff_manager_play$index$1_0$0({1}SC:U),R,0,0,[c]
S:Lriff_manager.engine_riff_manager_play$data$1_0$123({2}DG,SC:U),R,0,0,[e,d]
S:Lriff_manager.engine_riff_manager_play$bank$1_0$123({1}SC:U),R,0,0,[c]
